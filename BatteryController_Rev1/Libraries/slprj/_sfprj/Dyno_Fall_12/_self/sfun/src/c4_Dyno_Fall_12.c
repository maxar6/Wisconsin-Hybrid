...
static void initialize_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void initialize_params_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void enable_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void disable_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_Dyno_Fall_12
  (SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Dyno_Fall_12
  (SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void set_sim_state_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_Dyno_Fall_12
  (SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void finalize_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void sf_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void c4_chartstep_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void c4_RunTime(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void c4_PrcFault(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void c4_StandBy(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void c4_All_on(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void c4_ShutdownOne(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
...
static boolean_T c4_emlrt_marshallIn(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c4_AllowKeyOff, const char_T *c4_name);
static int32_T c4_b_emlrt_marshallIn(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c4_b_cnt, const char_T *c4_name);
static uint8_T c4_c_emlrt_marshallIn(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_Dyno_Fall_12, const char_T
  *c4_name);
static const mxArray *c4_d_emlrt_marshallIn(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c4_b_setSimStateSideEffectsInfo, const char_T
  *c4_name);
static int32_T c4__s32_add__(SFc4_Dyno_Fall_12InstanceStruct *chartInstance,
  int32_T c4_b, int32_T c4_c);
static void init_test_point_addr_map(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void **get_test_point_address_map(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance);
static rtwCAPI_ModelMappingInfo *get_test_point_mapping_info
  (SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
static void init_dsm_address_info(SFc4_Dyno_Fall_12InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Dyno_Fall_12 = 0U;
  chartInstance->c4_is_c4_Dyno_Fall_12 = 0U;
  ...
  (SFc4_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c4_is_active_c4_Dyno_Fall_12 == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG,3);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_StartUpPre) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,7);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,7);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_RunTime) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,2);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,2);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_ShutDownFinal) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,3);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,3);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_PrcFault) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,1);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,1);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_StandBy) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,5);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,5);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_All_on) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,0);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_ShutdownOne) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,4);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,4);
  }

  if (chartInstance->c4_is_c4_Dyno_Fall_12 == c4_IN_StartUpFull) {
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_PrcTOutFault = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 6)), "PrcTOutFault");
  chartInstance->c4_cnt = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_u, 7)), "cnt");
  chartInstance->c4_is_active_c4_Dyno_Fall_12 = c4_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 8)),
     "is_active_c4_Dyno_Fall_12");
  chartInstance->c4_is_c4_Dyno_Fall_12 = c4_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 9)),
    "is_c4_Dyno_Fall_12");
  ...
  c4_update_debugger_state_c4_Dyno_Fall_12(chartInstance);
...
static void sf_c4_Dyno_Fall_12(SFc4_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  c4_set_sim_state_side_effects_c4_Dyno_Fall_12(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  c4_chartstep_c4_Dyno_Fall_12(chartInstance);
  ...
  *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c4_is_active_c4_Dyno_Fall_12 == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG,3);
    chartInstance->c4_is_active_c4_Dyno_Fall_12 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,3);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG,1);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,1);
    chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_StandBy;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,5);
    chartInstance->c4_tp_StandBy = 1U;
  } else {
    switch (chartInstance->c4_is_c4_Dyno_Fall_12) {
     case c4_IN_All_on:
      CV_CHART_EVAL(3,0,1);
     ...
     case c4_IN_StartUpFull:
      ...
      if (CV_TRANSITION_EVAL(9U, !(_SFD_CCP_CALL(9,0,((*c4_BatWakeUp)!=0)) != 0))
        ...
        chartInstance->c4_tp_StartUpFull = 0U;
        chartInstance->c4_is_c4_Dyno_Fall_12 = (uint8_T)c4_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG,6);
        _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,6);
        chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_ShutdownOne;
        _SFD_CS_CALL(STATE_ACTIVE_TAG,4);
        chartInstance->c4_tp_ShutdownOne = 1U;
        chartInstance->c4_cnt = 0;
        _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c4_cnt, 6U);
        ...
        if (CV_TRANSITION_EVAL(8U, (int32_T)_SFD_CCP_CALL(8,0,(((real_T)
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG,6);
          _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,6);
          chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_PrcFault;
          _SFD_CS_CALL(STATE_ACTIVE_TAG,1);
          chartInstance->c4_tp_PrcFault = 1U;
          *c4_PrcTOutFault = TRUE;
          _SFD_DATA_RANGE_CHECK((real_T)*c4_PrcTOutFault, 8U);
          c4_b6 = *c4_PrcTOutFault;
          sf_mex_printf("%s =\\n", "PrcTOutFault");
          ...
          if (CV_TRANSITION_EVAL(7U, (int32_T)_SFD_CCP_CALL(7,0,((*c4_PrcOK)!=0)))
            ...
            _SFD_CS_CALL(STATE_INACTIVE_TAG,6);
            _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,6);
            chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_All_on;
            _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
            chartInstance->c4_tp_All_on = 1U;
            chartInstance->c4_cnt = 0;
            _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c4_cnt, 6U);
     ...
     case c4_IN_StartUpPre:
      ...
      if (CV_TRANSITION_EVAL(10U, (int32_T)_SFD_CCP_CALL(10,0,
        ...
        chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_StartUpFull;
        _SFD_CS_CALL(STATE_ACTIVE_TAG,6);
        chartInstance->c4_tp_StartUpFull = 1U;
        chartInstance->c4_cnt = 0;
        _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c4_cnt, 6U);
...
static void c4_StandBy(SFc4_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if (CV_TRANSITION_EVAL(3U, (int32_T)_SFD_CCP_CALL(3,0,((*c4_BatWakeUp)!=0)))
    ...
    chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_StartUpPre;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,7);
    chartInstance->c4_tp_StartUpPre = 1U;
    chartInstance->c4_cnt = 0;
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c4_cnt, 6U);
    ...
    *c4_PrcTOutFault = FALSE;
    _SFD_DATA_RANGE_CHECK((real_T)*c4_PrcTOutFault, 8U);
    c4_b26 = *c4_PrcTOutFault;
    sf_mex_printf("%s =\\n", "PrcTOutFault");
    sf_mex_call_debug("disp", 0U, 1U, 3, c4_b26);
    *c4_AllowKeyOff = TRUE;
    _SFD_DATA_RANGE_CHECK((real_T)*c4_AllowKeyOff, 10U);
    c4_b27 = *c4_AllowKeyOff;
    sf_mex_printf("%s =\\n", "AllowKeyOff");
...
static void c4_All_on(SFc4_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4,0,((chartInstance->c4_cnt >
    ...
    chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_RunTime;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,2);
    chartInstance->c4_tp_RunTime = 1U;
  } else {
...
static void c4_ShutdownOne(SFc4_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if (CV_TRANSITION_EVAL(6U, (int32_T)_SFD_CCP_CALL(6,0,((chartInstance->c4_cnt >
    ...
    chartInstance->c4_is_c4_Dyno_Fall_12 = c4_IN_ShutDownFinal;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,3);
    chartInstance->c4_tp_ShutDownFinal = 1U;
  } else {
    chartInstance->c4_cnt = c4__s32_add__(chartInstance, chartInstance->c4_cnt,
    ...
    *c4_BatRstReqFault = TRUE;
    _SFD_DATA_RANGE_CHECK((real_T)*c4_BatRstReqFault, 9U);
    c4_b37 = *c4_BatRstReqFault;
    sf_mex_printf("%s =\\n", "BatRstReqFault");
    sf_mex_call_debug("disp", 0U, 1U, 3, c4_b37);
    *c4_AllowKeyOff = TRUE;
    _SFD_DATA_RANGE_CHECK((real_T)*c4_AllowKeyOff, 10U);
    c4_b38 = *c4_AllowKeyOff;
    sf_mex_printf("%s =\\n", "AllowKeyOff");
...
const mxArray *sf_c4_Dyno_Fall_12_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c4_sf_marshall(void *chartInstanceVoid, void *c4_u)
{
  ...
  const mxArray *c4_b_y = NULL;
  SFc4_Dyno_Fall_12InstanceStruct *chartInstance;
  chartInstance = (SFc4_Dyno_Fall_12InstanceStruct *)chartInstanceVoid;
  c4_y = NULL;
  c4_b_u = *((uint8_T *)c4_u);
  c4_b_y = NULL;
  ...
  c4_name)
{
  boolean_T c4_y;
  boolean_T c4_b39;
  sf_mex_import(c4_name, sf_mex_dup(c4_AllowKeyOff), &c4_b39, 1, 11, 0U, 0, 0U,
                0);
  c4_y = c4_b39;
...
static uint8_T c4_c_emlrt_marshallIn(SFc4_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_Dyno_Fall_12,
  const char_T *c4_name)
{
  uint8_T c4_y;
  uint8_T c4_u0;
  sf_mex_import(c4_name, sf_mex_dup(c4_b_is_active_c4_Dyno_Fall_12), &c4_u0, 1,
                3, 0U, 0, 0U, 0);
  c4_y = c4_u0;
  sf_mex_destroy(&c4_b_is_active_c4_Dyno_Fall_12);
  return c4_y;
}
...
void sf_c4_Dyno_Fall_12_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(875575393U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2320600911U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3828098835U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3654354886U);
}

mxArray *sf_c4_Dyno_Fall_12_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(521685754U);
    pr[1] = (double)(526993088U);
    pr[2] = (double)(1359145689U);
    pr[3] = (double)(176032386U);
...
static mxArray *sf_get_sim_state_info_c4_Dyno_Fall_12(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[47],T\"AllowKeyOff\",},{M[1],M[29],T\"BatRdy\",},{M[1],M[32],T\"BatRstReqFault\",},{M[1],M[17],T\"MCNeg\",},{M[1],M[18],T\"MCPos\",},{M[1],M[19],T\"PrcC\",},{M[1],M[22],T\"PrcTOutFault\",},{M[3],M[23],T\"cnt\",},{M[8],M[0],T\"is_active_c4_Dyno_Fall_12\",},{M[9],M[0],T\"is_c4_Dyno_Fall_12\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Dyno_Fall_12_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_Dyno_Fall_12InstanceStruct *chartInstance;
    chartInstance = (SFc4_Dyno_Fall_12InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c4_Dyno_Fall_12(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_Dyno_Fall_12InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*)
    chartInstanceVar);
  initialize_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_Dyno_Fall_12(void *chartInstanceVar)
{
  enable_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_Dyno_Fall_12(void *chartInstanceVar)
{
  disable_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_Dyno_Fall_12(void *chartInstanceVar)
{
  sf_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c4_Dyno_Fall_12(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Dyno_Fall_12
    ((SFc4_Dyno_Fall_12InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c4_Dyno_Fall_12();/* state var info */
...
static void sf_internal_set_sim_state_c4_Dyno_Fall_12(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_Dyno_Fall_12();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c4_Dyno_Fall_12(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_Dyno_Fall_12(S);
}

static void sf_opaque_set_sim_state_c4_Dyno_Fall_12(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c4_Dyno_Fall_12(S, st);
}

static void sf_opaque_terminate_c4_Dyno_Fall_12(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Dyno_Fall_12InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_Dyno_Fall_12((SFc4_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
    if (!sim_mode_is_rtw_gen(S)) {
...
static void mdlProcessParameters_c4_Dyno_Fall_12(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_Dyno_Fall_12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Dyno_Fall_12","Dyno_Fall_12",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("Dyno_Fall_12","Dyno_Fall_12",4,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Dyno_Fall_12",
      "Dyno_Fall_12",4,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Dyno_Fall_12","Dyno_Fall_12",4,3);
      sf_mark_chart_reusable_outputs(S,"Dyno_Fall_12","Dyno_Fall_12",4,7);
    }

    sf_set_rtw_dwork_info(S,"Dyno_Fall_12","Dyno_Fall_12",4);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(1059563759U));
  ssSetChecksum1(S,(1403481632U));
  ssSetChecksum2(S,(594128946U));
  ssSetChecksum3(S,(1117569503U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c4_Dyno_Fall_12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Dyno_Fall_12", "Dyno_Fall_12",4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c4_Dyno_Fall_12(SimStruct *S)
{
  SFc4_Dyno_Fall_12InstanceStruct *chartInstance;
  chartInstance = (SFc4_Dyno_Fall_12InstanceStruct *)malloc(sizeof
    (SFc4_Dyno_Fall_12InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_Dyno_Fall_12InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_Dyno_Fall_12;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Dyno_Fall_12;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_Dyno_Fall_12;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_Dyno_Fall_12;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_Dyno_Fall_12;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_Dyno_Fall_12;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_Dyno_Fall_12;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Dyno_Fall_12;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Dyno_Fall_12;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Dyno_Fall_12;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_Dyno_Fall_12;
...
void c4_Dyno_Fall_12_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Dyno_Fall_12(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Dyno_Fall_12(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Dyno_Fall_12(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Dyno_Fall_12_method_dispatcher.\n"
