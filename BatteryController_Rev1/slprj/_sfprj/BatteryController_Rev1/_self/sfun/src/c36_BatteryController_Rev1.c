...
static void initialize_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void initialize_params_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void enable_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void disable_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void set_sim_state_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance, const mxArray
   *c36_st);
static void c36_set_sim_state_side_effects_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void finalize_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void sf_c36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
static void initSimStructsc36_BatteryController_Rev1
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_emlrt_marshallIn(SFc36_BatteryController_Rev1InstanceStruct
...
static const mxArray *c36_b_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static uint8_T c36_b_emlrt_marshallIn(SFc36_BatteryController_Rev1InstanceStruct
  *chartInstance, const mxArray *c36_b_tp_Init, const char_T *c36_identifier);
static uint8_T c36_c_emlrt_marshallIn(SFc36_BatteryController_Rev1InstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static boolean_T c36_d_emlrt_marshallIn
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance, const mxArray
   *c36_write, const char_T *c36_identifier);
static boolean_T c36_e_emlrt_marshallIn
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance, const mxArray
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_f_emlrt_marshallIn(SFc36_BatteryController_Rev1InstanceStruct *
  chartInstance, const mxArray *c36_b_count, const char_T *c36_identifier);
static real_T c36_g_emlrt_marshallIn(SFc36_BatteryController_Rev1InstanceStruct *
  chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
...
static const mxArray *c36_i_emlrt_marshallIn
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance, const mxArray
   *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_BatteryController_Rev1InstanceStruct
  *chartInstance);
  ...
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_BatteryController_Rev1 = 0U;
  chartInstance->c36_is_c36_BatteryController_Rev1 = 0U;
  ...
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c36_is_active_c36_BatteryController_Rev1 == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 7U, chartInstance->c36_sfEvent);
  }

  if (chartInstance->c36_is_c36_BatteryController_Rev1 == c36_IN_Init) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c36_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c36_sfEvent);
  }

  if (chartInstance->c36_is_c36_BatteryController_Rev1 == c36_IN_Counting) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c36_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c36_sfEvent);
  }

  if (chartInstance->c36_is_c36_BatteryController_Rev1 == c36_IN_Write) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c36_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c36_sfEvent);
  }

  if (chartInstance->c36_is_c36_BatteryController_Rev1 == c36_IN_Clear) {
  ...
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance)
{
  ...
  c36_c_hoistedGlobal = chartInstance->c36_is_active_c36_BatteryController_Rev1;
  c36_c_u = c36_c_hoistedGlobal;
  c36_d_y = NULL;
  sf_mex_assign(&c36_d_y, sf_mex_create("y", &c36_c_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c36_y, 2, c36_d_y);
  c36_d_hoistedGlobal = chartInstance->c36_is_c36_BatteryController_Rev1;
   ...
   *c36_st)
{
  ...
  *c36_write = c36_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c36_is_active_c36_BatteryController_Rev1 =
    c36_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 2)),
    "is_active_c36_BatteryController_Rev1");
  chartInstance->c36_is_c36_BatteryController_Rev1 = c36_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 3)),
     "is_c36_BatteryController_Rev1");
  ...
  c36_update_debugger_state_c36_BatteryController_Rev1(chartInstance);
  ...
  (SFc36_BatteryController_Rev1InstanceStruct *chartInstance)
{
  ...
  c36_write = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c36_set_sim_state_side_effects_c36_BatteryController_Rev1(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 7U, chartInstance->c36_sfEvent);
  ...
  chartInstance->c36_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 7U, chartInstance->c36_sfEvent);
  if ((int16_T)chartInstance->c36_is_active_c36_BatteryController_Rev1 == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 7U, chartInstance->c36_sfEvent);
    chartInstance->c36_is_active_c36_BatteryController_Rev1 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 7U, chartInstance->c36_sfEvent);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U,
                 chartInstance->c36_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c36_sfEvent);
    chartInstance->c36_is_c36_BatteryController_Rev1 = c36_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c36_sfEvent);
    chartInstance->c36_tp_Init = 1U;
  } else {
    switch (chartInstance->c36_is_c36_BatteryController_Rev1) {
     case c36_IN_Clear:
      CV_CHART_EVAL(7, 0, 1);
     ...
     case c36_IN_Counting:
      ...
      if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0,
        ...
        chartInstance->c36_tp_Counting = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c36_sfEvent);
        chartInstance->c36_is_c36_BatteryController_Rev1 = c36_IN_Write;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c36_sfEvent);
        chartInstance->c36_tp_Write = 1U;
      } else {
     ...
     case c36_IN_Init:
      ...
      if (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0, (int16_T)
        ...
        chartInstance->c36_tp_Init = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c36_sfEvent);
        chartInstance->c36_is_c36_BatteryController_Rev1 = c36_IN_Counting;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c36_sfEvent);
        chartInstance->c36_tp_Counting = 1U;
      } else {
        *c36_write = FALSE;
     ...
     case c36_IN_Write:
      ...
      if (CV_TRANSITION_EVAL(3U, (int32_T)_SFD_CCP_CALL(3U, 0, (int16_T)
        ...
        chartInstance->c36_tp_Write = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c36_sfEvent);
        chartInstance->c36_is_c36_BatteryController_Rev1 = c36_IN_Clear;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c36_sfEvent);
        chartInstance->c36_tp_Clear = 1U;
      } else {
        *c36_write = TRUE;
     ...
     default:
      CV_CHART_EVAL(7, 0, 0);
      chartInstance->c36_is_c36_BatteryController_Rev1 = (uint8_T)
...
const mxArray *sf_c36_BatteryController_Rev1_get_eml_resolved_functions_info
  (void)
{
  ...
  *c36_inData)
{
  ...
  const mxArray *c36_y = NULL;
  SFc36_BatteryController_Rev1InstanceStruct *chartInstance;
  chartInstance = (SFc36_BatteryController_Rev1InstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c36_BatteryController_Rev1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c36_BatteryController_Rev1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c36_BatteryController_Rev1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"write\",},{M[3],M[12],T\"count\",},{M[8],M[0],T\"is_active_c36_BatteryController_Rev1\",},{M[9],M[0],T\"is_c36_BatteryController_Rev1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_BatteryController_Rev1_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c36_BatteryController_Rev1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_BatteryController_Rev1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c36_BatteryController_Rev1
    ((SFc36_BatteryController_Rev1InstanceStruct*) chartInstanceVar);
  initialize_c36_BatteryController_Rev1
    ((SFc36_BatteryController_Rev1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c36_BatteryController_Rev1(void *chartInstanceVar)
{
  enable_c36_BatteryController_Rev1((SFc36_BatteryController_Rev1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c36_BatteryController_Rev1(void *chartInstanceVar)
{
  disable_c36_BatteryController_Rev1((SFc36_BatteryController_Rev1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c36_BatteryController_Rev1(void *chartInstanceVar)
{
  sf_c36_BatteryController_Rev1((SFc36_BatteryController_Rev1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c36_BatteryController_Rev1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c36_BatteryController_Rev1
    ((SFc36_BatteryController_Rev1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c36_BatteryController_Rev1();/* state var info */
...
extern void sf_internal_set_sim_state_c36_BatteryController_Rev1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c36_BatteryController_Rev1
    ((SFc36_BatteryController_Rev1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c36_BatteryController_Rev1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c36_BatteryController_Rev1(S);
}

static void sf_opaque_set_sim_state_c36_BatteryController_Rev1(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c36_BatteryController_Rev1(S, st);
}

static void sf_opaque_terminate_c36_BatteryController_Rev1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_BatteryController_Rev1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c36_BatteryController_Rev1
      ((SFc36_BatteryController_Rev1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc36_BatteryController_Rev1
    ((SFc36_BatteryController_Rev1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_BatteryController_Rev1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c36_BatteryController_Rev1
      ((SFc36_BatteryController_Rev1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_BatteryController_Rev1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BatteryController_Rev1",
      "BatteryController_Rev1",36);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BatteryController_Rev1",
                "BatteryController_Rev1",36,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"BatteryController_Rev1",
      "BatteryController_Rev1",36,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"BatteryController_Rev1",
        "BatteryController_Rev1",36,1);
      sf_mark_chart_reusable_outputs(S,"BatteryController_Rev1",
        "BatteryController_Rev1",36,1);
    }

    sf_set_rtw_dwork_info(S,"BatteryController_Rev1","BatteryController_Rev1",36);
...
static void mdlRTW_c36_BatteryController_Rev1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_BatteryController_Rev1(SimStruct *S)
{
  SFc36_BatteryController_Rev1InstanceStruct *chartInstance;
  chartInstance = (SFc36_BatteryController_Rev1InstanceStruct *)malloc(sizeof
    (SFc36_BatteryController_Rev1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_BatteryController_Rev1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c36_BatteryController_Rev1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c36_BatteryController_Rev1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c36_BatteryController_Rev1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c36_BatteryController_Rev1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c36_BatteryController_Rev1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c36_BatteryController_Rev1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c36_BatteryController_Rev1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c36_BatteryController_Rev1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_BatteryController_Rev1;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_BatteryController_Rev1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c36_BatteryController_Rev1;
...
void c36_BatteryController_Rev1_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_BatteryController_Rev1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_BatteryController_Rev1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_BatteryController_Rev1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_BatteryController_Rev1_method_dispatcher.\n"
