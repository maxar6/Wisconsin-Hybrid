...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_BatteryController_Rev1_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_BatteryController_Rev1_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_BatteryController_Rev1_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "BatteryController_Rev1") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_BatteryController_Rev1_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
{
  extern unsigned int sf_BatteryController_Rev1_get_eml_resolved_functions_info(
  ...
  if (strcmp(machineName, "BatteryController_Rev1") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_BatteryController_Rev1_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_BatteryController_Rev1_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"BatteryController_Rev1")) {
    return(sf_BatteryController_Rev1_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    BatteryController_Rev1_terminator();
    sf_debug_terminate();
  }
...
extern void BatteryController_Rev1_register_exported_symbols(SimStruct* S);
extern void BatteryController_Rev1_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  BatteryController_Rev1_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      BatteryController_Rev1_debug_initialize();
    }

    BatteryController_Rev1_initializer();
  }
