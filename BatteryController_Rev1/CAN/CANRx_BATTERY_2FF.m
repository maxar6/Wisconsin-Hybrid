function msg = CANRx_BATTERY_2FF()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'TripAmpHoursIn';
  msg.fields{1}.units         = 'Ah';
  ...
  msg.fields{2}.name          = 'TripAmpHoursOut';
  msg.fields{2}.units         = 'Ah';
  ...
  msg.fields{3}.name          = 'StateOfChargeMax';
  msg.fields{3}.units         = '%';
  ...
  msg.fields{4}.name          = 'StateOfChargeMin';
  msg.fields{4}.units         = '%';
  ...
  msg.fields{5}.name          = 'TAH_RollingCounter';
  msg.fields{5}.units         = '';
