...
%%
  ...
  msg.name                    = 'Volt Battery Pack V/I';
  msg.description             = 'ID06A Volt Battery Pack V/I';
  msg.protocol                = '';
  msg.module                  = 'VOLT';
  msg.channel				  = 1;
  ...
  msg.fields{1}.name          = 'PackVoltage';
  msg.fields{1}.units         = 'mV';
