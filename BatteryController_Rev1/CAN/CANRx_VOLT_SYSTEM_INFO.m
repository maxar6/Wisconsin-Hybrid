...
%%
  ...
  msg.name                    = 'Volt Battery Balance/System Info';
  msg.description             = 'ID06B Volt Battery System Info';
  msg.protocol                = '';
  msg.module                  = 'VOLT';
  msg.channel				  = 1;
  ...
  msg.fields{1}.name          = 'BalancingCount';
  msg.fields{1}.units         = '';
  ...
  %msg.fields{2}.name          = 'SystemVoltage';
