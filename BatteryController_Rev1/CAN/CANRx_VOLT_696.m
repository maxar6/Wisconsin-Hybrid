...
%%
  ...
  msg.name                    = 'Battery Controller';
  msg.description             = 'ID696 Volt Battery Controller';
  msg.protocol                = '';
  msg.module                  = 'VOLT';
  msg.channel				  = 1;
  ...
  msg.fields{1}.name          = 'Battery_Enable';
  msg.fields{1}.units         = '';
