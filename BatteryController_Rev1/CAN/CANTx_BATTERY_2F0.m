function msg = CANTx_BATTERY_2F0()
...
%%
  ...
  msg.name                    = 'ExternalCommand';
  msg.description             = 'CommandsToBattery';
  msg.protocol                = '';
  msg.module                  = 'Battery';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'ConnectCommand';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'IsolationMeasurementEnable';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Ignition';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 62;
