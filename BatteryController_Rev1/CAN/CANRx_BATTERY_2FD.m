function msg = CANRx_BATTERY_2FD()
...
%%
  ...
  msg.name                    = 'PackVoltageAndCurrent';
  msg.description             = '';
  msg.protocol                = '';
  msg.module                  = 'Battery';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'BatteryVoltage';
  ...
  msg.fields{2}.name          = 'BatteryCurrent';
  ...
  msg.fields{2}.offset        = -500;

  msg.fields{3}.name          = 'BusVoltage';
  ...
  msg.fields{4}.name          = 'PVC_RollingCounter';
  msg.fields{4}.units         = '';
