...
%%
  ...
  msg.name                    = 'Volt Battery Min/Max Stats';
  msg.description             = 'ID069 Volt Battery Min/Max Stats';
  msg.protocol                = '';
  msg.module                  = 'VOLT';
  msg.channel				  = 1;
  ...
  msg.fields{1}.name          = 'PackMaxVoltage';
  ...
  msg.fields{2}.name          = 'PackMinVoltage';
  ...
  %msg.fields{3}.name          = 'PackAverageVoltage';
  ...
  msg.fields{3}.name          = 'PackMaxTemp';
  msg.fields{3}.units         = 'C';
  msg.fields{3}.start_bit     = 48;
  msg.fields{3}.bit_length    =	8;
  msg.fields{3}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{3}.data_type     = 'UNSIGNED';
  msg.fields{3}.scale         = 100;
  msg.fields{3}.offset        = 0;
  
  msg.fields{4}.name          = 'PackMinTemp';
