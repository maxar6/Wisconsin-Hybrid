function msg = CANRx_BATTERY_2FB()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'MaximumDischargePower_10s';
  msg.fields{1}.units         = 'kW';
  ...
  msg.fields{2}.name          = 'MaximumRegenPower_10s';
  msg.fields{2}.units         = 'kW';
  ...
  msg.fields{5}.name          = 'PPL10s_RollingCounter';
  msg.fields{5}.units         = '';
