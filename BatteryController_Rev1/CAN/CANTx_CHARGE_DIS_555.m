...
%%
  ...
  msg.name                    = 'HS2 DISPLAY CMD';
  msg.description             = 'ID555 FORD HS2 DISPLAY CMD';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{3}.name          = 'Blue_LED';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 56;
