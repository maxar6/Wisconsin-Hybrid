...
%%
  ...
  msg.name                    = 'PD300_Command3';
  msg.description             = 'Auxillary Output Control';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_2';
  ...
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [242 02 00 00 00 00 00 00];
  ...
  msg.fields{field_ctr}.name          = 'XDRP_Supply_State';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Aux_PWM_State';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Aux_PWM_DutyCycle';
  msg.fields{field_ctr}.units         = '%';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Aux_PWM_Freq';
  msg.fields{field_ctr}.units         = 'Hz';
