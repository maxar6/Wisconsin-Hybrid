...
#define BaseEngineController_A02_IN_PowerUp (2U)
  ...
  if (BaseEngineController_A02_DWork.s5_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S5>/Coil Control' */
    {
      ...
      /* MATLAB Function Block: '<S783>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S783>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S783>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S784>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_A02_B.s783_RelationalOperator1 == TRUE)) {
        /* '<S784>:1:3' */
        /* '<S784>:1:4' */
        rtb_StateO_p = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_A02_B.s783_RelationalOperator1 ==
                            TRUE)) {
        /* '<S784>:1:5' */
        /* '<S784>:1:6' */
        rtb_StateO_p = 2.0;
      ...
      /* End of MATLAB Function Block: '<S783>/EST Enable TDC Counter Stateflow' */
      ...
      /* End of DataTypeConversion: '<S706>/Data Type Conversion' */
      ...
      /* End of DataTypeConversion: '<S706>/Data Type Conversion1' */
      ...
      /* End of DataTypeConversion: '<S706>/Data Type Conversion2' */
      ...
      /* RelationalOperator: '<S788>/RelOp' incorporates:
       *  Constant: '<S788>/Constant'
       */
      rtb_RelOp_a = ((rtb_SparkSequence_o1[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S779>/motohawk_fault_def' */
      ...
      /* RelationalOperator: '<S789>/RelOp' incorporates:
      ...
      /* RelationalOperator: '<S786>/RelOp' incorporates:
      ...
      /* RelationalOperator: '<S787>/RelOp' incorporates:
       *  Constant: '<S787>/Constant'
       */
      rtb_RelOp_b = ((rtb_SparkSequence_o2[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S779>/motohawk_fault_def9' */
