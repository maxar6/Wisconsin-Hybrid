function msg = miniview_button_down()

  msg.name                    = 'MiniView Button Down';
  msg.description             = 'MiniView Button Down';
  ...
  msg.fields{1}.name          = 'down asserted';
