function msg = miniview_draw_hline()

  msg.name                    = 'MiniView Horizontal Line';
  msg.description             = 'MiniView Horizontal Line';
  ...
  msg.idinherit               =  0;
  msg.payload_size            =  7;
  msg.payload_value           = [0 0 0 hex2dec('01') hex2dec('d3') 0 0];
  msg.payload_mask            = [0 0 0 hex2dec('ff') hex2dec('ff') 0 0];
  msg.interval                = -1;

  i=1;
  msg.fields{i}.name          = 'hline x0';
