...
%%
  ...
  msg.name                    = 'PD300_Command2';
  msg.description             = 'Secondary Limiting Centerpoints';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_2';
  ...
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [242 01 00 00 00 00 00 00];
  ...
  msg.fields{field_ctr}.name          = 'SecondarySpeedLim_CenterPT';
  ...
  msg.fields{field_ctr}.offset        = -32000;
   ...
   field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'SecondaryVoltLim_CenterPT';
