...
static const char * c4_debug_family_names[6] = { "nargin", "nargout", "trq",
  "speed", "hp", "kw" };
...
static real_T c4_emlrt_marshallIn(SFc4_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c4_kw, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_BaseEngineController_A02InstanceStruct *
  chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_BaseEngineController_A02,
  ...
  (SFc4_BaseEngineController_A02InstanceStruct *chartInstance)
{
  ...
  real_T *c4_hp;
  real_T *c4_kw;
  c4_kw = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c4_hp = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellarray(3));
  c4_hoistedGlobal = *c4_hp;
  c4_u = c4_hoistedGlobal;
  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_u, 0, 0U, 0U, 0U, 0));
  sf_mex_setcell(c4_y, 0, c4_b_y);
  c4_b_hoistedGlobal = *c4_kw;
  c4_b_u = c4_b_hoistedGlobal;
  c4_c_y = NULL;
  sf_mex_assign(&c4_c_y, sf_mex_create("y", &c4_b_u, 0, 0U, 0U, 0U, 0));
  sf_mex_setcell(c4_y, 1, c4_c_y);
  c4_c_hoistedGlobal = chartInstance->c4_is_active_c4_BaseEngineController_A02;
   ...
   *c4_st)
{
  ...
  *c4_hp = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)),
    "hp");
  *c4_kw = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
    "kw");
  ...
  (SFc4_BaseEngineController_A02InstanceStruct *chartInstance)
{
  ...
  real_T *c4_b_speed;
  real_T *c4_b_kw;
  c4_b_kw = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c4_b_speed = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_hp = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_trq = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c4_b_trq, 0U);
  _SFD_DATA_RANGE_CHECK(*c4_b_hp, 1U);
  _SFD_DATA_RANGE_CHECK(*c4_b_speed, 2U);
  _SFD_DATA_RANGE_CHECK(*c4_b_kw, 3U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_trq;
  c4_b_hoistedGlobal = *c4_b_speed;
  c4_trq = c4_hoistedGlobal;
  c4_speed = c4_b_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_trq, 2U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_speed, 3U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_hp, 4U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_kw, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 3);
  c4_a = c4_trq;
  c4_y = c4_a * 0.737562149;
  c4_b_a = c4_y;
  c4_b = c4_speed;
  c4_b_y = c4_b_a * c4_b;
  c4_A = c4_b_y;
  ...
  *chartInstance, const mxArray *c4_kw, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_kw), &c4_thisId);
  sf_mex_destroy(&c4_kw);
  return c4_y;
}
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  chartInstance = (SFc4_BaseEngineController_A02InstanceStruct *)
    chartInstanceVoid;
  c4_kw = sf_mex_dup(c4_mxArrayInData);
  ...
  const char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_BaseEngineController_A02), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_BaseEngineController_A02);
  return c4_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(127139421U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2053874214U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(953661380U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(676693589U);
}
...
mxArray *sf_c4_BaseEngineController_A02_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(83214670U);
    pr[1] = (double)(2725255725U);
    pr[2] = (double)(2264103277U);
    pr[3] = (double)(1501872310U);
...
static const mxArray *sf_get_sim_state_info_c4_BaseEngineController_A02(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"hp\",},{M[1],M[7],T\"kw\",},{M[8],M[0],T\"is_active_c4_BaseEngineController_A02\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"hp");
          _SFD_SET_DATA_PROPS(2,1,1,0,"speed");
          _SFD_SET_DATA_PROPS(3,2,0,1,"kw");
...

        {
          ...
          real_T *c4_kw;
          c4_kw = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c4_speed = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c4_hp = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c4_trq = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c4_trq);
          _SFD_SET_DATA_VALUE_PTR(1U, c4_hp);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_speed);
          _SFD_SET_DATA_VALUE_PTR(3U, c4_kw);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c4_BaseEngineController_A02(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3276696948U));
  ssSetChecksum1(S,(675115396U));
  ssSetChecksum2(S,(2877798287U));
  ssSetChecksum3(S,(648531587U));
