...
static const char * c3_debug_family_names[5] = { "nargin", "nargout", "tEnable",
  "gEnable", "ESTOP" };
...
static void sf_c3_BaseEngineController_A02
  (SFc3_BaseEngineController_A02InstanceStruct *chartInstance);
static void initSimStructsc3_BaseEngineController_A02
  (SFc3_BaseEngineController_A02InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c3_ESTOP, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_BaseEngineController_A02InstanceStruct *
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_BaseEngineController_A02,
  const char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_BaseEngineController_A02InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
  ...
  (SFc3_BaseEngineController_A02InstanceStruct *chartInstance)
{
  ...
  real_T *c3_ESTOP;
  c3_ESTOP = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellarray(2));
  c3_hoistedGlobal = *c3_ESTOP;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0));
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_BaseEngineController_A02;
   ...
   *c3_st)
{
  ...
  *c3_ESTOP = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "ESTOP");
  ...
  (SFc3_BaseEngineController_A02InstanceStruct *chartInstance)
{
  ...
  boolean_T c3_tEnable;
  boolean_T c3_gEnable;
  uint32_T c3_debug_family_var_map[5];
  real_T c3_nargin = 2.0;
  real_T c3_nargout = 1.0;
  real_T c3_ESTOP;
  boolean_T *c3_b_tEnable;
  real_T *c3_b_ESTOP;
  boolean_T *c3_b_gEnable;
  c3_b_gEnable = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_ESTOP = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_tEnable = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_b_tEnable, 0U);
  _SFD_DATA_RANGE_CHECK(*c3_b_ESTOP, 1U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_b_gEnable, 2U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_tEnable;
  c3_b_hoistedGlobal = *c3_b_gEnable;
  c3_tEnable = c3_hoistedGlobal;
  c3_gEnable = c3_b_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c3_nargout, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c3_tEnable, 2U, c3_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_gEnable, 3U, c3_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c3_ESTOP, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 3);
  if (CV_EML_IF(0, 0, (real_T)c3_tEnable == 1.0)) {
  ...
  *chartInstance, const mxArray *c3_ESTOP, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_ESTOP), &c3_thisId);
  sf_mex_destroy(&c3_ESTOP);
  return c3_y;
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  chartInstance = (SFc3_BaseEngineController_A02InstanceStruct *)
    chartInstanceVoid;
  c3_ESTOP = sf_mex_dup(c3_mxArrayInData);
  ...
  const char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_BaseEngineController_A02), &c3_thisId);
...
static const mxArray *sf_get_sim_state_info_c3_BaseEngineController_A02(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ESTOP\",},{M[8],M[0],T\"is_active_c3_BaseEngineController_A02\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds
            (_BaseEngineController_A02MachineNumber_,
             ...
             0,
             0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"tEnable");
          _SFD_SET_DATA_PROPS(1,2,0,1,"ESTOP");
          _SFD_SET_DATA_PROPS(2,1,1,0,"gEnable");
        ...
        _SFD_CV_INIT_EML_IF(0,0,39,54,70,128);
        _SFD_CV_INIT_EML_IF(0,1,70,89,105,128);
...

        {
          ...
          real_T *c3_ESTOP;
          boolean_T *c3_gEnable;
          c3_gEnable = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c3_ESTOP = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c3_tEnable = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c3_tEnable);
          _SFD_SET_DATA_VALUE_PTR(1U, c3_ESTOP);
          _SFD_SET_DATA_VALUE_PTR(2U, c3_gEnable);
        }
      }
    } else {
...
extern const mxArray* sf_internal_get_sim_state_c3_BaseEngineController_A02
  (SimStruct* S)
{
...
extern void sf_internal_set_sim_state_c3_BaseEngineController_A02(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
static const mxArray* sf_opaque_get_sim_state_c3_BaseEngineController_A02
  (SimStruct* S)
{
...
{
  initSimStructsc3_BaseEngineController_A02
    ((SFc3_BaseEngineController_A02InstanceStruct*) chartInstanceVar);
}
...
static void mdlSetWorkWidths_c3_BaseEngineController_A02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_A02","BaseEngineController_A02",3,
