...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_6779p0005 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6779p0005(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    ...
    if (good_payload) {
      ...
      new_message = !MHCAN_directslot_RxSlot_6779p0005.ready;
      MHCAN_directslot_RxSlot_6779p0005.message = *messageObj;
      MHCAN_directslot_RxSlot_6779p0005.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_6780p0005 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6780p0005(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    boolean_T good_payload = 1;
    messageObj->u1Length = messageObj->u1Length > 8 ? 8 : messageObj->u1Length;
    ...
    if (good_payload) {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_6780p0005.ready;
      MHCAN_directslot_RxSlot_6780p0005.message = *messageObj;
      MHCAN_directslot_RxSlot_6780p0005.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_6781p0005 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6781p0005(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    boolean_T good_payload = 1;
    messageObj->u1Length = messageObj->u1Length > 8 ? 8 : messageObj->u1Length;
    ...
    if (good_payload) {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_6781p0005.ready;
      MHCAN_directslot_RxSlot_6781p0005.message = *messageObj;
      MHCAN_directslot_RxSlot_6781p0005.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_6782p0005 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6782p0005(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    boolean_T good_payload = 1;
    messageObj->u1Length = messageObj->u1Length > 8 ? 8 : messageObj->u1Length;
    ...
    if (good_payload) {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_6782p0005.ready;
      MHCAN_directslot_RxSlot_6782p0005.message = *messageObj;
      MHCAN_directslot_RxSlot_6782p0005.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x1FFFFFFF[] = {
  { 0x18efff01, MHCAN_handler_RxSlot_6779p0005 },

  { 0x18efff01, MHCAN_handler_RxSlot_6780p0005 },

  { 0x18efff01, MHCAN_handler_RxSlot_6781p0005 },

  { 0x18efff01, MHCAN_handler_RxSlot_6782p0005 },
};
