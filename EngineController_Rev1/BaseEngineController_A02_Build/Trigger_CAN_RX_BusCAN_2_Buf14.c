...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_6486p0004 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6486p0004(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    ...
    if (good_payload) {
      ...
      new_message = !MHCAN_directslot_RxSlot_6486p0004.ready;
      MHCAN_directslot_RxSlot_6486p0004.message = *messageObj;
      MHCAN_directslot_RxSlot_6486p0004.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_6485p0006 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6485p0006(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    boolean_T good_payload = 1;
    messageObj->u1Length = messageObj->u1Length > 8 ? 8 : messageObj->u1Length;
    ...
    if (good_payload) {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_6485p0006.ready;
      MHCAN_directslot_RxSlot_6485p0006.message = *messageObj;
      MHCAN_directslot_RxSlot_6485p0006.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_6487p0004 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6487p0004(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    boolean_T good_payload = 1;
    messageObj->u1Length = messageObj->u1Length > 8 ? 8 : messageObj->u1Length;
    ...
    if (good_payload) {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_6487p0004.ready;
      MHCAN_directslot_RxSlot_6487p0004.message = *messageObj;
      MHCAN_directslot_RxSlot_6487p0004.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_6488p0004 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6488p0004(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18EFFF01) {
    boolean_T good_payload = 1;
    messageObj->u1Length = messageObj->u1Length > 8 ? 8 : messageObj->u1Length;
    ...
    if (good_payload) {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_6488p0004.ready;
      MHCAN_directslot_RxSlot_6488p0004.message = *messageObj;
      MHCAN_directslot_RxSlot_6488p0004.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x1FFFFFFF[] = {
  { 0x18efff01, MHCAN_handler_RxSlot_6486p0004 },

  { 0x18efff01, MHCAN_handler_RxSlot_6485p0006 },

  { 0x18efff01, MHCAN_handler_RxSlot_6487p0004 },

  { 0x18efff01, MHCAN_handler_RxSlot_6488p0004 },
};
