...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_6408p0004 = { 0 };

static boolean_T MHCAN_handler_RxSlot_6408p0004(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000210) {
...

    {
      ...
      new_message = !MHCAN_directslot_RxSlot_6408p0004.ready;
      MHCAN_directslot_RxSlot_6408p0004.message = *messageObj;
      MHCAN_directslot_RxSlot_6408p0004.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x000007FF[] = {
  { 0x00000210, MHCAN_handler_RxSlot_6408p0004 },
};
