  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_1_0_47;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_1_0_47 = 0;
    else
      can_tx_err_CAN_1_0_47 = (uint8_T) GetErrorCode(sErrorResult);
  }
  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_2_0_48;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_2_0_48 = 0;
    else
      can_tx_err_CAN_2_0_48 = (uint8_T) GetErrorCode(sErrorResult);
  }
