  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_1_0_50;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_1_0_50 = 0;
    else
      can_tx_err_CAN_1_0_50 = (uint8_T) GetErrorCode(sErrorResult);
  }
  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_2_0_51;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_2_0_51 = 0;
    else
      can_tx_err_CAN_2_0_51 = (uint8_T) GetErrorCode(sErrorResult);
  }
