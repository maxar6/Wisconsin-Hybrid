...
RT_MODEL_BaseEngineController_A02 *BaseEngineController_A02_M =
...
void BaseEngineController_A02_initialize(boolean_T firstTime)
{
  ...
  /* Start for trigger SubSystem: '<S845>/Post Shutdown two ticks before MPRD off' */

  /* Start for S-Function (fcncallgen): '<S852>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S852>/Post Shutdown two ticks before MPRD off'
   */

  /* end of Start for SubSystem: '<S845>/Post Shutdown two ticks before MPRD off' */

  /* Start for trigger SubSystem: '<S845>/Save NV Vars one tick before MPRD off' */

  /* Start for S-Function (fcncallgen): '<S854>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S854>/Save NV Vars one tick before MPRD off'
   */

  /* end of Start for SubSystem: '<S845>/Save NV Vars one tick before MPRD off' */

  /* Start for trigger SubSystem: '<S845>/Shutdown power on ECU565//563' */

  /* Start for S-Function (fcncallgen): '<S855>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S855>/Shutdown power on ECU565-128'
   */

  /* end of Start for SubSystem: '<S845>/Shutdown power on ECU565//563' */

  /* Start for S-Function (motohawk_sfun_dout): '<S840>/motohawk_dout' */
  ...
  /* Start for trigger SubSystem: '<S847>/Post Shutdown two ticks before MPRD off' */

  /* Start for S-Function (fcncallgen): '<S861>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S861>/Post Shutdown two ticks before MPRD off'
   */

  /* end of Start for SubSystem: '<S847>/Post Shutdown two ticks before MPRD off' */

  /* Start for trigger SubSystem: '<S847>/Save NV Vars one tick before MPRD off' */

  /* Start for S-Function (fcncallgen): '<S863>/Function-Call Generator1' incorporates:
   *  Start for SubSystem: '<S863>/Save NV Vars one tick before MPRD off'
   */

  /* end of Start for SubSystem: '<S847>/Save NV Vars one tick before MPRD off' */

  /* Start for trigger SubSystem: '<S847>/Shutdown power on ECU565//563' */

  /* Start for S-Function (fcncallgen): '<S864>/Function-Call Generator2' incorporates:
   *  Start for SubSystem: '<S864>/Shutdown power on ECU565-128'
   */

  /* end of Start for SubSystem: '<S847>/Shutdown power on ECU565//563' */

  /* Start for trigger SubSystem: '<S842>/Clear' */

  /* Start for S-Function (fcncallgen): '<S850>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S840>/motohawk_restore_nvmem'
   */

  /* end of Start for SubSystem: '<S842>/Clear' */

  /* Start for trigger SubSystem: '<S843>/Clear' */

  /* Start for S-Function (fcncallgen): '<S851>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S840>/motohawk_store_nvmem'
   */

  /* end of Start for SubSystem: '<S843>/Clear' */
  ...
  /* InitializeConditions for Memory: '<S860>/Memory' */
  BaseEngineController_A02_DWork.s860_Memory_PreviousInput = FALSE;
