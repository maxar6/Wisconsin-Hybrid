/*
 * Trigger_FGND_5XRTI_PERIODIC_7562p0001.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_7562p0001(void)
{
...
#define BaseEngineController_A02_IN_PowerUp (2U)
  ...
  if (BaseEngineController_A02_DWork.s5_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S5>/Coil Control' */
    {
      ...
      /* Logic: '<S733>/Logical Operator3' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S733>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_d = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S733>/motohawk_fault_action'
       *
       * Regarding '<S733>/motohawk_fault_action':
      ...
      /* S-Function (motohawk_sfun_data_read): '<S733>/motohawk_data_read2' */
      rtb_motohawk_data_read2 = ECUP_Enabled_DataStore();

      /* Logic: '<S733>/Logical Operator4' incorporates:
       *  Constant: '<S737>/Constant'
       *  RelationalOperator: '<S737>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S733>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_g = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S733>/EST Enable TDC Counter' */
      /* UnitDelay: '<S738>/CrankCounter' */
      BaseEngineController_A02_B.s738_CrankCounter =
        BaseEngineController_A02_DWork.s738_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S738>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_7097p0004 */
      if (BaseEngineController_A02_DWork.s738_motohawk_trigger1_DWORK1 == 0) {
        BaseEngineController_A02_DWork.s738_motohawk_trigger1_DWORK1 = 1;
      }

      /* RelationalOperator: '<S738>/Relational Operator1' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S738>/motohawk_calibration1'
       */
      BaseEngineController_A02_B.s738_RelationalOperator1 =
        ((BaseEngineController_A02_B.s740_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S738>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S738>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S738>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S739>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_A02_B.s738_RelationalOperator1 == TRUE)) {
        /* '<S739>:1:3' */
        /* '<S739>:1:4' */
        rtb_StateO_p = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_A02_B.s738_RelationalOperator1 ==
                            TRUE)) {
        /* '<S739>:1:5' */
        /* '<S739>:1:6' */
        rtb_StateO_p = 2.0;
      ...
      /* End of MATLAB Function Block: '<S738>/EST Enable TDC Counter Stateflow' */

      /* S-Function (motohawk_sfun_data_write): '<S738>/motohawk_data_write' */
      ...
      BaseEngineController_A02_B.s738_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S738>/CrankCounter' */
      BaseEngineController_A02_DWork.s738_CrankCounter_DSTATE = rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S733>/EST Enable TDC Counter' */

      /* Logic: '<S662>/Logical Operator1' incorporates:
       *  Logic: '<S733>/Logical Operator2'
       *  S-Function (motohawk_sfun_calibration): '<S733>/motohawk_calibration1'
       *  S-Function (motohawk_sfun_calibration): '<S733>/motohawk_calibration3'
       *  S-Function (motohawk_sfun_calibration): '<S733>/motohawk_calibration4'
       ...
       *  S-Function (motohawk_sfun_calibration): '<S733>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S733>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S733>/motohawk_calibration9'
       */
      BaseEngineController_A02_B.s662_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
          (SparkEnableCyl1_DataStore()) && rtb_motohawk_data_read2 &&
          rtb_LogicalOperator4_g &&
          (BaseEngineController_A02_B.s738_DataTypeConversion != 0) &&
          BaseEngineController_A02_B.s16_OnlyEnableSparkwhenEnergyisAboveZero &&
          BaseEngineController_A02_B.s14_LogicalOperator2[0]));
      BaseEngineController_A02_B.s662_LogicalOperator1[1] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s662_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s662_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s662_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s662_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s662_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s662_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_A02_DWork.s735_UnitDelay_DSTATE;
      ...
      /* Sum: '<S735>/Sum' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S735>/offset'
       */
      BaseEngineController_A02_B.s735_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S662>/Data Type Conversion' incorporates:
       *  Gain: '<S662>/Gain'
       */
      tmp_0 = 16.0 * BaseEngineController_A02_B.s735_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_A02_DWork.s736_UnitDelay_DSTATE;
       ...
       *  S-Function (motohawk_sfun_calibration): '<S736>/offset'
       */
      BaseEngineController_A02_B.s736_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S662>/Data Type Conversion1' incorporates:
       *  Gain: '<S662>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_A02_B.s736_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* End of DataTypeConversion: '<S662>/Data Type Conversion1' */
      ...
      /* S-Function Block: <S662>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_A02_B.s662_SparkSequence_o3)[i] =
            SparkSeqDiag_19_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_A02_B.s662_SparkSequence_o4)[i] =
            SparkSeqDiag_19_OnTime[i];
        }
      }

      /* RelationalOperator: '<S743>/RelOp' incorporates:
       *  Constant: '<S743>/Constant'
       */
      rtb_RelOp_a = ((rtb_SparkSequence_o1[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S734>/motohawk_fault_def' */
      ...
      /* RelationalOperator: '<S744>/RelOp' incorporates:
       *  Constant: '<S744>/Constant'
       */
      rtb_RelOp_d = ((rtb_SparkSequence_o1[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S734>/motohawk_fault_def1' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S734>/motohawk_fault_def8' */
      ...
      /* RelationalOperator: '<S742>/RelOp' incorporates:
       *  Constant: '<S742>/Constant'
       */
      rtb_RelOp_b = ((rtb_SparkSequence_o2[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S734>/motohawk_fault_def9' */
      ...
      /* S-Function (motohawk_sfun_data_write): '<S733>/motohawk_data_write' */
      ...
      BaseEngineController_A02_DWork.s735_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S736>/Unit Delay' */
      BaseEngineController_A02_DWork.s736_UnitDelay_DSTATE = rtb_CounterReset;

      /* S-Function Block: <S662>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_A02_B.s662_LogicalOperator1)[cyl])
