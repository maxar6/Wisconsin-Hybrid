/*
 * Trigger_FGND_5XRTI_PERIODIC_4476p0004.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_4476p0004(void)
{
...
#define BaseEngineController_A02_IN_PowerUp (2U)
  ...
  if (BaseEngineController_A02_DWork.s121_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S121>/MinGovernor' */
    {
       ...
       */
      rtb_Sum2_h = BaseEngineController_A02_B.s393_RPMInst -
      ...
      if (AirControlSource_DataStore() == FALSE) {
        rtb_Switch_l = BaseEngineController_A02_B.s354_Switch1;
      } else {
        rtb_Switch_l = BaseEngineController_A02_B.s360_Switch2;
      }
       ...
       */
      if (AirControlSource_DataStore() == FALSE) {
        rtb_RelOp_e = (BaseEngineController_A02_B.s368_Sum2 >
       ...
       */
      if (BaseEngineController_A02_B.s222_RelOp == FALSE) {
      ...
      BaseEngineController_A02_B.s219_MinMax1 = rtb_Sum2_h <= 1.0 ? rtb_Sum2_h :
        1.0;
      ...
      if (rtb_LogicalOperator_b) {
        rtb_Product5 = BaseEngineController_A02_B.s393_RPMInst;
      } else {
       ...
       */
      if (!rtb_LogicalOperator_b) {
        rtb_Sum2_h = BaseEngineController_A02_B.s360_Switch2;
      } else {
      ...
      /* Sum: '<S207>/Sum' */
      rtb_Sum2_h = BaseEngineController_A02_B.s542_Sum1 -
        BaseEngineController_A02_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM;
      ...
      rtb_Saturation_a = BaseEngineController_A02_B.s227_Switch >= 16000.0 ?
        16000.0 : BaseEngineController_A02_B.s227_Switch <= 0.0 ? 0.0 :
        BaseEngineController_A02_B.s227_Switch;
    ...
    /* Output and update for function-call system: '<S121>/MaxGovernor' */
    {
      ...
      /* Outputs for Enabled SubSystem: '<S188>/InGear' incorporates:
       ...
       */
      BaseEngineController_A02_B.s188_Merge = (rtb_MinMax_l <=
       ...
       *  Sum: '<S188>/Sum1'
       */
      rtb_RelationalOperator_m = (BaseEngineController_A02_B.s393_RPMInst >
        BaseEngineController_A02_B.s188_Merge -
        BaseEngineController_A02_B.s188_Merge1);

      /* RelationalOperator: '<S186>/Relational Operator2' */
      rtb_RelationalOperator2_j0 = (BaseEngineController_A02_B.s393_RPMInst >
        BaseEngineController_A02_B.s188_Merge);
      ...
      rtb_RelationalOperator_hj = (BaseEngineController_A02_B.s135_Sum <=
        BaseEngineController_A02_B.s360_Switch2 - (MaxGovTPSHyst_DataStore()));
      ...
      /* MATLAB Function Block: '<S186>/MaxGOV Stateflow' incorporates:
      ...
      /* MATLAB Function 'Foreground/Control/Controller/Run/MaxGovernor/MaxGovState/MaxGOV Stateflow': '<S190>:1' */
      ...
      /* End of MATLAB Function Block: '<S186>/MaxGOV Stateflow' */
      ...
      if (rtb_RelationalOperator_m) {
        rtb_alpha_o = BaseEngineController_A02_B.s393_RPMInst;
      } else {
      ...
      /* End of Switch: '<S187>/Preload lowpass filter with current RPM while not on Idle' */
      ...
      BaseEngineController_A02_B.s187_DontallowsetpointtoevergoabovetheTargetRPM
        = (BaseEngineController_A02_B.s188_Merge <= rtb_alpha_o) || rtIsNaN
        (rtb_alpha_o) ? BaseEngineController_A02_B.s188_Merge : rtb_alpha_o;
      ...
      /* S-Function Block: <S185>/motohawk_interpolation_1d4 */
      {
        ...
        rtb_motohawk_interpolation_1d4_l = TableInterpolation1D_real_T
          (BaseEngineController_A02_B.s309_RPMAccel17Idx, (real_T *)
      ...
      if (BaseEngineController_A02_B.s186_DataTypeConversion >= 1) {
        ...
        BaseEngineController_A02_B.s189_Switch = (rtb_Reset <=
    ...
    /* Output and update for function-call system: '<S121>/Spark Manager' */
    {
      ...
      /* S-Function Block: <S264>/motohawk_interpolation_1d1 */
      {
        ...
        rtb_motohawk_interpolation_1d1_o = TableInterpolation1D_real_T
          (BaseEngineController_A02_B.s346_motohawk_prelookup, (real_T *)
      ...
      /* S-Function Block: <S261>/motohawk_prelookup */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (EthanolPreLookupIn_DataStore()) = BaseEngineController_A02_B.s564_Merge;
      ...
      /* S-Function Block: <S260>/motohawk_prelookup */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (EGRLookupIn_DataStore()) = BaseEngineController_A02_B.s556_Merge;
        (EGRLookupIdx_DataStore()) = TablePrelookup_real_T
          (BaseEngineController_A02_B.s556_Merge, (EGRLookupIdxArr_DataStore()),
      ...
      if (BaseEngineController_A02_B.s222_RelOp) {
        /* S-Function Block: <S263>/motohawk_interpolation_1d4 */
        {
          ...
          rtb_motohawk_interpolation_1d4_i = TableInterpolation1D_real_T
            (BaseEngineController_A02_B.s388_motohawk_prelookup1, (real_T *)
       ...
       *  MinMax: '<S267>/MinMax'
       */
      BaseEngineController_A02_B.s267_MinMax1 = (rtb_Product_d <= rtb_Switch1_m)
      ...
      if (BaseEngineController_A02_DWork.s265_InitialConditionisTrue_DSTATE) {
         ...
         *  MinMax: '<S266>/MinMax'
         */
        rtb_Product_d = (BaseEngineController_A02_B.s267_MinMax1 >=
                         rtb_Product_d) || rtIsNaN(rtb_Product_d) ?
          BaseEngineController_A02_B.s267_MinMax1 : rtb_Product_d;
        BaseEngineController_A02_B.s262_Switch = (rtb_Product_d <= rtb_Switch1_m)
          || rtIsNaN(rtb_Switch1_m) ? rtb_Product_d : rtb_Switch1_m;
      }
