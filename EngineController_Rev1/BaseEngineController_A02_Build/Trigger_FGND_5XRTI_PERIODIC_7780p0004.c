/*
 * Trigger_FGND_5XRTI_PERIODIC_7780p0004.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_7780p0004(void)
{
...
#define BaseEngineController_A02_IN_PowerUp (2U)
  ...
  if (BaseEngineController_A02_DWork.s5_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S5>/Coil Control' */
    {
       ...
       *  S-Function (motohawk_sfun_data_read): '<S747>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_d = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S747>/motohawk_fault_action'
       *
       * Regarding '<S747>/motohawk_fault_action':
      ...
      /* S-Function (motohawk_sfun_data_read): '<S747>/motohawk_data_read2' */
      rtb_motohawk_data_read2 = ECUP_Enabled_DataStore();

      /* Logic: '<S747>/Logical Operator4' incorporates:
       *  Constant: '<S751>/Constant'
       *  RelationalOperator: '<S751>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S747>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_g = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S747>/EST Enable TDC Counter' */
      /* UnitDelay: '<S752>/CrankCounter' */
      BaseEngineController_A02_B.s752_CrankCounter =
        BaseEngineController_A02_DWork.s752_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S752>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_7287p0001 */
      if (BaseEngineController_A02_DWork.s752_motohawk_trigger1_DWORK1 == 0) {
       ...
       */
      BaseEngineController_A02_B.s752_RelationalOperator1 =
        ((BaseEngineController_A02_B.s754_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S752>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S752>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S752>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S753>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_A02_B.s752_RelationalOperator1 == TRUE)) {
        /* '<S753>:1:3' */
        /* '<S753>:1:4' */
        rtb_StateO_p = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_A02_B.s752_RelationalOperator1 ==
                            TRUE)) {
        /* '<S753>:1:5' */
        /* '<S753>:1:6' */
        rtb_StateO_p = 2.0;
      ...
      /* End of MATLAB Function Block: '<S752>/EST Enable TDC Counter Stateflow' */
      ...
      BaseEngineController_A02_B.s752_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S752>/CrankCounter' */
      BaseEngineController_A02_DWork.s752_CrankCounter_DSTATE = rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S747>/EST Enable TDC Counter' */

      /* Logic: '<S675>/Logical Operator1' incorporates:
       *  Logic: '<S747>/Logical Operator2'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration1'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration3'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration4'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration5'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration6'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S747>/motohawk_calibration9'
       */
      BaseEngineController_A02_B.s675_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
          (SparkEnableCyl1_DataStore()) && rtb_motohawk_data_read2 &&
          rtb_LogicalOperator4_g &&
          (BaseEngineController_A02_B.s752_DataTypeConversion != 0) &&
          BaseEngineController_A02_B.s17_OnlyEnableSparkwhenEnergyisAboveZero &&
          BaseEngineController_A02_B.s15_LogicalOperator2[0]));
      BaseEngineController_A02_B.s675_LogicalOperator1[1] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s675_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s675_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s675_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s675_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s675_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      BaseEngineController_A02_B.s675_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_d && rtb_LogicalOperator1_lo &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_A02_DWork.s749_UnitDelay_DSTATE;
       ...
       *  S-Function (motohawk_sfun_calibration): '<S749>/offset'
       */
      BaseEngineController_A02_B.s749_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S675>/Data Type Conversion' incorporates:
       *  Gain: '<S675>/Gain'
       */
      tmp_0 = 16.0 * BaseEngineController_A02_B.s749_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* End of DataTypeConversion: '<S675>/Data Type Conversion' */
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_A02_DWork.s750_UnitDelay_DSTATE;
       ...
       *  S-Function (motohawk_sfun_calibration): '<S750>/offset'
       */
      BaseEngineController_A02_B.s750_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S675>/Data Type Conversion1' incorporates:
       *  Gain: '<S675>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_A02_B.s750_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* End of DataTypeConversion: '<S675>/Data Type Conversion1' */
      /* DataTypeConversion: '<S675>/Data Type Conversion2' incorporates:
       *  Gain: '<S675>/Gain2'
       *  S-Function (motohawk_sfun_calibration): '<S675>/motohawk_calibration2'
       */
      ...
      /* S-Function Block: <S675>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_A02_B.s675_SparkSequence_o3)[i] =
            SparkSeqDiag_19_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_A02_B.s675_SparkSequence_o4)[i] =
            SparkSeqDiag_19_OnTime[i];
        }
      }

      /* RelationalOperator: '<S757>/RelOp' incorporates:
       *  Constant: '<S757>/Constant'
       */
      rtb_RelOp_a = ((rtb_SparkSequence_o1[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S748>/motohawk_fault_def' */
      ...
      /* RelationalOperator: '<S758>/RelOp' incorporates:
       *  Constant: '<S758>/Constant'
       */
      rtb_RelOp_d = ((rtb_SparkSequence_o1[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S748>/motohawk_fault_def1' */
      ...
      /* RelationalOperator: '<S755>/RelOp' incorporates:
       *  Constant: '<S755>/Constant'
       */
      rtb_RelOp_p = ((rtb_SparkSequence_o2[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S748>/motohawk_fault_def8' */
      ...
      /* RelationalOperator: '<S756>/RelOp' incorporates:
       *  Constant: '<S756>/Constant'
       */
      rtb_RelOp_b = ((rtb_SparkSequence_o2[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S748>/motohawk_fault_def9' */
      ...
      BaseEngineController_A02_DWork.s749_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S750>/Unit Delay' */
      BaseEngineController_A02_DWork.s750_UnitDelay_DSTATE = rtb_CounterReset;

      /* S-Function Block: <S675>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_A02_B.s675_LogicalOperator1)[cyl])
