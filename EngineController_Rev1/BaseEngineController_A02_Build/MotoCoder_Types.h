...
typedef enum {
    VARDECENUM_26_DASH=0,
    VARDECENUM_26_STALL=1,
    VARDECENUM_26_CRANK=2,
    VARDECENUM_26_RUN=3,
} E_VarDecEnum_26;
...
typedef enum {
    VARDECENUM_30_RISINGEDGE=0,
    VARDECENUM_30_FALLINGEDGE=1,
} E_VarDecEnum_30;

/* VarDecEnum_31 Enumeration */
typedef enum {
    VARDECENUM_31_WEAKPULLUP=0,
    VARDECENUM_31_STRONGPULLUP=1,
} E_VarDecEnum_31;
...
typedef enum {
    VARDECENUM_33_STANDARDOPENPARENCOILPERCYLINDERCLOSEPAREN=0,
    VARDECENUM_33_BANKEDOPENPARENFIREONBOTHPHASESUNTILCAMSYNCCLOSEPAREN=1,
    VARDECENUM_33_BATCHOPENPARENWASTEDSPARKCLOSEPAREN=2,
    VARDECENUM_33_MUXEDOPENPARENDISTRIBUTEDCLOSEPAREN=3,
} E_VarDecEnum_33;

/* VarDecEnum_34 Enumeration */
typedef enum {
    VARDECENUM_34_OPENPARENNONECLOSEPAREN=-1,
    VARDECENUM_34_FINJ1=12,
    VARDECENUM_34_AINJ4=21,
    VARDECENUM_34_AINJ5=22,
    VARDECENUM_34_AINJ6=23,
    VARDECENUM_34_FINJ2=13,
    VARDECENUM_34_FINJ3=14,
    VARDECENUM_34_FINJ4=15,
    VARDECENUM_34_FINJ5=16,
    VARDECENUM_34_FINJ6=17,
    VARDECENUM_34_AINJ1=18,
    VARDECENUM_34_AINJ2=19,
    VARDECENUM_34_AINJ3=20,
} E_VarDecEnum_34;

/* VarDecEnum_35 Enumeration */
typedef enum {
    VARDECENUM_35_STANDARDOPENPARENINJECTORPERCYLINDERCLOSEPAREN=0,
    VARDECENUM_35_BATCHOPENPARENFIREHALFFUELONHALFOFTHEINJECTORSEVERYREVCLOSEPAREN=1,
    VARDECENUM_35_WASTEDOPENPARENFIREHALFFUELONALLINJECTORSEVERYREVCLOSEPAREN=2,
} E_VarDecEnum_35;

/* VarDecEnum_36 Enumeration */
typedef enum {
    VARDECENUM_36_STANDARD=0,
    VARDECENUM_36_TRANSIENT=1,
} E_VarDecEnum_36;

/* VarDecEnum_38 Enumeration */
typedef enum {
    VARDECENUM_38_CUTTHROTTLE=0,
    VARDECENUM_38_DELAYEDENGINESHUTDOWN=1,
    VARDECENUM_38_DISABLEO2CTRL=2,
    VARDECENUM_38_ENGINESHUTDOWN=3,
    VARDECENUM_38_HARDREVLIMIT=4,
    VARDECENUM_38_MEDIUMREVLIMIT=5,
    VARDECENUM_38_SOFTREVLIMIT=6,
} E_VarDecEnum_38;

/* VarDecEnum_39 Enumeration */
typedef enum {
    VARDECENUM_39_DASH=0,
} E_VarDecEnum_39;
...
typedef enum {
    ...
    VARDECENUM_40_ECUP=53,
    VARDECENUM_40_AN7M=62,
    VARDECENUM_40_AN8M=63,
    VARDECENUM_40_AN9M=64,
    VARDECENUM_40_AN10M=65,
    VARDECENUM_40_AN11M=66,
    VARDECENUM_40_AN12M=67,
    VARDECENUM_40_AN13M=68,
    VARDECENUM_40_AN14M=69,
    VARDECENUM_40_AN15M=70,
    VARDECENUM_40_AN16M=71,
    VARDECENUM_40_DRVP=54,
    VARDECENUM_40_AN17M=72,
    VARDECENUM_40_AN18M=73,
    VARDECENUM_40_AN19M=74,
    VARDECENUM_40_O2A=90,
    VARDECENUM_40_O2B=91,
    VARDECENUM_40_XDRP_B=92,
    VARDECENUM_40_XDRP=55,
    VARDECENUM_40_AN1M=56,
    VARDECENUM_40_AN2M=57,
    VARDECENUM_40_AN3M=58,
    VARDECENUM_40_AN4M=59,
    VARDECENUM_40_AN5M=60,
    VARDECENUM_40_AN6M=61,
} E_VarDecEnum_40;

/* VarDecEnum_41 Enumeration */
typedef enum {
    VARDECENUM_41_5V=0,
    VARDECENUM_41_2POINT7V=1,
} E_VarDecEnum_41;

/* VarDecEnum_42 Enumeration */
typedef enum {
    VARDECENUM_42_OPENPARENNONECLOSEPAREN=-1,
    VARDECENUM_42_DG1M=93,
    VARDECENUM_42_DG2M=94,
    VARDECENUM_42_DG4M=96,
    VARDECENUM_42_CNK=100,
} E_VarDecEnum_42;

/* VarDecEnum_43 Enumeration */
typedef enum {
    VARDECENUM_43_NOALIASPROTECT=0,
    VARDECENUM_43_USEALIASPROTECT=1,
} E_VarDecEnum_43;

/* VarDecEnum_44 Enumeration */
typedef enum {
    VARDECENUM_44_DIGITALINPUT=0,
    VARDECENUM_44_VRINPUT=1,
} E_VarDecEnum_44;
