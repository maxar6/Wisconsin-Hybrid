/*
 * Trigger_BGND_BASE_PERIODIC_8373p0001.c
 *
...
void Trigger_BGND_BASE_PERIODIC_8373p0001(void)
{
...
#define BaseEngineController_A02_IN_PowerUp (2U)

  {
    /* Output and update for function-call system: '<S3>/Main Power Relay' */
    {
      ...
      /* S-Function Block: DOut8341p0001 */
      {
        DOut8341p0001_DiscreteOutput_Set(rtb_Merge);
      }
