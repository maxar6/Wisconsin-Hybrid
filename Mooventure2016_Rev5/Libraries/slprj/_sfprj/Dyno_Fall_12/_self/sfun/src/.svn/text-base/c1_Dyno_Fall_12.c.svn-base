...
static void initialize_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void initialize_params_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void enable_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void disable_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_Dyno_Fall_12
  (SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Dyno_Fall_12
  (SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
static void set_sim_state_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_Dyno_Fall_12
  (SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
static void finalize_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void sf_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
static void c1_Batterybootup(SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
static void c1_Charging_and_Temp(SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
...
static boolean_T c1_emlrt_marshallIn(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c1_Keyed_Relay, const char_T *c1_name);
static uint8_T c1_b_emlrt_marshallIn(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Dyno_Fall_12, const char_T
  *c1_name);
static const mxArray *c1_c_emlrt_marshallIn(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_name);
static void init_test_point_addr_map(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static void **get_test_point_address_map(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance);
static rtwCAPI_ModelMappingInfo *get_test_point_mapping_info
  (SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
static void init_dsm_address_info(SFc1_Dyno_Fall_12InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Dyno_Fall_12 = 0U;
  chartInstance->c1_is_c1_Dyno_Fall_12 = 0U;
  ...
  (SFc1_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c1_is_active_c1_Dyno_Fall_12 == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG,0);
  }

  if (chartInstance->c1_is_c1_Dyno_Fall_12 == c1_IN_Initial) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,2);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,2);
  }

  if (chartInstance->c1_is_c1_Dyno_Fall_12 == c1_IN_Batterybootup) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,0);
  }

  if (chartInstance->c1_is_c1_Dyno_Fall_12 == c1_IN_Charging_and_Temp) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,1);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,1);
  }

  if (chartInstance->c1_is_c1_Dyno_Fall_12 == c1_IN_Normal_Operation) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,4);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,4);
  }

  if (chartInstance->c1_is_c1_Dyno_Fall_12 == c1_IN_Shutdown_Sequence) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,5);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,5);
  }

  if (chartInstance->c1_is_c1_Dyno_Fall_12 == c1_IN_Kill_Component_Keyed) {
  ...
  (SFc1_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_Dyno_Fall_12;
  c1_e_u = c1_e_hoistedGlobal;
  c1_f_y = NULL;
  sf_mex_assign(&c1_f_y, sf_mex_create("y", &c1_e_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c1_y, 4, c1_f_y);
  c1_f_hoistedGlobal = chartInstance->c1_is_c1_Dyno_Fall_12;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_Vehicle_Ready = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_Dyno_Fall_12 = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_Dyno_Fall_12");
  chartInstance->c1_is_c1_Dyno_Fall_12 = c1_b_emlrt_marshallIn(chartInstance,
  ...
  c1_update_debugger_state_c1_Dyno_Fall_12(chartInstance);
...
static void sf_c1_Dyno_Fall_12(SFc1_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_Dyno_Fall_12(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if ((int16_T)chartInstance->c1_is_active_c1_Dyno_Fall_12 == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG,0);
    chartInstance->c1_is_active_c1_Dyno_Fall_12 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,0);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG,0);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,0);
    chartInstance->c1_is_c1_Dyno_Fall_12 = c1_IN_Initial;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,2);
    chartInstance->c1_tp_Initial = 1U;
  } else {
    switch (chartInstance->c1_is_c1_Dyno_Fall_12) {
     ...
     case c1_IN_Initial:
      ...
      if (CV_TRANSITION_EVAL(1U, !(_SFD_CCP_CALL(1,0,((*c1_Shutdown)!=0)) != 0))
        ...
        chartInstance->c1_is_c1_Dyno_Fall_12 = c1_IN_Batterybootup;
        _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
        chartInstance->c1_tp_Batterybootup = 1U;
      } else {
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG,9);
        if (CV_TRANSITION_EVAL(9U, (int32_T)_SFD_CCP_CALL(9,0,((*c1_Shutdown)!=0)))
            != 0) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG,2);
          _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,2);
          chartInstance->c1_is_c1_Dyno_Fall_12 = c1_IN_Shutdown_Sequence;
          _SFD_CS_CALL(STATE_ACTIVE_TAG,5);
          chartInstance->c1_tp_Shutdown_Sequence = 1U;
        } else {
          *c1_Vehicle_Enable = FALSE;
     ...
     case c1_IN_Normal_Operation:
      ...
      if (CV_TRANSITION_EVAL(6U, (int32_T)_SFD_CCP_CALL(6,0,((*c1_Shutdown)!=0)))
          != 0) {
        if (sf_debug_transition_conflict_check_enabled()) {
          unsigned int transitionList[2];
          unsigned int numTransitions= 1;
        ...
        if (CV_TRANSITION_EVAL(7U, (int32_T)_SFD_CCP_CALL(7,0,((*c1_Charging)!=0)))
            != 0) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG,4);
          _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,4);
          chartInstance->c1_is_c1_Dyno_Fall_12 = c1_IN_Charging_and_Temp;
          _SFD_CS_CALL(STATE_ACTIVE_TAG,1);
          chartInstance->c1_tp_Charging_and_Temp = 1U;
        } else {
     ...
     case c1_IN_Shutdown_Sequence:
      ...
      if (CV_TRANSITION_EVAL(8U, !(_SFD_CCP_CALL(8,0,((*c1_Batt_Contactor_Status)
              !=0)) != 0)) != 0) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,8);
        _SFD_CS_CALL(STATE_ENTER_EXIT_FUNCTION_TAG,5);
        chartInstance->c1_tp_Shutdown_Sequence = 0U;
        chartInstance->c1_is_c1_Dyno_Fall_12 = (uint8_T)c1_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG,5);
        _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,5);
        chartInstance->c1_is_c1_Dyno_Fall_12 = c1_IN_Kill_Component_Keyed;
        _SFD_CS_CALL(STATE_ACTIVE_TAG,3);
        chartInstance->c1_tp_Kill_Component_Keyed = 1U;
      } else {
        *c1_Vehicle_Enable = FALSE;
...
static void c1_Batterybootup(SFc1_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4,0,((*c1_Shutdown)!=0))) !=
    ...
    if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2,0,((*c1_Batt_Load_Enable)
           !=0))) != 0) {
...
static void c1_Charging_and_Temp(SFc1_Dyno_Fall_12InstanceStruct *chartInstance)
{
  ...
  if (CV_TRANSITION_EVAL(5U, (int32_T)_SFD_CCP_CALL(5,0,((*c1_Shutdown)!=0))) !=
    ...
    if (CV_TRANSITION_EVAL(3U, !(_SFD_CCP_CALL(3,0,((*c1_Charging)!=0)) != 0))
        != 0) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG,1);
      _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG,1);
      chartInstance->c1_is_c1_Dyno_Fall_12 = c1_IN_Normal_Operation;
      _SFD_CS_CALL(STATE_ACTIVE_TAG,4);
      chartInstance->c1_tp_Normal_Operation = 1U;
    } else {
      *c1_Vehicle_Enable = TRUE;
...
const mxArray *sf_c1_Dyno_Fall_12_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_Dyno_Fall_12InstanceStruct *chartInstance;
  chartInstance = (SFc1_Dyno_Fall_12InstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  c1_b_u = *((uint8_T *)c1_u);
  c1_b_y = NULL;
...
static boolean_T c1_emlrt_marshallIn(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c1_Keyed_Relay, const char_T *
  c1_name)
{
  boolean_T c1_y;
  boolean_T c1_b18;
...
static uint8_T c1_b_emlrt_marshallIn(SFc1_Dyno_Fall_12InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Dyno_Fall_12,
  const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_Dyno_Fall_12), &c1_u0, 1,
                3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_Dyno_Fall_12);
  return c1_y;
}
...
void sf_c1_Dyno_Fall_12_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(833156064U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(432681143U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(637512513U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1087659005U);
}

mxArray *sf_c1_Dyno_Fall_12_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c1_Dyno_Fall_12(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[7],T\"Keyed_Relay\",},{M[1],M[6],T\"Torque_Enable\",},{M[1],M[4],T\"Vehicle_Enable\",},{M[1],M[5],T\"Vehicle_Ready\",},{M[8],M[0],T\"is_active_c1_Dyno_Fall_12\",},{M[9],M[0],T\"is_c1_Dyno_Fall_12\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Dyno_Fall_12_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_Dyno_Fall_12InstanceStruct *chartInstance;
    chartInstance = (SFc1_Dyno_Fall_12InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_Dyno_Fall_12(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Dyno_Fall_12InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*)
    chartInstanceVar);
  initialize_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Dyno_Fall_12(void *chartInstanceVar)
{
  enable_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Dyno_Fall_12(void *chartInstanceVar)
{
  disable_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Dyno_Fall_12(void *chartInstanceVar)
{
  sf_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_Dyno_Fall_12(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Dyno_Fall_12
    ((SFc1_Dyno_Fall_12InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_Dyno_Fall_12();/* state var info */
...
static void sf_internal_set_sim_state_c1_Dyno_Fall_12(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Dyno_Fall_12();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_Dyno_Fall_12(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Dyno_Fall_12(S);
}

static void sf_opaque_set_sim_state_c1_Dyno_Fall_12(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c1_Dyno_Fall_12(S, st);
}

static void sf_opaque_terminate_c1_Dyno_Fall_12(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Dyno_Fall_12InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_Dyno_Fall_12((SFc1_Dyno_Fall_12InstanceStruct*) chartInstanceVar);
    if (!sim_mode_is_rtw_gen(S)) {
...
static void mdlProcessParameters_c1_Dyno_Fall_12(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Dyno_Fall_12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Dyno_Fall_12","Dyno_Fall_12",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("Dyno_Fall_12","Dyno_Fall_12",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Dyno_Fall_12",
      "Dyno_Fall_12",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Dyno_Fall_12","Dyno_Fall_12",1,4);
      sf_mark_chart_reusable_outputs(S,"Dyno_Fall_12","Dyno_Fall_12",1,4);
    }

    sf_set_rtw_dwork_info(S,"Dyno_Fall_12","Dyno_Fall_12",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(2149333293U));
  ssSetChecksum1(S,(1270113084U));
  ssSetChecksum2(S,(903248759U));
  ssSetChecksum3(S,(2846332776U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_Dyno_Fall_12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Dyno_Fall_12", "Dyno_Fall_12",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c1_Dyno_Fall_12(SimStruct *S)
{
  SFc1_Dyno_Fall_12InstanceStruct *chartInstance;
  chartInstance = (SFc1_Dyno_Fall_12InstanceStruct *)malloc(sizeof
    (SFc1_Dyno_Fall_12InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Dyno_Fall_12InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_Dyno_Fall_12;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Dyno_Fall_12;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_Dyno_Fall_12;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Dyno_Fall_12;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Dyno_Fall_12;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_Dyno_Fall_12;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_Dyno_Fall_12;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Dyno_Fall_12;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Dyno_Fall_12;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Dyno_Fall_12;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_Dyno_Fall_12;
...
void c1_Dyno_Fall_12_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Dyno_Fall_12(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Dyno_Fall_12(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Dyno_Fall_12(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Dyno_Fall_12_method_dispatcher.\n"
