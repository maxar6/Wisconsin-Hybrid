...
CANFrame RxSlot_3053p0002_ReceiveFrame;
boolean_T RxSlot_3053p0002_ReceiveFrameValid;
boolean_T RxSlot_3053p0002_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3053p0002_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3053p0002_ReceiveFrame.extended;
	if (id) *id = RxSlot_3053p0002_ReceiveFrame.id;
	if (length) *length = RxSlot_3053p0002_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3053p0002_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3053p0002_ReceiveFrame.data[i];
		}
	}
	RxSlot_3053p0002_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3054p0001_ReceiveFrame;
boolean_T RxSlot_3054p0001_ReceiveFrameValid;
boolean_T RxSlot_3054p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3054p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3054p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3054p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3054p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3054p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3054p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3054p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3055p0001_ReceiveFrame;
boolean_T RxSlot_3055p0001_ReceiveFrameValid;
boolean_T RxSlot_3055p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3055p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3055p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3055p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3055p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3055p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3055p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3055p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_10273p001_ReceiveFrame;
boolean_T RxSlot_10273p001_ReceiveFrameValid;
boolean_T RxSlot_10273p001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_10273p001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_10273p001_ReceiveFrame.extended;
	if (id) *id = RxSlot_10273p001_ReceiveFrame.id;
	if (length) *length = RxSlot_10273p001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_10273p001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_10273p001_ReceiveFrame.data[i];
		}
	}
	RxSlot_10273p001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3670p0001_ReceiveFrame;
boolean_T RxSlot_3670p0001_ReceiveFrameValid;
boolean_T RxSlot_3670p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3670p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3670p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3670p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3670p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3670p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3670p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3670p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3729p0001_ReceiveFrame;
boolean_T RxSlot_3729p0001_ReceiveFrameValid;
boolean_T RxSlot_3729p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3729p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3729p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3729p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3729p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3729p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3729p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3729p0001_ReceiveFrameValid = 0;
...
CANFrame_Queue RxSlot_3858p0001_ReceiveQueue;
CANFrame RxSlot_3858p0001_ReceiveQueueFrames[2];
boolean_T RxSlot_3858p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{

	CANFrame rxFrame;
	int32_T i;
	if (!CANFrame_Queue_Dequeue(&RxSlot_3858p0001_ReceiveQueue, &rxFrame)) {
		return 0;
	}
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3859p0001_ReceiveFrame;
boolean_T RxSlot_3859p0001_ReceiveFrameValid;
boolean_T RxSlot_3859p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3859p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3859p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3859p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3859p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3859p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3859p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3859p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3860p0001_ReceiveFrame;
boolean_T RxSlot_3860p0001_ReceiveFrameValid;
boolean_T RxSlot_3860p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3860p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3860p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3860p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3860p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3860p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3860p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3860p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3861p0001_ReceiveFrame;
boolean_T RxSlot_3861p0001_ReceiveFrameValid;
boolean_T RxSlot_3861p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3861p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3861p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3861p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3861p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3861p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3861p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3861p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4019p0001_ReceiveFrame;
boolean_T RxSlot_4019p0001_ReceiveFrameValid;
boolean_T RxSlot_4019p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4019p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4019p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4019p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4019p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4019p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4019p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4019p0001_ReceiveFrameValid = 0;
...
void CAN_1_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3053p0002_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3053p0002_ReceiveFrameValid = 1;
		}
		/* RxSlot_3054p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3054p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3054p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3055p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3055p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3055p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_10273p001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_10273p001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_10273p001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3670p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3670p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3670p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3729p0001 */
		if (
			(frame->extended == 1) &&
		...
		{
			memcpy(&RxSlot_3729p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3729p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3858p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			CANFrame_Queue_Enqueue(&RxSlot_3858p0001_ReceiveQueue, frame);
		}
		/* RxSlot_3859p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3859p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3859p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3860p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3860p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3860p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3861p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3861p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3861p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4019p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4019p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4019p0001_ReceiveFrameValid = 1;
		}
		/* CAN_1_KeySuite */
		if (
			(frame->extended == 1) &&
...
void CAN_1_Create(void)
{
	...
	CANFrame_Queue_Create(&RxSlot_3858p0001_ReceiveQueue, RxSlot_3858p0001_ReceiveQueueFrames, sizeof(RxSlot_3858p0001_ReceiveQueueFrames)/sizeof(CANFrame));
	RxSlot_3859p0001_ReceiveFrameValid = 0;
	RxSlot_3860p0001_ReceiveFrameValid = 0;
	RxSlot_3861p0001_ReceiveFrameValid = 0;
	RxSlot_4019p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3672p0001_ReceiveFrame;
boolean_T RxSlot_3672p0001_ReceiveFrameValid;
boolean_T RxSlot_3672p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3672p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3672p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3672p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3672p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3672p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3672p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3672p0001_ReceiveFrameValid = 0;
...
void CAN_2_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3672p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3672p0001_ReceiveFrameValid = 1;
		}
		/* CAN_2_KeySuite */
		if (
			(frame->extended == 1) &&
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3251p0001_ReceiveFrame;
boolean_T RxSlot_3251p0001_ReceiveFrameValid;
boolean_T RxSlot_3251p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3251p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3251p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3251p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3251p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3251p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3251p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3251p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3252p0001_ReceiveFrame;
boolean_T RxSlot_3252p0001_ReceiveFrameValid;
boolean_T RxSlot_3252p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3252p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3252p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3252p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3252p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3252p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3252p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3252p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3253p0001_ReceiveFrame;
boolean_T RxSlot_3253p0001_ReceiveFrameValid;
boolean_T RxSlot_3253p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3253p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3253p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3253p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3253p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3253p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3253p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3253p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3254p0001_ReceiveFrame;
boolean_T RxSlot_3254p0001_ReceiveFrameValid;
boolean_T RxSlot_3254p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3254p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3254p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3254p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3254p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3254p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3254p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3254p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3255p0001_ReceiveFrame;
boolean_T RxSlot_3255p0001_ReceiveFrameValid;
boolean_T RxSlot_3255p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3255p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3255p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3255p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3255p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3255p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3255p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3255p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3256p0001_ReceiveFrame;
boolean_T RxSlot_3256p0001_ReceiveFrameValid;
boolean_T RxSlot_3256p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3256p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3256p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3256p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3256p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3256p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3256p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3256p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3257p0001_ReceiveFrame;
boolean_T RxSlot_3257p0001_ReceiveFrameValid;
boolean_T RxSlot_3257p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3257p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3257p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3257p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3257p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3257p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3257p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3257p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3669p0004_ReceiveFrame;
boolean_T RxSlot_3669p0004_ReceiveFrameValid;
boolean_T RxSlot_3669p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3669p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3669p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3669p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3669p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3669p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3669p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3669p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3671p0001_ReceiveFrame;
boolean_T RxSlot_3671p0001_ReceiveFrameValid;
boolean_T RxSlot_3671p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3671p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3671p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3671p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3671p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3671p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3671p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3671p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3808p0001_ReceiveFrame;
boolean_T RxSlot_3808p0001_ReceiveFrameValid;
boolean_T RxSlot_3808p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3808p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3808p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3808p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3808p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3808p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3808p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3808p0001_ReceiveFrameValid = 0;
...
void CAN_3_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3251p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3251p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3252p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3252p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3252p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3253p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3253p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3253p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3254p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3254p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3254p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3255p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3255p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3255p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3256p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3256p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3256p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3257p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3257p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3257p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3669p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3669p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3669p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3671p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3671p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3671p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3808p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3808p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3808p0001_ReceiveFrameValid = 1;
		}
		/* CAN_3_KeySuite */
		if (
			(frame->extended == 1) &&
