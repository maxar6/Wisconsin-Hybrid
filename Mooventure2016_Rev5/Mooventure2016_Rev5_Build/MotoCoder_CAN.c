...
CANFrame RxSlot_3129p0005_ReceiveFrame;
boolean_T RxSlot_3129p0005_ReceiveFrameValid;
boolean_T RxSlot_3129p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3129p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3129p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3129p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3129p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3129p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3129p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3129p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3130p0004_ReceiveFrame;
boolean_T RxSlot_3130p0004_ReceiveFrameValid;
boolean_T RxSlot_3130p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3130p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3130p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3130p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3130p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3130p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3130p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3130p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3131p0004_ReceiveFrame;
boolean_T RxSlot_3131p0004_ReceiveFrameValid;
boolean_T RxSlot_3131p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3131p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3131p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3131p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3131p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3131p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3131p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3131p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3553p0006_ReceiveFrame;
boolean_T RxSlot_3553p0006_ReceiveFrameValid;
boolean_T RxSlot_3553p0006_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3553p0006_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3553p0006_ReceiveFrame.extended;
	if (id) *id = RxSlot_3553p0006_ReceiveFrame.id;
	if (length) *length = RxSlot_3553p0006_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3553p0006_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3553p0006_ReceiveFrame.data[i];
		}
	}
	RxSlot_3553p0006_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3791p0001_ReceiveFrame;
boolean_T RxSlot_3791p0001_ReceiveFrameValid;
boolean_T RxSlot_3791p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3791p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3791p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3791p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3791p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3791p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3791p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3791p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3904p0001_ReceiveFrame;
boolean_T RxSlot_3904p0001_ReceiveFrameValid;
boolean_T RxSlot_3904p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3904p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3904p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3904p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3904p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3904p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3904p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3904p0001_ReceiveFrameValid = 0;
...
CANFrame_Queue RxSlot_4058p0001_ReceiveQueue;
CANFrame RxSlot_4058p0001_ReceiveQueueFrames[2];
boolean_T RxSlot_4058p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{

	CANFrame rxFrame;
	int32_T i;
	if (!CANFrame_Queue_Dequeue(&RxSlot_4058p0001_ReceiveQueue, &rxFrame)) {
		return 0;
	}
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4059p0001_ReceiveFrame;
boolean_T RxSlot_4059p0001_ReceiveFrameValid;
boolean_T RxSlot_4059p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4059p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4059p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4059p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4059p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4059p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4059p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4059p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4060p0001_ReceiveFrame;
boolean_T RxSlot_4060p0001_ReceiveFrameValid;
boolean_T RxSlot_4060p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4060p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4060p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4060p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4060p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4060p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4060p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4060p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4061p0001_ReceiveFrame;
boolean_T RxSlot_4061p0001_ReceiveFrameValid;
boolean_T RxSlot_4061p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4061p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4061p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4061p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4061p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4061p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4061p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4061p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4263p0001_ReceiveFrame;
boolean_T RxSlot_4263p0001_ReceiveFrameValid;
boolean_T RxSlot_4263p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4263p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4263p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4263p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4263p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4263p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4263p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4263p0001_ReceiveFrameValid = 0;
...
void CAN_1_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3129p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3129p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3130p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3130p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3130p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3131p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3131p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3131p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3553p0006 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3553p0006_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3553p0006_ReceiveFrameValid = 1;
		}
		/* RxSlot_3791p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3791p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3791p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3904p0001 */
		if (
			(frame->extended == 1) &&
		...
		{
			memcpy(&RxSlot_3904p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3904p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4058p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			CANFrame_Queue_Enqueue(&RxSlot_4058p0001_ReceiveQueue, frame);
		}
		/* RxSlot_4059p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4059p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4059p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4060p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4060p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4060p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4061p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4061p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4061p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4263p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4263p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4263p0001_ReceiveFrameValid = 1;
		}
		/* CCP1 */
		if (
			(frame->extended == 1) &&
...
void CAN_1_Create(void)
{
	...
	CANFrame_Queue_Create(&RxSlot_4058p0001_ReceiveQueue, RxSlot_4058p0001_ReceiveQueueFrames, sizeof(RxSlot_4058p0001_ReceiveQueueFrames)/sizeof(CANFrame));
	RxSlot_4059p0001_ReceiveFrameValid = 0;
	RxSlot_4060p0001_ReceiveFrameValid = 0;
	RxSlot_4061p0001_ReceiveFrameValid = 0;
	RxSlot_4263p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3793p0001_ReceiveFrame;
boolean_T RxSlot_3793p0001_ReceiveFrameValid;
boolean_T RxSlot_3793p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3793p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3793p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3793p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3793p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3793p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3793p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3793p0001_ReceiveFrameValid = 0;
...
void CAN_2_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3793p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3793p0001_ReceiveFrameValid = 1;
		}
		/* CAN_2_KeySuite */
		if (
			(frame->extended == 1) &&
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3337p0004_ReceiveFrame;
boolean_T RxSlot_3337p0004_ReceiveFrameValid;
boolean_T RxSlot_3337p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3337p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3337p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3337p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3337p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3337p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3337p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3337p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3338p0004_ReceiveFrame;
boolean_T RxSlot_3338p0004_ReceiveFrameValid;
boolean_T RxSlot_3338p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3338p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3338p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3338p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3338p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3338p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3338p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3338p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3339p0004_ReceiveFrame;
boolean_T RxSlot_3339p0004_ReceiveFrameValid;
boolean_T RxSlot_3339p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3339p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3339p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3339p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3339p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3339p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3339p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3339p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3340p0004_ReceiveFrame;
boolean_T RxSlot_3340p0004_ReceiveFrameValid;
boolean_T RxSlot_3340p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3340p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3340p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3340p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3340p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3340p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3340p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3340p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3341p0004_ReceiveFrame;
boolean_T RxSlot_3341p0004_ReceiveFrameValid;
boolean_T RxSlot_3341p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3341p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3341p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3341p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3341p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3341p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3341p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3341p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3342p0004_ReceiveFrame;
boolean_T RxSlot_3342p0004_ReceiveFrameValid;
boolean_T RxSlot_3342p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3342p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3342p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3342p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3342p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3342p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3342p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3342p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3343p0004_ReceiveFrame;
boolean_T RxSlot_3343p0004_ReceiveFrameValid;
boolean_T RxSlot_3343p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3343p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3343p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3343p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3343p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3343p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3343p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3343p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3790p0004_ReceiveFrame;
boolean_T RxSlot_3790p0004_ReceiveFrameValid;
boolean_T RxSlot_3790p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3790p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3790p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3790p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3790p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3790p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3790p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3790p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3792p0001_ReceiveFrame;
boolean_T RxSlot_3792p0001_ReceiveFrameValid;
boolean_T RxSlot_3792p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3792p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3792p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3792p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3792p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3792p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3792p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3792p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4001p0001_ReceiveFrame;
boolean_T RxSlot_4001p0001_ReceiveFrameValid;
boolean_T RxSlot_4001p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4001p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4001p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4001p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4001p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4001p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4001p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4001p0001_ReceiveFrameValid = 0;
...
void CAN_3_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3337p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3337p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3338p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3338p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3338p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3339p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3339p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3339p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3340p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3340p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3340p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3341p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3341p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3341p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3342p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3342p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3342p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3343p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3343p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3343p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3790p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3790p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3790p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3792p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3792p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3792p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4001p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4001p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4001p0001_ReceiveFrameValid = 1;
		}
		/* CAN_3_KeySuite */
		if (
			(frame->extended == 1) &&
