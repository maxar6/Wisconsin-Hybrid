...
CANFrame RxSlot_3064p0002_ReceiveFrame;
boolean_T RxSlot_3064p0002_ReceiveFrameValid;
boolean_T RxSlot_3064p0002_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3064p0002_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3064p0002_ReceiveFrame.extended;
	if (id) *id = RxSlot_3064p0002_ReceiveFrame.id;
	if (length) *length = RxSlot_3064p0002_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3064p0002_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3064p0002_ReceiveFrame.data[i];
		}
	}
	RxSlot_3064p0002_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3065p0001_ReceiveFrame;
boolean_T RxSlot_3065p0001_ReceiveFrameValid;
boolean_T RxSlot_3065p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3065p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3065p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3065p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3065p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3065p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3065p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3065p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3066p0001_ReceiveFrame;
boolean_T RxSlot_3066p0001_ReceiveFrameValid;
boolean_T RxSlot_3066p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3066p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3066p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3066p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3066p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3066p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3066p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3066p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3478p0004_ReceiveFrame;
boolean_T RxSlot_3478p0004_ReceiveFrameValid;
boolean_T RxSlot_3478p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3478p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3478p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3478p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3478p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3478p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3478p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3478p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3698p0001_ReceiveFrame;
boolean_T RxSlot_3698p0001_ReceiveFrameValid;
boolean_T RxSlot_3698p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3698p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3698p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3698p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3698p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3698p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3698p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3698p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3757p0001_ReceiveFrame;
boolean_T RxSlot_3757p0001_ReceiveFrameValid;
boolean_T RxSlot_3757p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3757p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3757p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3757p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3757p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3757p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3757p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3757p0001_ReceiveFrameValid = 0;
...
CANFrame_Queue RxSlot_3886p0001_ReceiveQueue;
CANFrame RxSlot_3886p0001_ReceiveQueueFrames[2];
boolean_T RxSlot_3886p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{

	CANFrame rxFrame;
	int32_T i;
	if (!CANFrame_Queue_Dequeue(&RxSlot_3886p0001_ReceiveQueue, &rxFrame)) {
		return 0;
	}
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3887p0001_ReceiveFrame;
boolean_T RxSlot_3887p0001_ReceiveFrameValid;
boolean_T RxSlot_3887p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3887p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3887p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3887p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3887p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3887p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3887p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3887p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3888p0001_ReceiveFrame;
boolean_T RxSlot_3888p0001_ReceiveFrameValid;
boolean_T RxSlot_3888p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3888p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3888p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3888p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3888p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3888p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3888p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3888p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3889p0001_ReceiveFrame;
boolean_T RxSlot_3889p0001_ReceiveFrameValid;
boolean_T RxSlot_3889p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3889p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3889p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3889p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3889p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3889p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3889p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3889p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4047p0001_ReceiveFrame;
boolean_T RxSlot_4047p0001_ReceiveFrameValid;
boolean_T RxSlot_4047p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4047p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4047p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4047p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4047p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4047p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4047p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4047p0001_ReceiveFrameValid = 0;
...
void CAN_1_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3064p0002_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3064p0002_ReceiveFrameValid = 1;
		}
		/* RxSlot_3065p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3065p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3065p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3066p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3066p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3066p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3478p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3478p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3478p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3698p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3698p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3698p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3757p0001 */
		if (
			(frame->extended == 1) &&
		...
		{
			memcpy(&RxSlot_3757p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3757p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3886p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			CANFrame_Queue_Enqueue(&RxSlot_3886p0001_ReceiveQueue, frame);
		}
		/* RxSlot_3887p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3887p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3887p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3888p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3888p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3888p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3889p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3889p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3889p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4047p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4047p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4047p0001_ReceiveFrameValid = 1;
		}
		/* CAN_1_KeySuite */
		if (
			(frame->extended == 1) &&
...
void CAN_1_Create(void)
{
	...
	CANFrame_Queue_Create(&RxSlot_3886p0001_ReceiveQueue, RxSlot_3886p0001_ReceiveQueueFrames, sizeof(RxSlot_3886p0001_ReceiveQueueFrames)/sizeof(CANFrame));
	RxSlot_3887p0001_ReceiveFrameValid = 0;
	RxSlot_3888p0001_ReceiveFrameValid = 0;
	RxSlot_3889p0001_ReceiveFrameValid = 0;
	RxSlot_4047p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3700p0001_ReceiveFrame;
boolean_T RxSlot_3700p0001_ReceiveFrameValid;
boolean_T RxSlot_3700p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3700p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3700p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3700p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3700p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3700p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3700p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3700p0001_ReceiveFrameValid = 0;
...
void CAN_2_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3700p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3700p0001_ReceiveFrameValid = 1;
		}
		/* CAN_2_KeySuite */
		if (
			(frame->extended == 1) &&
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3262p0001_ReceiveFrame;
boolean_T RxSlot_3262p0001_ReceiveFrameValid;
boolean_T RxSlot_3262p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3262p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3262p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3262p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3262p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3262p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3262p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3262p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3263p0001_ReceiveFrame;
boolean_T RxSlot_3263p0001_ReceiveFrameValid;
boolean_T RxSlot_3263p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3263p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3263p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3263p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3263p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3263p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3263p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3263p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3264p0001_ReceiveFrame;
boolean_T RxSlot_3264p0001_ReceiveFrameValid;
boolean_T RxSlot_3264p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3264p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3264p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3264p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3264p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3264p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3264p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3264p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3265p0001_ReceiveFrame;
boolean_T RxSlot_3265p0001_ReceiveFrameValid;
boolean_T RxSlot_3265p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3265p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3265p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3265p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3265p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3265p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3265p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3265p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3266p0001_ReceiveFrame;
boolean_T RxSlot_3266p0001_ReceiveFrameValid;
boolean_T RxSlot_3266p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3266p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3266p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3266p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3266p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3266p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3266p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3266p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3267p0001_ReceiveFrame;
boolean_T RxSlot_3267p0001_ReceiveFrameValid;
boolean_T RxSlot_3267p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3267p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3267p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3267p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3267p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3267p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3267p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3267p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3268p0001_ReceiveFrame;
boolean_T RxSlot_3268p0001_ReceiveFrameValid;
boolean_T RxSlot_3268p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3268p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3268p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3268p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3268p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3268p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3268p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3268p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3697p0004_ReceiveFrame;
boolean_T RxSlot_3697p0004_ReceiveFrameValid;
boolean_T RxSlot_3697p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3697p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3697p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3697p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3697p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3697p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3697p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3697p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3699p0001_ReceiveFrame;
boolean_T RxSlot_3699p0001_ReceiveFrameValid;
boolean_T RxSlot_3699p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3699p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3699p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3699p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3699p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3699p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3699p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3699p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3836p0001_ReceiveFrame;
boolean_T RxSlot_3836p0001_ReceiveFrameValid;
boolean_T RxSlot_3836p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3836p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3836p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3836p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3836p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3836p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3836p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3836p0001_ReceiveFrameValid = 0;
...
void CAN_3_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3262p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3262p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3263p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3263p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3263p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3264p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3264p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3264p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3265p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3265p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3265p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3266p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3266p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3266p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3267p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3267p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3267p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3268p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3268p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3268p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3697p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3697p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3697p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3699p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3699p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3699p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3836p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3836p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3836p0001_ReceiveFrameValid = 1;
		}
		/* CAN_3_KeySuite */
		if (
			(frame->extended == 1) &&
