...
CANFrame RxSlot_3024p0002_ReceiveFrame;
boolean_T RxSlot_3024p0002_ReceiveFrameValid;
boolean_T RxSlot_3024p0002_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3024p0002_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3024p0002_ReceiveFrame.extended;
	if (id) *id = RxSlot_3024p0002_ReceiveFrame.id;
	if (length) *length = RxSlot_3024p0002_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3024p0002_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3024p0002_ReceiveFrame.data[i];
		}
	}
	RxSlot_3024p0002_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3025p0001_ReceiveFrame;
boolean_T RxSlot_3025p0001_ReceiveFrameValid;
boolean_T RxSlot_3025p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3025p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3025p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3025p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3025p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3025p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3025p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3025p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3026p0001_ReceiveFrame;
boolean_T RxSlot_3026p0001_ReceiveFrameValid;
boolean_T RxSlot_3026p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3026p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3026p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3026p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3026p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3026p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3026p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3026p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3443p0007_ReceiveFrame;
boolean_T RxSlot_3443p0007_ReceiveFrameValid;
boolean_T RxSlot_3443p0007_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3443p0007_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3443p0007_ReceiveFrame.extended;
	if (id) *id = RxSlot_3443p0007_ReceiveFrame.id;
	if (length) *length = RxSlot_3443p0007_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3443p0007_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3443p0007_ReceiveFrame.data[i];
		}
	}
	RxSlot_3443p0007_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3681p0001_ReceiveFrame;
boolean_T RxSlot_3681p0001_ReceiveFrameValid;
boolean_T RxSlot_3681p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3681p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3681p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3681p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3681p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3681p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3681p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3681p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3796p0001_ReceiveFrame;
boolean_T RxSlot_3796p0001_ReceiveFrameValid;
boolean_T RxSlot_3796p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3796p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3796p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3796p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3796p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3796p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3796p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3796p0001_ReceiveFrameValid = 0;
...
CANFrame_Queue RxSlot_3950p0001_ReceiveQueue;
CANFrame RxSlot_3950p0001_ReceiveQueueFrames[2];
boolean_T RxSlot_3950p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{

	CANFrame rxFrame;
	int32_T i;
	if (!CANFrame_Queue_Dequeue(&RxSlot_3950p0001_ReceiveQueue, &rxFrame)) {
		return 0;
	}
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3951p0001_ReceiveFrame;
boolean_T RxSlot_3951p0001_ReceiveFrameValid;
boolean_T RxSlot_3951p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3951p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3951p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3951p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3951p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3951p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3951p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3951p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3952p0001_ReceiveFrame;
boolean_T RxSlot_3952p0001_ReceiveFrameValid;
boolean_T RxSlot_3952p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3952p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3952p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3952p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3952p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3952p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3952p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3952p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3953p0001_ReceiveFrame;
boolean_T RxSlot_3953p0001_ReceiveFrameValid;
boolean_T RxSlot_3953p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3953p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3953p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3953p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3953p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3953p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3953p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3953p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4155p0004_ReceiveFrame;
boolean_T RxSlot_4155p0004_ReceiveFrameValid;
boolean_T RxSlot_4155p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4155p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4155p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_4155p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_4155p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4155p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4155p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_4155p0004_ReceiveFrameValid = 0;
...
void CAN_1_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3024p0002_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3024p0002_ReceiveFrameValid = 1;
		}
		/* RxSlot_3025p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3025p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3025p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3026p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3026p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3026p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3443p0007 */
		if (
			(frame->extended == 0) &&
			((frame->id & 0x7FF) == 0x430) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_3443p0007_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3443p0007_ReceiveFrameValid = 1;
		}
		/* RxSlot_3681p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3681p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3681p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3796p0001 */
		if (
			(frame->extended == 1) &&
		...
		{
			memcpy(&RxSlot_3796p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3796p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3950p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			CANFrame_Queue_Enqueue(&RxSlot_3950p0001_ReceiveQueue, frame);
		}
		/* RxSlot_3951p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3951p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3951p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3952p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3952p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3952p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3953p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3953p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3953p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4155p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4155p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4155p0004_ReceiveFrameValid = 1;
		}
		/* CCP1 */
		if (
			(frame->extended == 1) &&
...
void CAN_1_Create(void)
{
	...
	CANFrame_Queue_Create(&RxSlot_3950p0001_ReceiveQueue, RxSlot_3950p0001_ReceiveQueueFrames, sizeof(RxSlot_3950p0001_ReceiveQueueFrames)/sizeof(CANFrame));
	RxSlot_3951p0001_ReceiveFrameValid = 0;
	RxSlot_3952p0001_ReceiveFrameValid = 0;
	RxSlot_3953p0001_ReceiveFrameValid = 0;
	RxSlot_4155p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3683p0001_ReceiveFrame;
boolean_T RxSlot_3683p0001_ReceiveFrameValid;
boolean_T RxSlot_3683p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3683p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3683p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3683p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3683p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3683p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3683p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3683p0001_ReceiveFrameValid = 0;
...
void CAN_2_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3683p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3683p0001_ReceiveFrameValid = 1;
		}
		/* CAN_2_KeySuite */
		if (
			(frame->extended == 1) &&
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3227p0005_ReceiveFrame;
boolean_T RxSlot_3227p0005_ReceiveFrameValid;
boolean_T RxSlot_3227p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3227p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3227p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3227p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3227p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3227p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3227p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3227p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3228p0005_ReceiveFrame;
boolean_T RxSlot_3228p0005_ReceiveFrameValid;
boolean_T RxSlot_3228p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3228p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3228p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3228p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3228p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3228p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3228p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3228p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3229p0005_ReceiveFrame;
boolean_T RxSlot_3229p0005_ReceiveFrameValid;
boolean_T RxSlot_3229p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3229p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3229p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3229p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3229p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3229p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3229p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3229p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3230p0005_ReceiveFrame;
boolean_T RxSlot_3230p0005_ReceiveFrameValid;
boolean_T RxSlot_3230p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3230p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3230p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3230p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3230p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3230p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3230p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3230p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3231p0005_ReceiveFrame;
boolean_T RxSlot_3231p0005_ReceiveFrameValid;
boolean_T RxSlot_3231p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3231p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3231p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3231p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3231p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3231p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3231p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3231p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3232p0005_ReceiveFrame;
boolean_T RxSlot_3232p0005_ReceiveFrameValid;
boolean_T RxSlot_3232p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3232p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3232p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3232p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3232p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3232p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3232p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3232p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3233p0005_ReceiveFrame;
boolean_T RxSlot_3233p0005_ReceiveFrameValid;
boolean_T RxSlot_3233p0005_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3233p0005_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3233p0005_ReceiveFrame.extended;
	if (id) *id = RxSlot_3233p0005_ReceiveFrame.id;
	if (length) *length = RxSlot_3233p0005_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3233p0005_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3233p0005_ReceiveFrame.data[i];
		}
	}
	RxSlot_3233p0005_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3680p0004_ReceiveFrame;
boolean_T RxSlot_3680p0004_ReceiveFrameValid;
boolean_T RxSlot_3680p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3680p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3680p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3680p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3680p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3680p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3680p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3680p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3682p0001_ReceiveFrame;
boolean_T RxSlot_3682p0001_ReceiveFrameValid;
boolean_T RxSlot_3682p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3682p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3682p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3682p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3682p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3682p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3682p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3682p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3893p0001_ReceiveFrame;
boolean_T RxSlot_3893p0001_ReceiveFrameValid;
boolean_T RxSlot_3893p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3893p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3893p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3893p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3893p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3893p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3893p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3893p0001_ReceiveFrameValid = 0;
...
void CAN_3_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3227p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3227p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3228p0005 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3228p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3228p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3229p0005 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3229p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3229p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3230p0005 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3230p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3230p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3231p0005 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3231p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3231p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3232p0005 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3232p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3232p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3233p0005 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3233p0005_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3233p0005_ReceiveFrameValid = 1;
		}
		/* RxSlot_3680p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3680p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3680p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3682p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3682p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3682p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3893p0001 */
		if (
			(frame->extended == 0) &&
			((frame->id & 0x7FF) == 0x209) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_3893p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3893p0001_ReceiveFrameValid = 1;
		}
		/* CAN_3_KeySuite */
		if (
			(frame->extended == 1) &&
