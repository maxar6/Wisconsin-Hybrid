...
CANFrame RxSlot_3140p0002_ReceiveFrame;
boolean_T RxSlot_3140p0002_ReceiveFrameValid;
boolean_T RxSlot_3140p0002_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3140p0002_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3140p0002_ReceiveFrame.extended;
	if (id) *id = RxSlot_3140p0002_ReceiveFrame.id;
	if (length) *length = RxSlot_3140p0002_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3140p0002_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3140p0002_ReceiveFrame.data[i];
		}
	}
	RxSlot_3140p0002_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3141p0001_ReceiveFrame;
boolean_T RxSlot_3141p0001_ReceiveFrameValid;
boolean_T RxSlot_3141p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3141p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3141p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3141p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3141p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3141p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3141p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3141p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3142p0001_ReceiveFrame;
boolean_T RxSlot_3142p0001_ReceiveFrameValid;
boolean_T RxSlot_3142p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3142p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3142p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3142p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3142p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3142p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3142p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3142p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3564p0004_ReceiveFrame;
boolean_T RxSlot_3564p0004_ReceiveFrameValid;
boolean_T RxSlot_3564p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3564p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3564p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3564p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3564p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3564p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3564p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3564p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3802p0001_ReceiveFrame;
boolean_T RxSlot_3802p0001_ReceiveFrameValid;
boolean_T RxSlot_3802p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3802p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3802p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3802p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3802p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3802p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3802p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3802p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3910p0001_ReceiveFrame;
boolean_T RxSlot_3910p0001_ReceiveFrameValid;
boolean_T RxSlot_3910p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3910p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3910p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3910p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3910p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3910p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3910p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3910p0001_ReceiveFrameValid = 0;
...
CANFrame_Queue RxSlot_4064p0001_ReceiveQueue;
CANFrame RxSlot_4064p0001_ReceiveQueueFrames[2];
boolean_T RxSlot_4064p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{

	CANFrame rxFrame;
	int32_T i;
	if (!CANFrame_Queue_Dequeue(&RxSlot_4064p0001_ReceiveQueue, &rxFrame)) {
		return 0;
	}
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4065p0001_ReceiveFrame;
boolean_T RxSlot_4065p0001_ReceiveFrameValid;
boolean_T RxSlot_4065p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4065p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4065p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4065p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4065p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4065p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4065p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4065p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4066p0001_ReceiveFrame;
boolean_T RxSlot_4066p0001_ReceiveFrameValid;
boolean_T RxSlot_4066p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4066p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4066p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4066p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4066p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4066p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4066p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4066p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4067p0001_ReceiveFrame;
boolean_T RxSlot_4067p0001_ReceiveFrameValid;
boolean_T RxSlot_4067p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4067p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4067p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4067p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4067p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4067p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4067p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4067p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4269p0001_ReceiveFrame;
boolean_T RxSlot_4269p0001_ReceiveFrameValid;
boolean_T RxSlot_4269p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4269p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4269p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4269p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4269p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4269p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4269p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4269p0001_ReceiveFrameValid = 0;
...
void CAN_1_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3140p0002_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3140p0002_ReceiveFrameValid = 1;
		}
		/* RxSlot_3141p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3141p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3141p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3142p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3142p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3142p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3564p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3564p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3564p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3802p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3802p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3802p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3910p0001 */
		if (
			(frame->extended == 1) &&
		...
		{
			memcpy(&RxSlot_3910p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3910p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4064p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			CANFrame_Queue_Enqueue(&RxSlot_4064p0001_ReceiveQueue, frame);
		}
		/* RxSlot_4065p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4065p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4065p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4066p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4066p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4066p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4067p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4067p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4067p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4269p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4269p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4269p0001_ReceiveFrameValid = 1;
		}
		/* CCP1 */
		if (
			(frame->extended == 1) &&
...
void CAN_1_Create(void)
{
	...
	CANFrame_Queue_Create(&RxSlot_4064p0001_ReceiveQueue, RxSlot_4064p0001_ReceiveQueueFrames, sizeof(RxSlot_4064p0001_ReceiveQueueFrames)/sizeof(CANFrame));
	RxSlot_4065p0001_ReceiveFrameValid = 0;
	RxSlot_4066p0001_ReceiveFrameValid = 0;
	RxSlot_4067p0001_ReceiveFrameValid = 0;
	RxSlot_4269p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3804p0001_ReceiveFrame;
boolean_T RxSlot_3804p0001_ReceiveFrameValid;
boolean_T RxSlot_3804p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3804p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3804p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3804p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3804p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3804p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3804p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3804p0001_ReceiveFrameValid = 0;
...
void CAN_2_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3804p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3804p0001_ReceiveFrameValid = 1;
		}
		/* CAN_2_KeySuite */
		if (
			(frame->extended == 1) &&
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3348p0001_ReceiveFrame;
boolean_T RxSlot_3348p0001_ReceiveFrameValid;
boolean_T RxSlot_3348p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3348p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3348p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3348p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3348p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3348p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3348p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3348p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3349p0001_ReceiveFrame;
boolean_T RxSlot_3349p0001_ReceiveFrameValid;
boolean_T RxSlot_3349p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3349p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3349p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3349p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3349p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3349p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3349p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3349p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3350p0001_ReceiveFrame;
boolean_T RxSlot_3350p0001_ReceiveFrameValid;
boolean_T RxSlot_3350p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3350p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3350p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3350p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3350p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3350p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3350p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3350p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3351p0001_ReceiveFrame;
boolean_T RxSlot_3351p0001_ReceiveFrameValid;
boolean_T RxSlot_3351p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3351p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3351p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3351p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3351p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3351p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3351p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3351p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3352p0001_ReceiveFrame;
boolean_T RxSlot_3352p0001_ReceiveFrameValid;
boolean_T RxSlot_3352p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3352p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3352p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3352p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3352p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3352p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3352p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3352p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3353p0001_ReceiveFrame;
boolean_T RxSlot_3353p0001_ReceiveFrameValid;
boolean_T RxSlot_3353p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3353p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3353p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3353p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3353p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3353p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3353p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3353p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3354p0001_ReceiveFrame;
boolean_T RxSlot_3354p0001_ReceiveFrameValid;
boolean_T RxSlot_3354p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3354p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3354p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3354p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3354p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3354p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3354p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3354p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3801p0004_ReceiveFrame;
boolean_T RxSlot_3801p0004_ReceiveFrameValid;
boolean_T RxSlot_3801p0004_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3801p0004_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3801p0004_ReceiveFrame.extended;
	if (id) *id = RxSlot_3801p0004_ReceiveFrame.id;
	if (length) *length = RxSlot_3801p0004_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3801p0004_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3801p0004_ReceiveFrame.data[i];
		}
	}
	RxSlot_3801p0004_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_3803p0001_ReceiveFrame;
boolean_T RxSlot_3803p0001_ReceiveFrameValid;
boolean_T RxSlot_3803p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_3803p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_3803p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_3803p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_3803p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_3803p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_3803p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_3803p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_4007p0001_ReceiveFrame;
boolean_T RxSlot_4007p0001_ReceiveFrameValid;
boolean_T RxSlot_4007p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_4007p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_4007p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_4007p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_4007p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_4007p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_4007p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_4007p0001_ReceiveFrameValid = 0;
...
void CAN_3_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		{
			memcpy(&RxSlot_3348p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3348p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3349p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3349p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3349p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3350p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3350p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3350p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3351p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3351p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3351p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3352p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3352p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3352p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3353p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3353p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3353p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3354p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3354p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3354p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_3801p0004 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3801p0004_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3801p0004_ReceiveFrameValid = 1;
		}
		/* RxSlot_3803p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_3803p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_3803p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_4007p0001 */
		if (
			(frame->extended == 0) &&
		...
		{
			memcpy(&RxSlot_4007p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_4007p0001_ReceiveFrameValid = 1;
		}
		/* CAN_3_KeySuite */
		if (
			(frame->extended == 1) &&
