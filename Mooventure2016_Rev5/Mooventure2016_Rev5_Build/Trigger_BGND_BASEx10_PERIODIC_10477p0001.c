/*
 * Trigger_BGND_BASEx10_PERIODIC_10477p0001.c
 *
...
void Trigger_BGND_BASEx10_PERIODIC_10477p0001(void)
{
  if (Mooventure2016_Rev5_DWork.s5_motohawk_trigger6_DWORK1) {
    Mooventure2016_Rev5_CCPDaqProcessing(6);
  }
}
