...
void Trigger_Fault_active_0_8(void)
{
  ...
  /* Output and update for function-call system: '<S32>/Data Write' */
  {
    ...
    /* S-Function Block: <S49>/motohawk_abs_time */
    {
    ...
    /* S-Function (motohawk_sfun_data_sizeof): '<S49>/motohawk_data_sizeof' */
     ...
     *  MATLAB Function Block: '<S49>/Data Iterator'
     */
    ...
    /* MATLAB Function Block: '<S49>/Data Iterator' incorporates:
     *  S-Function (motohawk_sfun_data_sizeof): '<S49>/motohawk_data_sizeof'
     */

    /* MATLAB Function 'Foreground/Control/Faults/Freeze Frame/Data Write/Data Iterator': '<S50>:1' */
    /* '<S50>:1:3' */
    ...
    /* End of MATLAB Function Block: '<S49>/Data Iterator' */
