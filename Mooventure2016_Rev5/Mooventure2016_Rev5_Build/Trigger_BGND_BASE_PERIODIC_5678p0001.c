/*
 * Trigger_BGND_BASE_PERIODIC_5678p0001.c
 *
...
void Trigger_BGND_BASE_PERIODIC_5678p0001(void)
{
  {
...

  {
    /* Output and update for function-call system: '<S2>/Background' */
    {
      ...
      /* S-Function Block: DOut5628p0004 */
      {
        DOut5628p0004_DiscreteOutput_Set(rtb_Merge);
      }
