...
@if ERRORLEVEL 1 exit junk
@"c:\program files (x86)\woodward\mcs\motohawk\2011a_sp0.184\motocoder\bin\nant\bin\nant" -buildfile:TDB\Database.build -D:required.installdir="C:\Program Files (x86)\Woodward\DevelopmentTools\Toolchains\GCC\win32-pe\4_4_0" -D:database.basename=Mooventur_214 -q -nologo rebuild
@if ERRORLEVEL 1 exit junk
...
@echo ### Copy Mooventur_214.dll and Mooventure2016_Rev5_214.srz
@if exist C:\ECUFiles\TDBDLL\*.* copy /Y .\TDB\Mooventur_214.dll C:\ECUFiles\TDBDLL > NUL
@if ERRORLEVEL 1 exit junk
@if exist C:\ECUFiles\Programs\*.* copy /Y .\Target\Mooventure2016_Rev5.srz C:\ECUFiles\Programs\Mooventure2016_Rev5_214.srz > NUL
@if ERRORLEVEL 1 exit junk


@echo ### Dumping DLL to XML
@"C:\PROGRA~2\Woodward\MCS\MotoHawk\2011A_~1.184\Bin\motohawk_dumpdll.exe" -xml "C:\Users\maxar\Documents\GitHub\Wisconsin-Hybrid\Mooventure2016_Rev5\Mooventure2016_Rev5_Build\TDB\Mooventur_214.dll" > "C:\Users\maxar\Documents\GitHub\Wisconsin-Hybrid\Mooventure2016_Rev5\Mooventure2016_Rev5_Build\TDB\Mooventur_214.xml"
@if ERRORLEVEL 1 exit junk
...
@"C:\PROGRA~2\Woodward\MCS\MotoHawk\2011A_~1.184\Bin\ASAP2.exe" -m "C:\Users\maxar\Documents\GitHub\Wisconsin-Hybrid\Mooventure2016_Rev5\Mooventure2016_Rev5_Build\TDB\Mooventur_214.xml" -o "C:\Users\maxar\Documents\GitHub\Wisconsin-Hybrid\Mooventure2016_Rev5\Mooventure2016_Rev5_Build\TDB\Mooventur_214.a2l" -u VirtualCalSpace -asap1b "C:\Users\maxar\Documents\GitHub\Wisconsin-Hybrid\Mooventure2016_Rev5\Mooventure2016_Rev5_Build\mh_asap1b_ccp_CCP1.xml"
@if ERRORLEVEL 1 exit junk


@echo ### Installing ASAP2 file in C:\ECUFiles\TDBDLL\
@copy "C:\Users\maxar\Documents\GitHub\Wisconsin-Hybrid\Mooventure2016_Rev5\Mooventure2016_Rev5_Build\TDB\Mooventur_214.a2l" "C:\ECUFiles\TDBDLL\" > NUL
@if ERRORLEVEL 1 exit junk
