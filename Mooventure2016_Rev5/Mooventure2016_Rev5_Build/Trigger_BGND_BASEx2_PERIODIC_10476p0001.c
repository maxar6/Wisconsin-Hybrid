/*
 * Trigger_BGND_BASEx2_PERIODIC_10476p0001.c
 *
...
void Trigger_BGND_BASEx2_PERIODIC_10476p0001(void)
{
  if (Mooventure2016_Rev5_DWork.s5_motohawk_trigger5_DWORK1) {
    Mooventure2016_Rev5_CCPDaqProcessing(5);
  }
}
