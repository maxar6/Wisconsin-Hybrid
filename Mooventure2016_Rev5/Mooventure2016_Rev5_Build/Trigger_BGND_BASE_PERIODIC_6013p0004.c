/*
 * Trigger_BGND_BASE_PERIODIC_6013p0004.c
 *
...
void Trigger_BGND_BASE_PERIODIC_6013p0004(void)
{
  {
    /* Output and update for function-call system: '<S3>/Background' */
    {
      ...
      /* S-Function Block: DOut5963p0004 */
      {
        DOut5963p0004_DiscreteOutput_Set(rtb_Merge);
      }
