...
void OnChangeFaultActive(uint32_T fault, boolean_T val)
{
  ...
  if (val) {
    ...
    {
      extern void Trigger_Fault_active_0_10(void);
      Trigger_Fault_active_0_10();
    }
  } else {
...
void GlobalFaultClear(void)
{
  ...
  FaultMarquees_DataStore_FaultMarquees().current_suspected_vardec = 96;
  FaultMarquees_DataStore_FaultMarquees().current_active_vardec = 96;
  FaultMarquees_DataStore_FaultMarquees().current_occurred_vardec = 96;
  VolFaultManager_DataStore_VolFaultManager().last_suspected_fault = 96;
  VolFaultManager_DataStore_VolFaultManager().last_unsuspected_fault = 96;
  VolFaultManager_DataStore_VolFaultManager().last_active_fault = 96;
  VolFaultManager_DataStore_VolFaultManager().last_inactive_fault = 96;
  VolFaultManager_DataStore_VolFaultManager().last_occurred_fault = 96;
}
...
static void UpdateActionReasonMarquee(uint32_T fault_action_index)
{
  ...
  static fault_action_marquee_state_t fault_action_marquee_state[16] = { { 0 } };
  ...
  (FaultActionReason_DataStore())[fault_action_index] = 96;
}
