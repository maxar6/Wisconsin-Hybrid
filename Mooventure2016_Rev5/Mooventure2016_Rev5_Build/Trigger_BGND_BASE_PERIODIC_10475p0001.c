/*
 * Trigger_BGND_BASE_PERIODIC_10475p0001.c
 *
...
void Trigger_BGND_BASE_PERIODIC_10475p0001(void)
{
  if (Mooventure2016_Rev5_DWork.s5_motohawk_trigger4_DWORK1) {
    Mooventure2016_Rev5_CCPDaqProcessing(4);
  }
}
