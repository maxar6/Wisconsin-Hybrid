...
void DOut4594p0001_DiscreteOutput_Create(void);
void DOut4594p0001_DiscreteOutput_Stop(void);

void DOut4595p0001_DiscreteOutput_Create(void);
void DOut4595p0001_DiscreteOutput_Stop(void);

void S_SHRC_4_Create(void);

void MC33800_INJ8_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4596p0001;
	

void MC33800_INJ6_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4597p0001;
	

void MC33800_INJ7_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4598p0001;
	

void MC33800_INJ5_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4599p0001;
	

void MC33800_LSO2_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4600p0001;
	

void MC33800_INJ4_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4601p0001;
...
extern const S_BasicOut_Defn_DiscreteOut DOut4820p0001;
	

void DOut4821p0001_DiscreteOutput_Create(void);
void DOut4821p0001_DiscreteOutput_Stop(void);

void DOut4822p0001_DiscreteOutput_Create(void);
void DOut4822p0001_DiscreteOutput_Stop(void);

void MC33800_LSO10_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut4823p0001;
	

extern const S_BasicOut_Defn_DiscreteOut DOut4824p0001_DiagDisable;
	

extern const S_BasicOut_Defn_DiscreteOut DOut4824p0001;
	

extern const S_BasicOut_Defn_DiscreteOut DOut4825p0001_DiagDisable;
	

extern const S_BasicOut_Defn_DiscreteOut DOut4825p0001;
	

void MC33800_MPRD_DiscreteOutput_Create(void);

extern const S_BasicOut_Defn_DiscreteOut DOut5963p0004;
...
void DOut4596p0001_DiscreteOutput_Create(void);
void DOut4596p0001_DiscreteOutput_Stop(void);
void DOut4597p0001_DiscreteOutput_Create(void);
void DOut4597p0001_DiscreteOutput_Stop(void);
void DOut4598p0001_DiscreteOutput_Create(void);
void DOut4598p0001_DiscreteOutput_Stop(void);
void DOut4599p0001_DiscreteOutput_Create(void);
void DOut4599p0001_DiscreteOutput_Stop(void);
...
void DOut4820p0001_DiscreteOutput_Create(void);
void DOut4820p0001_DiscreteOutput_Stop(void);
void DOut4823p0001_DiscreteOutput_Create(void);
void DOut4823p0001_DiscreteOutput_Stop(void);
void DOut4824p0001_DiscreteOutput_Create(void);
void DOut4824p0001_DiscreteOutput_Stop(void);
void DOut4825p0001_DiscreteOutput_Create(void);
void DOut4825p0001_DiscreteOutput_Stop(void);
void DOut5963p0004_DiscreteOutput_Create(void);
void DOut5963p0004_DiscreteOutput_Stop(void);
...
void DOut4824p0001_DiagDisable_DiscreteOutput_Create(void);
void DOut4825p0001_DiagDisable_DiscreteOutput_Create(void);
...
INSTANTIATE_MC33800Output_DiscreteOut(DOut4594p0001,
	MC33800_CCD1,
	CCD,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
E_ResourceState DOut4594p0001_State;
...
void DOut4594p0001_DiscreteOutput_Create(void)
{
    ...
    DOut4594p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4594p0001, &CreateObj);
}
void DOut4594p0001_DiscreteOutput_Set(boolean_T value)
{
    ...
    if ((DOut4594p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4594p0001_State != eState)
        {
            DOut4594p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4594p0001, eState);
            Interrupt_DisableApp();
            DOut4594p0001_State = DOut4594p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4594p0001_DiscreteOutput_Stop(void)
{
    ...
    DOut4594p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4594p0001, RES_OFF);
}

INSTANTIATE_MC33800Output_DiscreteOut(DOut4595p0001,
	MC33800_OUT1,
	OSS,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4595p0001_State;
#include <Pragma_Section_End_SDA.h>
void DOut4595p0001_DiscreteOutput_Create(void)
{
	S_MC33800Output_Create_DiscreteOut CreateObj;
    ...
    /* Cache state because UseUpdateOnlyOnChange was true */
    DOut4595p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4595p0001, &CreateObj);
}
void DOut4595p0001_DiscreteOutput_Set(boolean_T value)
{
    E_ResourceState eState;
    ...
    Interrupt_DisableApp();
    if ((DOut4595p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4595p0001_State != eState)
        {
            DOut4595p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4595p0001, eState);
            Interrupt_DisableApp();
            DOut4595p0001_State = DOut4595p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4595p0001_DiscreteOutput_Stop(void)
{
    ...
    /* IO Stop is called on shutdown. It should override the state being set by another thread.
       The expectation is that normal operation shall not resume without effectively restarting the code */
    DOut4595p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4595p0001, RES_OFF);
}
...
INSTANTIATE_MC33800Output_DiscreteOut(DOut4604p0001,
	MC33800_OUT2,
	OSS,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
void DOut4604p0001_DiscreteOutput_Create(void)
{
    ...
    /* Cache state because UseUpdateOnlyOnChange was true */
    DOut4604p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4604p0001, &CreateObj);
}
void DOut4604p0001_DiscreteOutput_Set(boolean_T value)
{
    ...
    Interrupt_DisableApp();
    if ((DOut4604p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4604p0001_State != eState)
        {
            DOut4604p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4604p0001, eState);
            Interrupt_DisableApp();
            DOut4604p0001_State = DOut4604p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4604p0001_DiscreteOutput_Stop(void)
{
    ...
    /* IO Stop is called on shutdown. It should override the state being set by another thread.
       The expectation is that normal operation shall not resume without effectively restarting the code */
    DOut4604p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4604p0001, RES_OFF);
}

INSTANTIATE_MC33800Output_DiscreteOut(DOut4605p0001,
	MC33800_OUT1,
	OSS,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
void DOut4605p0001_DiscreteOutput_Create(void)
{
    ...
    /* Cache state because UseUpdateOnlyOnChange was true */
    DOut4605p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4605p0001, &CreateObj);
}
void DOut4605p0001_DiscreteOutput_Set(boolean_T value)
{
    ...
    Interrupt_DisableApp();
    if ((DOut4605p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4605p0001_State != eState)
        {
            DOut4605p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4605p0001, eState);
            Interrupt_DisableApp();
            DOut4605p0001_State = DOut4605p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4605p0001_DiscreteOutput_Stop(void)
{
    ...
    /* IO Stop is called on shutdown. It should override the state being set by another thread.
       The expectation is that normal operation shall not resume without effectively restarting the code */
    DOut4605p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4605p0001, RES_OFF);
}

INSTANTIATE_MC33800Output_DiscreteOut(DOut4606p0001,
	MC33800_PWM6,
	PWM,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
void DOut4606p0001_DiscreteOutput_Create(void)
{
    ...
    /* Cache state because UseUpdateOnlyOnChange was true */
    DOut4606p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4606p0001, &CreateObj);
}
void DOut4606p0001_DiscreteOutput_Set(boolean_T value)
{
    ...
    Interrupt_DisableApp();
    if ((DOut4606p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4606p0001_State != eState)
        {
            DOut4606p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4606p0001, eState);
            Interrupt_DisableApp();
            DOut4606p0001_State = DOut4606p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4606p0001_DiscreteOutput_Stop(void)
{
    ...
    /* IO Stop is called on shutdown. It should override the state being set by another thread.
       The expectation is that normal operation shall not resume without effectively restarting the code */
    DOut4606p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4606p0001, RES_OFF);
}
...
INSTANTIATE_MC33800Output_DiscreteOut(DOut4821p0001,
	MC33800_PWM6,
	PWM,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4821p0001_State;
#include <Pragma_Section_End_SDA.h>
void DOut4821p0001_DiscreteOutput_Create(void)
{
	S_MC33800Output_Create_DiscreteOut CreateObj;
    ...
    /* Cache state because UseUpdateOnlyOnChange was true */
    DOut4821p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4821p0001, &CreateObj);
}
void DOut4821p0001_DiscreteOutput_Set(boolean_T value)
{
    E_ResourceState eState;
    ...
    Interrupt_DisableApp();
    if ((DOut4821p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4821p0001_State != eState)
        {
            DOut4821p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4821p0001, eState);
            Interrupt_DisableApp();
            DOut4821p0001_State = DOut4821p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4821p0001_DiscreteOutput_Stop(void)
{
    ...
    /* IO Stop is called on shutdown. It should override the state being set by another thread.
       The expectation is that normal operation shall not resume without effectively restarting the code */
    DOut4821p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4821p0001, RES_OFF);
}

INSTANTIATE_MC33800Output_DiscreteOut(DOut4822p0001,
	MC33800_PWM5,
	PWM,
	RES_POL_ACTIVE_LOW,
	OUTPUT_IS_INVERTING,
...
#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4822p0001_State;
#include <Pragma_Section_End_SDA.h>
void DOut4822p0001_DiscreteOutput_Create(void)
{
	S_MC33800Output_Create_DiscreteOut CreateObj;
    ...
    /* Cache state because UseUpdateOnlyOnChange was true */
    DOut4822p0001_State = CreateObj.DiscreteOutCreateAttribs.eInitialState;
	...
	MC33800_DiscreteOut_Create(&DOut4822p0001, &CreateObj);
}
void DOut4822p0001_DiscreteOutput_Set(boolean_T value)
{
    E_ResourceState eState;
    ...
    Interrupt_DisableApp();
    if ((DOut4822p0001_State & 0x80) == 0)
    {   /* Object is not currently undergoing modification */
        if (DOut4822p0001_State != eState)
        {
            DOut4822p0001_State = eState | 0x80;
            Interrupt_EnableApp();
            MC33800_DiscreteOut_State_Set(&DOut4822p0001, eState);
            Interrupt_DisableApp();
            DOut4822p0001_State = DOut4822p0001_State & 0x7F;
        }
    }
    else
    {
...
void DOut4822p0001_DiscreteOutput_Stop(void)
{
    ...
    /* IO Stop is called on shutdown. It should override the state being set by another thread.
       The expectation is that normal operation shall not resume without effectively restarting the code */
    DOut4822p0001_State = RES_OFF;

	MC33800_DiscreteOut_State_Set(&DOut4822p0001, RES_OFF);
}
...
#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4596p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4596p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4596p0001_State;
    }
    else if (DOut4596p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4596p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4596p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_137_G1, 
                                 GPIO,
...
void DOut4596p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4596p0001, &DOut4596p0001_State, RES_OFF);
}
void DOut4596p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4596p0001,
                                                &DOut4596p0001_State,
                                                value);
}
void DOut4596p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4596p0001, &DOut4596p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4597p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4597p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4597p0001_State;
    }
    else if (DOut4597p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4597p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4597p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_135_G4, 
                                 GPIO,
...
void DOut4597p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4597p0001, &DOut4597p0001_State, RES_OFF);
}
void DOut4597p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4597p0001,
                                                &DOut4597p0001_State,
                                                value);
}
void DOut4597p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4597p0001, &DOut4597p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4598p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4598p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4598p0001_State;
    }
    else if (DOut4598p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4598p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4598p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_136_G2, 
                                 GPIO,
...
void DOut4598p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4598p0001, &DOut4598p0001_State, RES_OFF);
}
void DOut4598p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4598p0001,
                                                &DOut4598p0001_State,
                                                value);
}
void DOut4598p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4598p0001, &DOut4598p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4599p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4599p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4599p0001_State;
    }
    else if (DOut4599p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4599p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4599p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_134_H1, 
                                 GPIO,
...
void DOut4599p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4599p0001, &DOut4599p0001_State, RES_OFF);
}
void DOut4599p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4599p0001,
                                                &DOut4599p0001_State,
                                                value);
}
void DOut4599p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4599p0001, &DOut4599p0001_State);
}
...
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4600p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4600p0001_State;
    }
    else if (DOut4600p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4600p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4600p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_138_F1, 
                                 GPIO,
...
void DOut4600p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4600p0001, &DOut4600p0001_State, RES_OFF);
}
void DOut4600p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4600p0001,
                                                &DOut4600p0001_State,
                                                value);
}
void DOut4600p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4600p0001, &DOut4600p0001_State);
}
...
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4601p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4601p0001_State;
    }
    else if (DOut4601p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4601p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4601p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_133_H2, 
                                 GPIO,
...
void DOut4601p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4601p0001, &DOut4601p0001_State, RES_OFF);
}
void DOut4601p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4601p0001,
                                                &DOut4601p0001_State,
                                                value);
}
void DOut4601p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4601p0001, &DOut4601p0001_State);
}
...
#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4820p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4820p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4820p0001_State;
    }
    else if (DOut4820p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4820p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4820p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_159_J24, 
                                 GPIO,
...
void DOut4820p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4820p0001, &DOut4820p0001_State, RES_OFF);
}
void DOut4820p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4820p0001,
                                                &DOut4820p0001_State,
                                                value);
}
void DOut4820p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4820p0001, &DOut4820p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4823p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4823p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4823p0001_State;
    }
    else if (DOut4823p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4823p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4823p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_158_J25, 
                                 GPIO,
...
void DOut4823p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4823p0001, &DOut4823p0001_State, RES_OFF);
}
void DOut4823p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4823p0001,
                                                &DOut4823p0001_State,
                                                value);
}
void DOut4823p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4823p0001, &DOut4823p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4824p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4824p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4824p0001_State;
    }
    else if (DOut4824p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4824p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4824p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_124_K3, 
                                 GPIO,
...
void DOut4824p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4824p0001, &DOut4824p0001_State, RES_OFF);
}
void DOut4824p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4824p0001,
                                                &DOut4824p0001_State,
                                                value);
}
void DOut4824p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4824p0001, &DOut4824p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut4825p0001_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut4825p0001_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut4825p0001_State;
    }
    else if (DOut4825p0001_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut4825p0001_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4825p0001,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_122_L1, 
                                 GPIO,
...
void DOut4825p0001_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut4825p0001, &DOut4825p0001_State, RES_OFF);
}
void DOut4825p0001_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut4825p0001,
                                                &DOut4825p0001_State,
                                                value);
}
void DOut4825p0001_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut4825p0001, &DOut4825p0001_State);
}
    
    

#include <Pragma_Section_Start_SDA.h>
E_ResourceState DOut5963p0004_State;
#include <Pragma_Section_End_SDA.h>
NativeError_S DOut5963p0004_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    if (FALSE == RES_OFF)
    {   /* Optimized return function can be used because enum states match with boolean*/
        *out_pValue = (boolean_T)DOut5963p0004_State;
    }
    else if (DOut5963p0004_State == RES_OFF)
    {
        *out_pValue = FALSE;
    }
    else /* if (DOut5963p0004_State == RES_ON) */
    {
        *out_pValue = TRUE;
    }
    return(SUCCESS_OK);
...
INSTANTIATE_BasicOut_DiscreteOut(DOut5963p0004,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_198_AE20, 
                                 GPIO,
...
void DOut5963p0004_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateOnChange_Create(&DOut5963p0004, &DOut5963p0004_State, RES_OFF);
}
void DOut5963p0004_DiscreteOutput_Set(boolean_T value)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Set(&DOut5963p0004,
                                                &DOut5963p0004_State,
                                                value);
}
void DOut5963p0004_DiscreteOutput_Stop(void)
{
    MotoCoder_DiscreteOutput_UpdateOnChange_Stop(&DOut5963p0004, &DOut5963p0004_State);
}
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4824p0001_DiagDisable,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_193_AF19, 
                                 GPIO,
...
void DOut4824p0001_DiagDisable_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateAlways_Create(&DOut4824p0001_DiagDisable, RES_ON);
}
NativeError_S DOut4824p0001_DiagDisable_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    NativeError_S sError;
    E_ResourceState eState = RES_OFF;

    sError = BasicOut_DiscreteOut_State_Get(&DOut4824p0001_DiagDisable, &eState);
    if (RES_OFF == FALSE)
    {   /* Optimized return function can be used because enum states match with boolean */
        *out_pValue = (boolean_T)eState;
    }
...
INSTANTIATE_BasicOut_DiscreteOut(DOut4825p0001_DiagDisable,
                                 CPUCore_0, 
                                 CPU, 
                                 GPIO_196_AD19, 
                                 GPIO,
...
void DOut4825p0001_DiagDisable_DiscreteOutput_Create(void)
{
	MotoCoder_DiscreteOutput_UpdateAlways_Create(&DOut4825p0001_DiagDisable, RES_ON);
}
NativeError_S DOut4825p0001_DiagDisable_DiscreteOutput_Get(boolean_T* const out_pValue)
{
    NativeError_S sError;
    E_ResourceState eState = RES_OFF;

    sError = BasicOut_DiscreteOut_State_Get(&DOut4825p0001_DiagDisable, &eState);
    if (RES_OFF == FALSE)
    {   /* Optimized return function can be used because enum states match with boolean */
        *out_pValue = (boolean_T)eState;
    }
...
void IO_Create(void)
{
    ...
    {extern void DOut4594p0001_DiscreteOutput_Create(void);
        DOut4594p0001_DiscreteOutput_Create();
    }
    {extern void DOut4595p0001_DiscreteOutput_Create(void);
        DOut4595p0001_DiscreteOutput_Create();
    }
    ...
    {extern void DOut4596p0001_DiscreteOutput_Create(void);
        DOut4596p0001_DiscreteOutput_Create();
    }
    {extern void MC33800_INJ6_DiscreteOutput_Create(void);
        MC33800_INJ6_DiscreteOutput_Create();
    }
    {extern void DOut4597p0001_DiscreteOutput_Create(void);
        DOut4597p0001_DiscreteOutput_Create();
    }
    {extern void MC33800_INJ7_DiscreteOutput_Create(void);
        MC33800_INJ7_DiscreteOutput_Create();
    }
    {extern void DOut4598p0001_DiscreteOutput_Create(void);
        DOut4598p0001_DiscreteOutput_Create();
    }
    {extern void MC33800_INJ5_DiscreteOutput_Create(void);
        MC33800_INJ5_DiscreteOutput_Create();
    }
    {extern void DOut4599p0001_DiscreteOutput_Create(void);
        DOut4599p0001_DiscreteOutput_Create();
    }
    ...
    {extern void DOut4820p0001_DiscreteOutput_Create(void);
        DOut4820p0001_DiscreteOutput_Create();
    }
    {extern void DOut4821p0001_DiscreteOutput_Create(void);
        DOut4821p0001_DiscreteOutput_Create();
    }
    {extern void DOut4822p0001_DiscreteOutput_Create(void);
        DOut4822p0001_DiscreteOutput_Create();
    }
    {extern void MC33800_LSO10_DiscreteOutput_Create(void);
        MC33800_LSO10_DiscreteOutput_Create();
    }
    {extern void DOut4823p0001_DiscreteOutput_Create(void);
        DOut4823p0001_DiscreteOutput_Create();
    }
    {extern void DOut4824p0001_DiagDisable_DiscreteOutput_Create(void);
        DOut4824p0001_DiagDisable_DiscreteOutput_Create();
    }
    {extern void DOut4824p0001_DiscreteOutput_Create(void);
        DOut4824p0001_DiscreteOutput_Create();
    }
    {extern void DOut4825p0001_DiagDisable_DiscreteOutput_Create(void);
        DOut4825p0001_DiagDisable_DiscreteOutput_Create();
    }
    {extern void DOut4825p0001_DiscreteOutput_Create(void);
        DOut4825p0001_DiscreteOutput_Create();
    }
    {extern void MC33800_MPRD_DiscreteOutput_Create(void);
        MC33800_MPRD_DiscreteOutput_Create();
    }
    {extern void DOut5963p0004_DiscreteOutput_Create(void);
        DOut5963p0004_DiscreteOutput_Create();
    }
...
void IO_Stop(void)
{
    ...
    {extern void DOut4594p0001_DiscreteOutput_Stop(void);
        DOut4594p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4595p0001_DiscreteOutput_Stop(void);
        DOut4595p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4596p0001_DiscreteOutput_Stop(void);
        DOut4596p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4597p0001_DiscreteOutput_Stop(void);
        DOut4597p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4598p0001_DiscreteOutput_Stop(void);
        DOut4598p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4599p0001_DiscreteOutput_Stop(void);
        DOut4599p0001_DiscreteOutput_Stop();
    }
    ...
    {extern void DOut4820p0001_DiscreteOutput_Stop(void);
        DOut4820p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4821p0001_DiscreteOutput_Stop(void);
        DOut4821p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4822p0001_DiscreteOutput_Stop(void);
        DOut4822p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4823p0001_DiscreteOutput_Stop(void);
        DOut4823p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4824p0001_DiscreteOutput_Stop(void);
        DOut4824p0001_DiscreteOutput_Stop();
    }
    {extern void DOut4825p0001_DiscreteOutput_Stop(void);
        DOut4825p0001_DiscreteOutput_Stop();
    }
    {extern void DOut5963p0004_DiscreteOutput_Stop(void);
        DOut5963p0004_DiscreteOutput_Stop();
    }
