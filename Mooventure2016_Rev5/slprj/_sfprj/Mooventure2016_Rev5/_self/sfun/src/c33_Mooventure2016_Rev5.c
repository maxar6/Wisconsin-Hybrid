...
static const char * c33_debug_family_names[4] = { "nargin", "nargout",
  "torqueIn", "torqueOut" };
...
static const mxArray *c33_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static real_T c33_emlrt_marshallIn(SFc33_Mooventure2016_Rev5InstanceStruct
  *chartInstance, const mxArray *c33_torqueOut, const char_T *c33_identifier);
static real_T c33_b_emlrt_marshallIn(SFc33_Mooventure2016_Rev5InstanceStruct
...
static const mxArray *c33_b_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static int32_T c33_c_emlrt_marshallIn(SFc33_Mooventure2016_Rev5InstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId);
static void c33_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c33_mxArrayInData, const char_T *c33_varName, void *c33_outData);
static uint8_T c33_d_emlrt_marshallIn(SFc33_Mooventure2016_Rev5InstanceStruct
  *chartInstance, const mxArray *c33_b_is_active_c33_Mooventure2016_Rev5, const
  char_T *c33_identifier);
static uint8_T c33_e_emlrt_marshallIn(SFc33_Mooventure2016_Rev5InstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId);
  ...
  (SFc33_Mooventure2016_Rev5InstanceStruct *chartInstance)
{
  ...
  real_T *c33_torqueOut;
  c33_torqueOut = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c33_st = NULL;
  c33_st = NULL;
  c33_y = NULL;
  sf_mex_assign(&c33_y, sf_mex_createcellarray(2));
  c33_hoistedGlobal = *c33_torqueOut;
  c33_u = c33_hoistedGlobal;
  c33_b_y = NULL;
  sf_mex_assign(&c33_b_y, sf_mex_create("y", &c33_u, 0, 0U, 0U, 0U, 0));
  sf_mex_setcell(c33_y, 0, c33_b_y);
  c33_b_hoistedGlobal = chartInstance->c33_is_active_c33_Mooventure2016_Rev5;
  ...
  (SFc33_Mooventure2016_Rev5InstanceStruct *chartInstance, const mxArray *c33_st)
{
  ...
  *c33_torqueOut = c33_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c33_u, 0)), "torqueOut");
  chartInstance->c33_is_active_c33_Mooventure2016_Rev5 = c33_d_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T c33_torqueOut;
  real_T *c33_b_torqueIn;
  real_T *c33_b_torqueOut;
  c33_b_torqueOut = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c33_b_torqueIn = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 32U, chartInstance->c33_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c33_b_torqueIn, 0U);
  _SFD_DATA_RANGE_CHECK(*c33_b_torqueOut, 1U);
  chartInstance->c33_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 32U, chartInstance->c33_sfEvent);
  c33_hoistedGlobal = *c33_b_torqueIn;
  c33_torqueIn = c33_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 4U, 4U, c33_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c33_nargout, 1U, c33_sf_marshallOut,
    c33_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c33_torqueIn, 2U, c33_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c33_torqueOut, 3U,
    c33_sf_marshallOut, c33_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c33_sfEvent, 3);
  if (CV_EML_IF(0, 0, c33_torqueIn > 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c33_sfEvent, 4);
    c33_torqueOut = -(4000.0 - c33_torqueIn);
  } else {
    _SFD_EML_CALL(0U, chartInstance->c33_sfEvent, 5);
    if (CV_EML_IF(0, 1, c33_torqueIn < 0.0)) {
  ...
  *chartInstance, const mxArray *c33_torqueOut, const char_T *c33_identifier)
{
  ...
  c33_y = c33_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c33_torqueOut),
    &c33_thisId);
  sf_mex_destroy(&c33_torqueOut);
  return c33_y;
}
...
static void c33_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c33_mxArrayInData, const char_T *c33_varName, void *c33_outData)
{
  const mxArray *c33_torqueOut;
  const char_T *c33_identifier;
  emlrtMsgIdentifier c33_thisId;
  real_T c33_y;
  SFc33_Mooventure2016_Rev5InstanceStruct *chartInstance;
  chartInstance = (SFc33_Mooventure2016_Rev5InstanceStruct *)chartInstanceVoid;
  c33_torqueOut = sf_mex_dup(c33_mxArrayInData);
  ...
  char_T *c33_identifier)
{
  ...
  c33_y = c33_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c33_b_is_active_c33_Mooventure2016_Rev5), &c33_thisId);
  sf_mex_destroy(&c33_b_is_active_c33_Mooventure2016_Rev5);
  return c33_y;
}
...
static const mxArray *sf_get_sim_state_info_c33_Mooventure2016_Rev5(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"torqueOut\",},{M[8],M[0],T\"is_active_c33_Mooventure2016_Rev5\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c33_torqueOut;
          c33_torqueOut = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c33_torqueIn = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c33_torqueIn);
          _SFD_SET_DATA_VALUE_PTR(1U, c33_torqueOut);
        }
      }
    } else {
