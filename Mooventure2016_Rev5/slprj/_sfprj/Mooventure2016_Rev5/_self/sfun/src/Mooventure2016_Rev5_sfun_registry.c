...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Mooventure2016_Rev5_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Mooventure2016_Rev5_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Mooventure2016_Rev5_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Mooventure2016_Rev5") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Mooventure2016_Rev5_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
{
  extern unsigned int sf_Mooventure2016_Rev5_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "Mooventure2016_Rev5") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Mooventure2016_Rev5_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_Mooventure2016_Rev5_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Mooventure2016_Rev5")) {
    return(sf_Mooventure2016_Rev5_method_dispatcher(simstructPtr,chartFileNumber,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Mooventure2016_Rev5_terminator();
    sf_debug_terminate();
  }
...
extern void Mooventure2016_Rev5_register_exported_symbols(SimStruct* S);
extern void Mooventure2016_Rev5_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Mooventure2016_Rev5_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Mooventure2016_Rev5_debug_initialize();
    }

    Mooventure2016_Rev5_initializer();
  }
