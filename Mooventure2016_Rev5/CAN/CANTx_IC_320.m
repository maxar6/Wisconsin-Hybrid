...
%%
  ...
  msg.name                    = 'HS TBCM STATE 2';
  msg.description             = 'ID320 FORD HS TBCM STATE 2';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'BCU_Cation';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 22;
  ...
  msg.fields{2}.name          = 'BCU_Hazard';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 23;
