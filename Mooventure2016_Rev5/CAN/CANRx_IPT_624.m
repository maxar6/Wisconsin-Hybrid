...
%%
  ...
  msg.description             = 'ID624 DCDC Status';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'IPT_DCErrorCategory';
  ...
  msg.fields{2}.name          = 'IPT_DCLVOn';
  msg.fields{2}.units         = 'Flag';
  msg.fields{2}.start_bit     = 9;
  ...
  msg.fields{3}.name          = 'IPT_DCLVGeneralError';
  ...
  msg.fields{6}.name          = 'IPT_DCLVBusVoltage';
  ...
  msg.fields{7}.name          = 'IPT_DCHVBusCurrent';
  msg.fields{7}.units         = 'A';
