...
%%
  ...
  msg.name                    = 'ABS Control 2';
  msg.description             = 'ID4B0 FORD ABS Control 2';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Front_left_whl_speed';
  msg.fields{1}.units         = 'kph';
  msg.fields{1}.start_bit     = 0;
  msg.fields{1}.bit_length    = 16;
  msg.fields{1}.byte_order    = 'BIG_ENDIAN';
  msg.fields{1}.data_type     = 'UNSIGNED';
  msg.fields{1}.scale         = 0.01;
  msg.fields{1}.offset        = -1000;

  msg.fields{2}.name          = 'Front_right_whl_speed';
  msg.fields{2}.units         = 'kph';
  msg.fields{2}.start_bit     = 16;
  msg.fields{2}.bit_length    = 16;
  msg.fields{2}.byte_order    = 'BIG_ENDIAN';
  msg.fields{2}.data_type     = 'UNSIGNED';
  msg.fields{2}.scale         = 0.01;
  msg.fields{2}.offset        = -1000;
  
  msg.fields{3}.name          = 'Rear_left_whl_speed';
  msg.fields{3}.units         = 'kph';
  ...
  msg.fields{3}.offset        = -1000;
  
  msg.fields{4}.name          = 'Rear_right_whl_speed';
  msg.fields{4}.units         = 'kph';
