...
%%
  ...
  msg.name                    = 'FIAT Engine Speed and Pedal Position';
  msg.description             = 'ID110 FIAT Engine Speed and Pedal Position';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Acel_Effect_Pos_V';
  msg.fields{2}.units         = '';
  ...
  msg.fields{5}.name          = 'Acel_Actual_Pos_V';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.scale         = 0.25;
  msg.fields{6}.offset        = 0;

  msg.fields{7}.name          = 'Acel_Effect_Pos';
  msg.fields{7}.units         = '%';
  msg.fields{7}.start_bit     = 32;
  msg.fields{7}.bit_length    = 8;
  msg.fields{7}.byte_order    = 'BIG_ENDIAN';
  msg.fields{7}.data_type     = 'UNSIGNED';
  msg.fields{7}.scale         = 0.392157;
  msg.fields{7}.offset        = 0;

  msg.fields{8}.name          = 'Acel_Grad';
  msg.fields{8}.units         = '%/ms';
  msg.fields{8}.start_bit     = 24;
  msg.fields{8}.bit_length    = 8;
  msg.fields{8}.byte_order    = 'BIG_ENDIAN';
  msg.fields{8}.data_type     = 'SIGNED';
  msg.fields{8}.scale         = 0.0078125;
  msg.fields{8}.offset        = 0;

  msg.fields{9}.name          = 'Throt_Pos';
  msg.fields{9}.units         = '%';
  msg.fields{9}.start_bit     = 16;
