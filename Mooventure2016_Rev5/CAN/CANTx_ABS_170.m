...
%%
  ...
  msg.name                    = 'ABS HS PCM Vehicle Control 1';
  msg.description             = 'ID170 FORD HS VEhcile Control 1';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Engine_On';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 3;
