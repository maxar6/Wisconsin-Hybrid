function msg = CANRx_Cluster_Information_430()
...
%%
  ...
  msg.name                    = 'Cluster Information';
  msg.description             = 'ID430 FORD Cluster Information';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 3;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'HEV_CC_Defrost_Mode';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'AC_Engaged_CMD';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 11;
