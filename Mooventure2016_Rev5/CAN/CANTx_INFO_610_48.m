function msg = CANTx_INFO_610_48()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 48';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 48';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Battery_Use_Pct';
  msg.fields{2}.units         = '%';
  ...
  msg.fields{2}.offset        = -100;
  
  msg.fields{3}.name          = 'Battery_SOC';
  msg.fields{3}.units         = '%';
  ...
  msg.fields{4}.name          = 'Battery_Drive_Mode';
  msg.fields{4}.units         = 'Mode';
