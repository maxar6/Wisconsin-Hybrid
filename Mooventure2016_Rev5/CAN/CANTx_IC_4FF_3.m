...
%%
  ...
  msg.name                    = 'VEHICLE INFORMATION 3';
  msg.description             = 'ID4FF FORD VEHICLE INFORMATION 3';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'VIN_DATA_BYTE_6';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'VIN_DATA_BYTE_7';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'VIN_DATA_BYTE_8';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'VIN_DATA_BYTE_9';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'VIN_DATA_BYTE_10';
  msg.fields{6}.units         = '';
  ...
  msg.fields{7}.name          = 'VIN_DATA_BYTE_11';
  msg.fields{7}.units         = '';
