...
%%
  ...
  msg.name                    = 'BrakeSysCon Features TT';
  msg.description             = 'ID415 FORD BrakeSysCon Features TT';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Brk_Warn_Teltal';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'ABS_TELTAL';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 28;
