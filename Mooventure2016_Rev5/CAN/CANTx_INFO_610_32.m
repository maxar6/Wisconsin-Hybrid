function msg = CANTx_INFO_610_32()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 32';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 32';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Average_MPG_6';
  ...
  msg.fields{3}.name          = 'Average_MPG_5';
  ...
  msg.fields{4}.name          = 'Average_MPG_4';
  ...
  msg.fields{5}.name          = 'Average_MPG_3';
  ...
  msg.fields{6}.name          = 'Average_MPG_2';
  ...
  msg.fields{7}.name          = 'Average_MPG_1';
