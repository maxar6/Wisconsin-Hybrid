function msg = CANRx_FuelLvls_AE()
...
%%
  ...
  msg.name                    = 'Fuel Levels';
  msg.description             = 'Fuel Levels';
  msg.protocol                = 'CAN_1';
  msg.module                  = 'ATI';
  msg.bus_name                = 'CAN_1';
  ...
  msg.fields{field_ctr}.name          = 'DieselFuelLevel';
  ...
  msg.fields{field_ctr}.scale         = 0.390625;
  msg.fields{field_ctr}.offset        = 0;
  
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'EthanolFuelLevel';
  msg.fields{field_ctr}.units         = '%';
