function msg = CANTx_INFO_610_64()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 64';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 64';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Motor2Battery';
  msg.fields{2}.units         = 'State';
  ...
  msg.fields{2}.offset        = -3;
  
  msg.fields{3}.name          = 'Motor2Axle';
  msg.fields{3}.units         = 'State';
  ...
  msg.fields{3}.offset        = -3;
  
  msg.fields{4}.name          = 'Engine2Axle';
  msg.fields{4}.units         = 'State';
  msg.fields{4}.start_bit     = 24;
  msg.fields{4}.bit_length    = 4;
  msg.fields{4}.byte_order    = 'BIG_ENDIAN';
  msg.fields{4}.data_type     = 'UNSIGNED';
  msg.fields{4}.scale         = 1;
  msg.fields{4}.offset        = -3;
  
  msg.fields{5}.name          = 'Engine2Motor';
  msg.fields{5}.units         = 'State';
  ...
  msg.fields{5}.offset        = -3;
  
  msg.fields{6}.name          = 'Gas_Use_Pct';
  msg.fields{6}.units         = '%';
  ...
  msg.fields{7}.name          = 'Battery_Use_Pct';
  msg.fields{7}.units         = '%';
  ...
  msg.fields{7}.offset        = -100;
  
  msg.fields{8}.name          = 'Engine_Status';
