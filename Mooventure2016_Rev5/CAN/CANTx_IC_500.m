...
%%
  ...
  msg.name                    = 'PCM DRIVER INTERFACE';
  msg.description             = 'ID500 FORD PCM DRIVER INTERFACE';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Ready_Light';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 8;
  ...
  msg.fields{2}.name          = 'Regen_Brakes_Disabled';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 10;
  ...
  msg.fields{3}.name          = 'HV_Elec_Sys_Warm';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 11;
  ...
  msg.fields{4}.name          = 'Repair_Wrench';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 12;
  ...
  msg.fields{5}.name          = 'Cruise_Ctrl_Light';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'Eng_Cool_Temp';
  msg.fields{6}.units         = '';
  ...
  msg.fields{7}.name          = 'Me_Cool_Temp';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 40;
