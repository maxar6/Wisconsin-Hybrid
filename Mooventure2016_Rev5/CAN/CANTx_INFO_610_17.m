function msg = CANTx_INFO_610_17()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 17';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 17';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Selected_Trip';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Previous_MPG';
