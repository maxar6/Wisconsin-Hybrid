function msg = CANTx_EatonCharger_EF()
...
%%
  ...
  msg.fields{1}.name          = 'ChargeEnable';
  msg.fields{1}.units         = '';
  ...
  msg.fields{1}.maximum       = 3;
  
  msg.fields{2}.name          = 'ChargeComplete';
  msg.fields{2}.units         = '';
  ...
  msg.fields{2}.maximum       = 3;
  
  msg.fields{3}.name          = 'ChargeSystemFault';
  msg.fields{3}.units         = '';
  ...
  msg.fields{6}.maximum       = 15;
  
  msg.fields{7}.name          = 'MessageChecksum';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 4;
  msg.fields{7}.bit_length    = 4;
  msg.fields{7}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{7}.data_type     = 'UNSIGNED';
  msg.fields{7}.scale         = 1;
  msg.fields{7}.offset        = 0;
  msg.fields{7}.maximum       = 15;
