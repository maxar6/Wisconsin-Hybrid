...
%%
  ...
  msg.name                    = 'HS Dyno Send';
  msg.description             = 'ID209 WISC HS DYNO SEND';
  msg.protocol                = '';
  msg.module                  = 'DYNO';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'RPM';
  msg.fields{1}.units         = 'RPM';
  msg.fields{1}.start_bit     = 54;
  ...
  msg.fields{2}.name          = 'Oil_Pressure';
  msg.fields{2}.units         = 'kpa';
  msg.fields{2}.start_bit     = 46;
  ...
  msg.fields{3}.name          = 'Temp_Guage';
  msg.fields{3}.units         = 'C';
  msg.fields{3}.start_bit     = 38;
  ...
  msg.fields{4}.name          = 'Engine_Crank';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'Engine_On';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 36;
  ...
  msg.fields{6}.name          = 'Load_On';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 35;
  ...
  msg.fields{7}.name          = 'Fault';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 33;
