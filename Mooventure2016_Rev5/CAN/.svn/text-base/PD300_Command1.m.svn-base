...
%%
  ...
  msg.name                    = 'PD300_Command1';
  msg.description             = 'Commands operating modes and others';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18EF0180');
  msg.idmask                  = hex2dec('FFFFFFFF');
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [242 00 00 00 00 00 00 00];
  ...
  msg.fields{field_ctr}.name          = 'Run_Request';
 ...
 field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Control_Mode_Cmd';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Motoring_Tq_Curve';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Generating_Tq_Curve';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Speed_Voltage_Torque_CMD';
  ...
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = -32000;
  
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Motoring_Torque_Lim';
  msg.fields{field_ctr}.units         = '%';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Generating_Torque_Lim';
  msg.fields{field_ctr}.units         = '%';
