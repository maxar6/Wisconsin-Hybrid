...
%%
  ...
  msg.name                    = 'BMS_Feedback_1';
  msg.description             = 'Battery_CAN';
  msg.protocol                = 'CAN_2';
  msg.module                  = 'TBCM';
  msg.bus_name                = 'CAN_2';
  ...
  msg.fields{field_ctr}.name          = 'Batt_current';
  ...
  msg.fields{field_ctr}.offset        = -150;
  
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Batt_voltage';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 180;
  
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name        = 'Batt_PwrOff';
  msg.fields{field_ctr}.units         = 'bool';
  msg.fields{field_ctr}.start_bit     = 39;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'LOS';
  msg.fields{field_ctr}.units         = 'bool';
  msg.fields{field_ctr}.start_bit     = 38;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'No_restart';
  msg.fields{field_ctr}.units        = 'bool';
  msg.fields{field_ctr}.start_bit     = 37;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'BCU_sts_cau';
  msg.fields{field_ctr}.units        = 'bool';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'BCU_sts_warn';
  msg.fields{field_ctr}.units       = 'bool';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Cont_status_unconf';
  msg.fields{field_ctr}.units         = 'bool';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Cont_status_conf';
  msg.fields{field_ctr}.units         = 'bool';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Traction_Batt_Flt';
  msg.fields{field_ctr}.units        = 'bool';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Traction_Batt_Contactor_Flt';
  msg.fields{field_ctr}.units        = 'bool';
  msg.fields{field_ctr}.start_bit     = 31;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Traction_Batt_Cooling_Flt';
  msg.fields{field_ctr}.units         = 'bool';
  msg.fields{field_ctr}.start_bit     = 30;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Traction_Batt_Electronic_Flt';
  msg.fields{field_ctr}.units        = 'bool';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Diag_Tool_Reqd';
  msg.fields{field_ctr}.units         = 'bool';
