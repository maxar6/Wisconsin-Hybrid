function msg = CANTx_DRVBYWIRE_12A()
...
%%
  ...
  msg.name                    = 'DriveByWireOutputMessage';
  msg.protocol                = 'CAN';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.fields{field_ctr}.name          = 'DriveByWireCMD';
  msg.fields{field_ctr}.units         = 'UnitsOutOf256';
  msg.fields{field_ctr}.start_bit     = 56;
  msg.fields{field_ctr}.bit_length    = 8;
  msg.fields{field_ctr}.scale         = .390625;
