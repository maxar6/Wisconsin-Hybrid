...
%%
  ...
  msg.name                    = 'FIAT Engine General Status 2';
  msg.description             = 'ID301 FIAT Engine General Status 2';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Eng_Boost_Pres_V';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Baro_Pres_Abs_V';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'PwrTrn_Hi_Elect_Load_Req';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'Aply_Brk_Pedal_Ind';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'Check_Fuel_Cap';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'Eng_Recommend_Shft';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 57;
  ...
  msg.fields{7}.name          = 'Eng_H20_In_Fuel';
  msg.fields{7}.units         = '';
  ...
  msg.fields{8}.name          = 'Eng_Boost_Pres';
  msg.fields{8}.units         = '%';
  msg.fields{8}.start_bit     = 48;
  msg.fields{8}.bit_length    = 8;
  msg.fields{8}.byte_order    = 'BIG_ENDIAN';
  msg.fields{8}.data_type     = 'UNSIGNED';
  msg.fields{8}.scale         = 0.392157;
  msg.fields{8}.offset        = 0;
  
  msg.fields{9}.name          = 'Eng_Oil_Remaining_Life';
  msg.fields{9}.units         = '%';
  msg.fields{9}.start_bit     = 40;
  msg.fields{9}.bit_length    = 8;
  msg.fields{9}.byte_order    = 'BIG_ENDIAN';
  msg.fields{9}.data_type     = 'UNSIGNED';
  msg.fields{9}.scale         = 0.392157;
  msg.fields{9}.offset        = 0;

  msg.fields{10}.name          = 'Eng_Prod_Option_Ident';
  msg.fields{10}.units         = '';
  msg.fields{10}.start_bit     = 32;
  msg.fields{10}.bit_length    = 8;
  msg.fields{10}.byte_order    = 'BIG_ENDIAN';
  msg.fields{10}.data_type     = 'UNSIGNED';
  msg.fields{10}.scale         = 1;
  msg.fields{10}.offset        = 0;

  msg.fields{11}.name          = 'Eng_Fan_Spd';
  msg.fields{11}.units         = '%';
  msg.fields{11}.start_bit     = 24;
  msg.fields{11}.bit_length    = 8;
  msg.fields{11}.byte_order    = 'BIG_ENDIAN';
  msg.fields{11}.data_type     = 'UNSIGNED';
  msg.fields{11}.scale         = 0.392157;
  msg.fields{11}.offset        = 0;
  
  msg.fields{12}.name          = 'Eng_Gear_Shift_Inh_Req';
  msg.fields{12}.units         = '';
  msg.fields{12}.start_bit     = 23;
  ...
  msg.fields{13}.name          = 'Eng_Jerk_Shift_Pattern_Req';
  msg.fields{13}.units         = '';
  msg.fields{13}.start_bit     = 22;
  ...
  msg.fields{14}.name          = 'Eng_Ntral_Control_Inh_Req';
  msg.fields{14}.units         = '';
  msg.fields{14}.start_bit     = 21;
  ...
  msg.fields{15}.name          = 'Reduce_Prf_Shft_Ptrn_Req';
  msg.fields{15}.units         = '';
  ...
  msg.fields{16}.name          = 'Throt_Progression';
  msg.fields{16}.units         = '';
  msg.fields{16}.start_bit     = 9;
  ...
  msg.fields{17}.name          = 'PwrTrn_Part_Filter Warning';
  msg.fields{17}.units         = '';
  ...
  msg.fields{18}.name          = 'Baro_Pres_Abs';
  msg.fields{18}.units         = 'kPa';
  msg.fields{18}.start_bit     = 0;
  msg.fields{18}.bit_length    = 8;
  msg.fields{18}.byte_order    = 'BIG_ENDIAN';
  msg.fields{18}.data_type     = 'UNSIGNED';
  msg.fields{18}.scale         = 0.5;
