function msg = CANRx_INFO_610_80()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 80';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 80';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Confirm_Active_Trip';
  msg.fields{2}.units         = 'Yes/No';
  ...
  msg.fields{3}.name          = 'Confirm_Reset_Trip_B';
  msg.fields{3}.units         = 'Yes/No';
  ...
  msg.fields{4}.name          = 'Confirm_Reset_Trip_A';
  msg.fields{4}.units         = 'Yes/No';
