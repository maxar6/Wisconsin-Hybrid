...
%%
  ...
  msg.name                    = 'FIAT Engine Temp';
  msg.description             = 'ID510 FIAT Engine Temperature';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Eng_Coolant_Temp_V';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Eng_Intake_Air_Temp_V';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Eng_Coolant_Temp';
  ...
  msg.fields{4}.name          = 'Eng_Intake_Air_Temp';
