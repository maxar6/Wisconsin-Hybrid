...
%%
  ...
  msg.name                    = 'PD300_Status1';
  msg.description             = 'ExtraInputs';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [243 2 00 00 00 00 00 00];
  ...
  msg.fields{field_ctr}.name          = 'PD300_AD_Input1_En';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_XDRP_State';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 41;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_PWMOutput_State';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 42;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
      ...
      field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_AD_Input2_En';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 43;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
        ...
        field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Bus_HVIL_Status';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
          ...
          field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_3Phase_HVIL_Status';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
            ...
            field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_DPos_Sens1';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
              ...
              field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_DigPos_Sens2';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 33;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
                ...
                field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_DigPos_Sens3';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 34;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
        ...
        field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_DigPos_Sens4';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 35;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_DigPos_Sens5';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 36;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_CtrlBoard_Temp';
  msg.fields{field_ctr}.units         = 'degC';
  ...
  msg.fields{field_ctr}.offset        = -40;
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Keyed_Voltage';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_AD_Input1_Vin';
  msg.fields{field_ctr}.units         = 'V';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_AD_Input2_Vin';
  msg.fields{field_ctr}.units         = 'V';
