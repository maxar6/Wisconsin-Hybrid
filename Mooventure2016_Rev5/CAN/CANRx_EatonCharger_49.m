function msg = CANRx_EatonCharger_49()
...
%%
  ...
  msg.name                    = 'Status';
  msg.description             = 'Eaton HV Charger';
  msg.protocol                = 'J1939';
  msg.module                  = '';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18FF4049');
...
%%
  ...
  msg.fields{5}.scale         = 0.5;
  msg.fields{5}.offset        = 0;
  msg.fields{5}.maximum       = 125;
  
  msg.fields{6}.name          = 'Eaton_HV_Charger_Temperature';
  msg.fields{6}.units         = 'C';
  msg.fields{6}.start_bit     = 16;
  msg.fields{6}.bit_length    = 8;
  msg.fields{6}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{6}.data_type     = 'SIGNED';
  msg.fields{6}.scale         = 1;
  msg.fields{6}.offset        = -40;
  msg.fields{6}.minimum       = -40;
  msg.fields{6}.maximum       = 210;  
  
  msg.fields{7}.name          = 'IgnitionStatus';
  msg.fields{7}.units         = '';
