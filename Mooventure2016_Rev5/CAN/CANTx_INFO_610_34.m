function msg = CANTx_INFO_610_34()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 34';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 34';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Subfunction_Select';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Average_MPG_Tot';
  msg.fields{2}.units         = 'MPG';
  ...
  msg.fields{3}.name          = 'Bar_Color_9';
  msg.fields{3}.units         = 'On/Off';
  msg.fields{3}.start_bit     = 0;
  ...
  msg.fields{4}.name          = 'Bar_Color_8';
  msg.fields{4}.units         = 'On/Off';
  msg.fields{4}.start_bit     = 15;
  ...
  msg.fields{5}.name          = 'Bar_Color_7';
  msg.fields{5}.units         = 'On/Off';
  msg.fields{5}.start_bit     = 14;
  ...
  msg.fields{7}.name          = 'Bar_Color_5';
  msg.fields{7}.units         = 'On/Off';
  msg.fields{7}.start_bit     = 12;
  ...
  msg.fields{8}.name          = 'Bar_Color_4';
  msg.fields{8}.units         = 'On/Off';
  msg.fields{8}.start_bit     = 11;
  ...
  msg.fields{9}.name          = 'Bar_Color_3';
  msg.fields{9}.units         = 'On/Off';
  msg.fields{9}.start_bit     = 10;
  ...
  msg.fields{10}.name          = 'Bar_Color_2';
  ...
  msg.fields{11}.name          = 'Bar_Color_15';
  msg.fields{11}.units         = 'On/Off';
  msg.fields{11}.start_bit     = 6;
  ...
  msg.fields{12}.name          = 'Bar_Color_14';
  msg.fields{12}.units         = 'On/Off';
  msg.fields{12}.start_bit     = 5;
  ...
  msg.fields{13}.name          = 'Bar_Color_13';
  msg.fields{13}.units         = 'On/Off';
  msg.fields{13}.start_bit     = 4;
  ...
  msg.fields{14}.name          = 'Bar_Color_12';
  msg.fields{14}.units         = 'On/Off';
  msg.fields{14}.start_bit     = 3;
  ...
  msg.fields{15}.name          = 'Bar_Color_11';
  msg.fields{15}.units         = 'On/Off';
  msg.fields{15}.start_bit     = 2;
  ...
  msg.fields{16}.name          = 'Bar_Color_10';
  ...
  msg.fields{17}.name          = 'Bar_Color_1';
  ...
  msg.fields{18}.name          = 'Average_MPG_15';
  msg.fields{18}.units         = 'MPG';
  ...
  msg.fields{19}.name          = 'Average_MPG_14';
  msg.fields{19}.units         = 'MPG';
  msg.fields{19}.start_bit     = 32;
  ...
  msg.fields{20}.name          = 'Average_MPG_13';
  msg.fields{20}.units         = 'MPG';
  msg.fields{20}.start_bit     = 40;
  msg.fields{20}.bit_length    = 8;
