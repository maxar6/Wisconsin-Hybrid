function msg = CANRx_BATTERY_2FC()
...
%%
  ...
  msg.name                    = 'PackPowerLimits_Continuous';
  msg.description             = '';
  msg.protocol                = '';
  msg.module                  = 'Battery';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'MaximumDischargePower_Continuous';
  ...
  msg.fields{2}.name          = 'MaximumRegenPower_Continuous';
  ...
  msg.fields{3}.name          = 'PPLCont_RollingCounter';
  msg.fields{3}.units         = '';
