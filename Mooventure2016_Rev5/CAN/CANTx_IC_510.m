...
%%
  ...
  msg.name                    = 'HS PCM VEHCILE CONTROL 3';
  msg.description             = 'ID510 FORD HS PCM VEHICLE CONTROL 3';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Check_Engine_Light';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 52;
  ...
  msg.fields{2}.name          = 'Battery_Light';
  msg.fields{2}.units         = '';
