function msg = CANTx_INFO_610_82()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 82';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 82';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Trip_B_Savings';
  ...
  msg.fields{4}.name          = 'Trip_B_Fuel_Used';
