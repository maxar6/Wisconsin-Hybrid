...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'IPT_InverterTemperature';
  msg.fields{1}.units         = 'Deg C';
  ...
  msg.fields{1}.offset        = -40;

  msg.fields{2}.name          = 'IPT_MotorTemperature';
  msg.fields{2}.units         = 'Deg C';
  ...
  msg.fields{7}.name          = 'IPT_IPTReady';
  msg.fields{7}.units         = 'Flag';
  msg.fields{7}.start_bit     = 51;
  ...
  msg.fields{8}.name          = 'IPT_IPTAwake';
  msg.fields{8}.units         = 'Flag';
  msg.fields{8}.start_bit     = 50;
  ...
  msg.fields{9}.name          = 'IPT_MotorReady';
  msg.fields{9}.units         = 'Flag';
  msg.fields{9}.start_bit     = 49;
  ...
  msg.fields{10}.name          = 'IPT_MaxWasteAvailable';
  msg.fields{10}.units         = 'Watts';
  msg.fields{10}.start_bit     = 56;
  msg.fields{10}.bit_length    = 8;
  msg.fields{10}.byte_order    = 'BIG_ENDIAN';
  msg.fields{10}.data_type     = 'UNSIGNED';
  msg.fields{10}.scale         = 50;
