function msg = CANTx_INFO_610_81()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 81';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 81';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Trip_A_Savings';
  msg.fields{2}.units         = 'Dollars_per_Gallon';
  ...
  msg.fields{3}.name          = 'Trip_A_Cost';
  msg.fields{3}.units         = 'Dollars_per_Gallon';
  ...
  msg.fields{4}.name          = 'Trip_A_Fuel_Used';
  msg.fields{4}.units         = 'Gallons';
