...
%%
  ...
  msg.name                    = 'VEHICLE INFORMATION 4';
  msg.description             = 'ID4FF FORD VEHICLE INFORMATION 4';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'VIN_DATA_BYTE_12';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'VIN_DATA_BYTE_13';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'VIN_DATA_BYTE_14';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'VIN_DATA_BYTE_15';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'VIN_DATA_BYTE_16';
  msg.fields{6}.units         = '';
  ...
  msg.fields{7}.name          = 'VIN_DATA_BYTE_17';
  msg.fields{7}.units         = '';
