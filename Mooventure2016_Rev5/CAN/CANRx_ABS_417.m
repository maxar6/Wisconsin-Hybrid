...
%%
  ...
  msg.name                    = 'ABS Traction Control Status';
  msg.description             = 'ID417 FORD Traction Control Status';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'TCS_ENG_EVNT_IN_PROGRESS';
  msg.fields{1}.units         = '';
