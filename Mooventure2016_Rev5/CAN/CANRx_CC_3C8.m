...
%%
  ...
  msg.name                    = 'Temperature Control';
  msg.description             = 'ID3C8 FORD Temperature Control';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{4}.name          = 'PASSENGER_10';
  msg.fields{4}.units         = '';
