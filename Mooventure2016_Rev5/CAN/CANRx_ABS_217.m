...
%%
  ...
  msg.name                    = 'ABS Wheel Info';
  msg.description             = 'ID217 FORD ABS Wheel Info';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'LF_Wheel_Rolling_Count';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'RT_Wheel_Rolling_Count';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Wheel_Rolling_Timestamp';
  msg.fields{3}.units         = '';
