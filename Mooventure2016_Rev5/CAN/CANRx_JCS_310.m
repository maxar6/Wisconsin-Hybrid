...
%%
  ...
  msg.fields{field_ctr}.name          = 'SOC_max_lim';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'SOC_hi_lim';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'SOC_low_lim';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'SOC_min_lim';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Batt_Temp';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Charg_power_lim';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Dischg_power_lim';
  msg.fields{field_ctr}.units         = '';
