...
%%
  ...
  msg.name                    = 'DIAG SID IC HS ReqM';
  msg.description             = 'ID720 FORD DIAG SID IC HS ReqM';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
