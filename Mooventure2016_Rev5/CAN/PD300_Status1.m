...
%%
  ...
  msg.description             = 'SpeedTqVoltage';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [243 00 00 00 00 00 00 00];
  ...
  msg.fields{field_ctr}.name          = 'PD300_Est_Absolute_Torque';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Motor_Speed';
  ...
  msg.fields{field_ctr}.offset        = -32000;
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_HVBus_Voltage';
