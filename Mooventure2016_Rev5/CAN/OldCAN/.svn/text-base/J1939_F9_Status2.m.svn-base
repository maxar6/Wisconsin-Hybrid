...
%%
  ...
  msg.name                    = 'F9_Status2';
  msg.description             = 'OP_State_OP_Mode_Error';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.payloadvalue            =hex2dec('F30100000000000');
  msg.payloadmask             =hex2dec('FFFF00000000000');

  id_ctr = 0;
  
  id_ctr = id_ctr + 1;
  msg.idcontent{id_ctr}.name       = 'Node ID';
  msg.idcontent{id_ctr}.start_bit  = 8;
  msg.idcontent{id_ctr}.bit_length = 8;
  ...
  msg.fields{field_ctr}.name          = 'Operating State';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Operating Mode';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Error';
  msg.fields{field_ctr}.units         = '%';
