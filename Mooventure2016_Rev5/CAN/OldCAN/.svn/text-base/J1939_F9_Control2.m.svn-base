...
%%
  ...
  msg.name                    = 'F9_Control2';
  msg.description             = 'Torque_Limit_Motoring,Torque_Limit_Regen';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('00ffa700');
  ...
  msg.fields{field_ctr}.name          = 'Torque_Limit_Motoring';
  ...
  %%msg.fields{field_ctr}.maximum       = 2^11-1;  %% Defaults to maximum possible value in field
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Torque_Limit_Generating';
