...
%%
  ...
  msg.name                    = 'F9_Status1';
  msg.description             = 'Motor_Speed_and_Est_Torque';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.payloadvalue            =hex2dec('F300000000000000');
  msg.payloadmask             =hex2dec('FFFF000000000000');
  ...
  msg.fields{field_ctr}.name          = 'Motor_Speed';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Estimated_Motor_Torque';
  ...
  msg.fields{field_ctr}.offset        = -3200;
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'DC_Bus_Voltage';
