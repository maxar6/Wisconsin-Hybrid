function msg = CANTx_INFO_610_16()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 16';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 16';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Engine_Status';
  msg.fields{2}.units         = 'On/Off';
