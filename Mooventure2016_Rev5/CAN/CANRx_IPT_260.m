...
%%
  ...
  msg.name                    = 'IPT Status 2';
  msg.description             = 'ID260 IPT Status 2';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'IPT_CurrentUsed';
  ...
  msg.fields{1}.offset        = -600;

  msg.fields{2}.name          = 'IPT_CurrentRequest';
  ...
  msg.fields{2}.offset        = -600;

  msg.fields{3}.name          = 'IPT_MotorSpeed';
  ...
  msg.fields{3}.offset        = -15000;

  msg.fields{4}.name          = 'IPT_WheelTorqueDelivered';
  msg.fields{4}.units         = 'N-m';
  msg.fields{4}.start_bit     = 47;
  msg.fields{4}.bit_length    = 13;
  msg.fields{4}.byte_order    = 'BIG_ENDIAN';
  msg.fields{4}.data_type     = 'UNSIGNED';
  msg.fields{4}.scale         = 1;
  msg.fields{4}.offset        = -4000;

  msg.fields{5}.name          = 'IPT_CurrentLimit';
  ...
  msg.fields{6}.name          = 'IPT_Antishudder';
