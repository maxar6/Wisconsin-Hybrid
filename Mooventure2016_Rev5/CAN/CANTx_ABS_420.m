...
%%
  ...
  msg.name                    = 'ABS HS TMU Control 2';
  msg.description             = 'ID420 FORD HS TMU Control 2';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Commanded_gen_torq';
  msg.fields{1}.units         = '';
  ...
  msg.fields{1}.offset        = -110;
  
  msg.fields{2}.name          = 'Commanded_mot_torq';
  msg.fields{2}.units         = '';
