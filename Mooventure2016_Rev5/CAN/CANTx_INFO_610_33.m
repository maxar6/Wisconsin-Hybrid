function msg = CANTx_INFO_610_33()
...
%%
  ...
  msg.name                    = 'INFO HS2 VEH 2 HMI 33';
  msg.description             = 'ID610 FORD HS2 VEH 2 HMI 33';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Average_MPG_9';
  msg.fields{2}.units         = 'MPG';
  msg.fields{2}.start_bit     = 24;
  ...
  msg.fields{3}.name          = 'Average_MPG_8';
  msg.fields{3}.units         = 'MPG';
  ...
  msg.fields{4}.name          = 'Average_MPG_7';
  msg.fields{4}.units         = 'MPG';
  ...
  msg.fields{5}.name          = 'Average_MPG_12';
  msg.fields{5}.units         = 'MPG';
  ...
  msg.fields{6}.name          = 'Average_MPG_11';
  msg.fields{6}.units         = 'MPG';
  ...
  msg.fields{7}.name          = 'Average_MPG_10';
  msg.fields{7}.units         = 'MPG';
  msg.fields{7}.start_bit     = 16;
