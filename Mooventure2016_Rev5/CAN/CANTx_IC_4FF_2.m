...
%%
  ...
  msg.name                    = 'VEHICLE INFORMATION 2';
  msg.description             = 'ID4FF FORD VEHICLE INFORMATION 2';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'VIN_DATA_BYTE_1';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'VIN_DATA_BYTE_2';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'VIN_DATA_BYTE_3';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'VIN_DATA_BYTE_4';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'VIN_DATA_BYTE_5';
  msg.fields{6}.units         = '';
