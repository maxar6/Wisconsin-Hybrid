...
%%
  ...
  msg.name                    = 'IPT ID590';
  msg.description             = 'ID590 ClockStatus';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
  ...
  msg.fields{3}.name          = 'Altitude';
  msg.fields{3}.units         = 'Meters';
  msg.fields{3}.start_bit     = 16;
  msg.fields{3}.bit_length    = 13;
  msg.fields{3}.byte_order    = 'BIG_ENDIAN';
  msg.fields{3}.data_type     = 'UNSIGNED';
  msg.fields{3}.scale         = 1;
  msg.fields{3}.offset        = -500;
  
  msg.fields{4}.name          = 'GPSQuality';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 29;
  ...
  msg.fields{5}.name          = 'DateTime';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 32;
  msg.fields{5}.bit_length    = 32;
