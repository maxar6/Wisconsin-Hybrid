...
%%
  ...
  msg.name                    = 'VSC_IPTCommand';
  msg.description             = 'ID262 VSC IPT Command';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'VSC_TRSPosition';
  msg.fields{1}.units         = 'Flag';
  msg.fields{1}.start_bit     = 30;
  ...
  msg.fields{2}.name          = 'VSC_MotorEnable';
  msg.fields{2}.units         = 'Flag';
  msg.fields{2}.start_bit     = 29;
  ...
  msg.fields{3}.name          = 'VSC_ActiveDischargeDisable';
  msg.fields{3}.units         = 'Flag';
  msg.fields{3}.start_bit     = 28;
  ...
  msg.fields{4}.name          = 'VSC_AntishudderDisable';
  msg.fields{4}.units         = 'Flag';
  msg.fields{4}.start_bit     = 27;
  ...
  msg.fields{5}.name          = 'VSC_SDPTActive';
  msg.fields{5}.units         = 'Flag';
  msg.fields{5}.start_bit     = 26;
  ...
  msg.fields{6}.name          = 'VSC_IPTWakeup';
  msg.fields{6}.units         = 'Flag';
  msg.fields{6}.start_bit     = 25;
  ...
  msg.fields{7}.name          = 'VSC_IPTEnable';
  msg.fields{7}.units         = 'Flag';
  msg.fields{7}.start_bit     = 24;
