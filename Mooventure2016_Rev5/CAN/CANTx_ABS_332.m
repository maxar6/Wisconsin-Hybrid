...
%%
  ...
  msg.name                    = 'ABS HS Vehicle Control 2';
  msg.description             = 'ID332 FORD HS VEhcile Control 2';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'ACC_torq_rqstd';
  msg.fields{1}.units         = 'N-m';
  ...
  msg.fields{2}.name          = 'Pct_whl_trq_desired';
  msg.fields{2}.units         = '%';
  ...
  msg.fields{3}.name          = 'Power_train_torq_actual';
  ...
  msg.fields{3}.offset        = -32767;
  
  msg.fields{4}.name          = 'prndl_dir';
  msg.fields{4}.units         = 'on/off';
  msg.fields{4}.start_bit     = 6;
  msg.fields{4}.bit_length    = 11;
  msg.fields{4}.byte_order    = 'BIG_ENDIAN';
  msg.fields{4}.data_type     = 'UNSIGNED';
  msg.fields{4}.scale         = 1;
  msg.fields{4}.offset        = 0;
  
  msg.fields{5}.name          = 'Regen_torq_limit';
  msg.fields{5}.units         = 'N-m';
