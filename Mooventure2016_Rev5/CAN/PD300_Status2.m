...
%%
  ...
  msg.name                    = 'PD300_Status2';
  msg.description             = 'StatesModesErrors';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [243 1 00 00 00 00 00 00];
  ...
  msg.fields{field_ctr}.name          = 'PD300_RunEnable';
  ...
  msg.fields{field_ctr}.data_type     = 'BOOLEAN';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
  
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_NegativeTq';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Generating';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
      ...
      field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Fault';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
        ...
        field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_TqLimiting_Reason';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 44;
  msg.fields{field_ctr}.bit_length    = 4;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_ControlMode';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_MotoringTqCurve';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 36;
  msg.fields{field_ctr}.bit_length    = 2;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  msg.fields{field_ctr}.offset        = 0;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_GeneratingTqCurve';
  msg.fields{field_ctr}.units         = '';
  ...
  msg.fields{field_ctr}.offset        = 0;
      ...
      field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Est_Relative_Torque';
  msg.fields{field_ctr}.units         = '%';
  ...
  msg.fields{field_ctr}.offset        = 0;
    ...
    field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_Estimated_VBatt_LV';
  ...
  msg.fields{field_ctr}.offset        = 0;
      ...
      field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_MotorTemp';
  ...
  msg.fields{field_ctr}.offset        = -40;
        ...
        field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'PD300_DriveTemp';
  msg.fields{field_ctr}.units         = 'degC';
