...
%%
  ...
  msg.name                    = 'PSCM Steering Wheel Angle';
  msg.description             = 'ID80 FORD PSCM Steering Wheel Angle';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'STR_WHL_ANGLE_CNTR_FND';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'STR_WHL_ANGLE';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 49;
  ...
  msg.fields{3}.name          = 'RELATIVE_STR_WHL_ANGLE';
  msg.fields{3}.units         = '';
