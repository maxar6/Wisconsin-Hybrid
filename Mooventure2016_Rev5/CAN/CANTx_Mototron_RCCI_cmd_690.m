function msg = CANTx_Mototron_RCCI_cmd_690()
...
%%                   filCAN_T_ter requires the bits set in the payload mask to
...
%%
  ...
  msg.name                    = 'Mototron RCCI Command';
  msg.description             = '';
  msg.protocol                = '';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';
  ...
  msg.fields{field_ctr}.name          = 'Accel_Ped_Command';
  ...
  msg.fields{field_ctr}.scale         = 0.392157;
  msg.fields{field_ctr}.offset        = 0;

  
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'RCCI_Request';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Engine_Run_Requested';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 55;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
