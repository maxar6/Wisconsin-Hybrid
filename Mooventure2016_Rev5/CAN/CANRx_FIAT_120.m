...
%%
  ...
  msg.name                    = 'FIAT Engine Torque';
  msg.description             = 'ID120 FIAT Engine Torque';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Eng_Torq_Actual_V';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Eng_Torq_Driver_Reqest_V';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Eng_Max_Drag_Torq_V';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'Eng_Torq_Max_V';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'Eng_Torq_Actual';
  ...
  msg.fields{6}.name          = 'Eng_Torq_Request';
  msg.fields{6}.units         = 'Nm';
  msg.fields{6}.start_bit     = 32;
  ...
  msg.fields{7}.name          = 'Eng_Max_Drag_Torq';
