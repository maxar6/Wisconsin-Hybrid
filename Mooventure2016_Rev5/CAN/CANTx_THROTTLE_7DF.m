...
%%
  ...
  msg.name                    = 'Throttle Position Request';
  msg.description             = 'ID7DF Ford Throttle Position Request';
  msg.protocol                = '';
  msg.module                  = 'FORD';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Number_Of_Bytes';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Real_Time_Or_Freeze_Frame';
  msg.fields{2}.units         = '';
