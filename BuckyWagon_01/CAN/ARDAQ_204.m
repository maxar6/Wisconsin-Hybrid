...
%%
  ...
  msg.fields{field_ctr}.name          = 'BattCrntStr7';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'battTemp';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'cruiseTarget';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'AuxVoltage';
