function msg = CANTx_UQM_14EFrrss()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{8}.scale         = 0.1;
  msg.fields{8}.offset        = -3212.8;
  ...
  msg.fields{9}.scale         = 0.5;
  msg.fields{9}.offset        = -16064;
