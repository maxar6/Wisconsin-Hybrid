function msg = CANTx_EATONM_18FF30F0()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Fault_Severity_Indicator';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 20;
  msg.fields{1}.bit_length    = 3;
  msg.fields{1}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{1}.data_type     = 'UNSIGNED';
  msg.fields{1}.scale         = 1;
  msg.fields{1}.offset        = 0;

  msg.fields{2}.name          = 'Message_Checksum';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Message_Counter';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'Motor_Control_State';
  msg.fields{4}.units         = '';
