function msg = CANRx_UQM_14EFrrss()
...
%%
  ...
  msg.name                    = 'Limited_Torque_Percentage_Message';
  msg.description             = '';
  msg.protocol                = '';
  msg.module                  = 'Inverter';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{3}.scale         = 0.8;
  msg.fields{3}.offset        = -100;
