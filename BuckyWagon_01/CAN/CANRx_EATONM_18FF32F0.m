function msg = CANTx_EATONM_18FF32F0()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{3}.offset        = -8000;

  msg.fields{4}.name          = 'Maximum_Rated_Torqe';
  msg.fields{4}.units         = 'Nm';
