function msg = CANRx_UQM_18EFrrss()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Inverter_Temperature';
  ...
  msg.fields{2}.name          = 'Rotor_Temp';
  msg.fields{2}.units         = 'degC';
