function msg = J1939_CoolantPump_Control()
...
%%
  ...
  msg.name                    = 'Coolant_Pump_Control';
  msg.description             = 'Coolant Pump Control';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18ef208B');
  msg.idmask                  = hex2dec('ffffffff');
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_mask            = 'f0ffff00ffffffff';
  msg.payload_value           = 'f0ffff00ffffffff';
  msg.interval                = 100;

  field_ctr = 0;

  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Mode and Direction';% 57..56
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Hold Mode'; % 59..58
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Set to FFFF'; % 59..58
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Speed'; % 59..58
  msg.fields{field_ctr}.units         = '%';
