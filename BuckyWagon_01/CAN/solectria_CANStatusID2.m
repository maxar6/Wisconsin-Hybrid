function msg = solectria_CANStatusID2()
%%
...
%%
  ...
  msg.fields{field_ctr}.name          = 'HeatsinkTemp';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'MotorTemp';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'DCVoltage';
  msg.fields{field_ctr}.units         = 'V';
  msg.fields{field_ctr}.start_bit     = 24;
  msg.fields{field_ctr}.bit_length    = 16;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'SIGNED';
  msg.fields{field_ctr}.scale         = 200/1024;
  msg.fields{field_ctr}.offset        = 0;
