function msg = CANTx_EATONM_18FF3AEF()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{4}.name          = 'Speed_Command';
  msg.fields{4}.units         = '';
  ...
  msg.fields{4}.offset        = -8000;
  
  msg.fields{5}.name          = 'Speed_Ramp_Rate';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'Torque_Command';
  msg.fields{6}.units         = '';
