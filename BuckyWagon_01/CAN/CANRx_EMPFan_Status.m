...
%%
  ...
  msg.name                    = 'Cooling_Fan_Status';
  msg.description             = 'Cooling Fan Status';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18ff038B'); 
  ...
  msg.fields{field_ctr}.name          = 'Fan Status'; % 61..58
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fan Mode'; % 57..56
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fan Speed'; %% 55..48..40
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fan Power'; %% 23..16..8
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fan Speed Percent'; %% 7..0
  msg.fields{field_ctr}.units         = '%';
