function msg = J1939_6A_PowerSteering_Control()
...
%%
  ...
  msg.name                    = '6A_Control';
  msg.description             = 'Power Steering Pump Control';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_2';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18ff6aef');
  ...
  msg.fields{field_ctr}.name          = 'EHPAS Activate';  % 58..56
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Performance Limit'; % 55..48
  msg.fields{field_ctr}.units         = 'percent';
  msg.fields{field_ctr}.start_bit     = 48;
  msg.fields{field_ctr}.bit_length    = 8;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 0.4;
  msg.fields{field_ctr}.offset        = 0;
  %msg.fields{field_ctr}.minimum       = -(2^11); %% Defaults to minimum possible value in field
