...
%%
  ...
  msg.fields{field_ctr}.name          = 'bcm_balancing';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_balancing_cnt';
  msg.fields{field_ctr}.units         = 'cells';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_eeprom_wip';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_fault_mon';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_fgd';
  msg.fields{field_ctr}.units         = '%';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_ibat2';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_mainc_step';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_vbus_neg';
  ...
  msg.fields{field_ctr}.offset        = -500;
  
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_vbus_pos';
  msg.fields{field_ctr}.units         = 'V';
  msg.fields{field_ctr}.start_bit     = 20;
  msg.fields{field_ctr}.bit_length    = 12;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 0.25;
