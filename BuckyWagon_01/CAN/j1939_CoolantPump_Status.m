...
%%
  ...
  msg.name                    = 'Coolant_Pump_Status';
  msg.description             = 'Coolant Pump Status';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18ff0320'); 
  ...
  msg.fields{field_ctr}.name          = 'Pump Status'; % 61..58
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Mode'; % 57..56
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Speed'; %% 55..48..40
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Controller Temp'; %% 39..32..24
  msg.fields{field_ctr}.units         = 'degC';
  msg.fields{field_ctr}.start_bit     = 32;
  msg.fields{field_ctr}.bit_length    = 16;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 0.03125;
  msg.fields{field_ctr}.offset        = -273;


  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Power'; %% 23..16..8
  msg.fields{field_ctr}.units         = 'W';
  msg.fields{field_ctr}.start_bit     = 16;
  msg.fields{field_ctr}.bit_length    = 16;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1.0;
  msg.fields{field_ctr}.offset        = 0;

  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Speed Percent'; %% 7..0
  msg.fields{field_ctr}.units         = '%';
