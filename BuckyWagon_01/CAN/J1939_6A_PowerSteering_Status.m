function msg = J1939_6A_PowerSteering_Status()
...
%%
  ...
  msg.name                    = '6A_Status1';
  msg.description             = 'Power Steering Status';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_2';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('00ff602e'); %hex2dec('00ff6000');
  msg.idmask                  = hex2dec('00ffffff'); %hex2dec('00ffff00');
  msg.idinherit               =  0;
  msg.payload_size            =  8;
  msg.payload_value           = [];
  msg.payload_mask            = [];
  ...
  msg.fields{field_ctr}.name          = 'Input Voltage'; % 63..56
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Input Current'; % 55..48
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Pump Speed'; %% 47..40..32
  msg.fields{field_ctr}.units         = 'RPM';
  msg.fields{field_ctr}.start_bit     = 40;
  msg.fields{field_ctr}.bit_length    = 16;
  msg.fields{field_ctr}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 0.125;
  msg.fields{field_ctr}.offset        = 0;

  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Board Temperature (Max)'; %% 31..24
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Board Temperature (Current)'; %% 23..16
  msg.fields{field_ctr}.units         = 'degC';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Operating State'; %% 11..8
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fault Indicator'; %% 14..12
  msg.fields{field_ctr}.units         = '';
