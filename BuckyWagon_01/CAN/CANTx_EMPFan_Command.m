...
%%
  ...
  msg.name                    = 'Coolant_Fan_Control';
  msg.description             = 'Coolant Fan Control';
  msg.protocol                = 'J1939';
  msg.module                  = 'PCM-1';
  msg.bus_name                = 'CAN_1';

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('18ef8B01');
  ...
  msg.fields{field_ctr}.name          = 'Fan Mode and Direction';% 57..56
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fan Hold Mode'; % 59..58
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'Fan Speed'; % 59..58
  msg.fields{field_ctr}.units         = '%';
