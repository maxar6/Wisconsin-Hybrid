function msg = CANTx_EATONM_18FF31F0()
...
%%
  ...
  msg.name                    = 'Voltage_Current_and_Temperature';
  msg.description             = '';
  msg.protocol                = '';
  msg.module                  = 'Inverter';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{3}.offset        = -40;

  msg.fields{4}.name          = 'Motor_Temperature';
  ...
  msg.fields{4}.offset        = -40;
  
  msg.fields{5}.name          = 'Phase_Current';
  msg.fields{5}.units         = 'A';
  msg.fields{5}.start_bit     = 28;
  msg.fields{5}.bit_length    = 12;
  msg.fields{5}.byte_order    = 'LITTLE_ENDIAN';
  msg.fields{5}.data_type     = 'UNSIGNED';
  msg.fields{5}.scale         = 0.2;
  msg.fields{5}.offset        = -400;
    
  msg.fields{6}.name          = 'Phase_phase_voltage';
