function msg = solectria_CANCommand()
%%
...
%%
  ...
  msg.name                    = 'CAN Command';
  msg.description             = 'CAN Command for Solectria DMOC 445';
  msg.channel                 = 1;
  ...
  msg.fields{field_ctr}.name          = 'SpeedSet';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'LowerTorqueLimit';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'UpperTorqueLimit';
  msg.fields{field_ctr}.units         = 'Nm';
