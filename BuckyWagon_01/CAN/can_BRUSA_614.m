function msg = can_BRUSA_614()
%% Brusa NLG5 Errors/Warnings
%%
%%
...
%%
  ...
  msg.name                    = 'NLG5 Errors/Warnings';
  msg.description             = 'NLG5 Errors/Warnings';
  msg.protocol                = 'Brusa';
  msg.module                  = 'NLG5->VCU';
  msg.channel                 = 1;
  ...
  msg.fields{2}.name          = 'MainsOvrVlt2';
  ...
  msg.fields{3}.name          = 'MainsOvrVlt1';
  ...
  msg.fields{4}.name          = 'PwrStgShrtCkt';
  ...
  msg.fields{5}.name          = 'PlsbltyOutptVltMeas';
  ...
  msg.fields{6}.name          = 'PlsbltyMainsVltMeas';
  ...
  msg.fields{7}.name          = 'OutptFuseDefect';
  ...
  msg.fields{8}.name          = 'MainsFuseDefect';
  ...
  msg.fields{9}.name          = 'BattPolarity';
  ...
  msg.fields{10}.name          = 'TempSensCap';
  ...
  msg.fields{11}.name          = 'TempSensPwrStg';
  ...
  msg.fields{12}.name          = 'TempSensDiode';
  msg.fields{12}.units         = 'bool';
  msg.fields{12}.start_bit     = 52;
  ...
  msg.fields{13}.name          = 'TempSensXfrmr';
  msg.fields{13}.units         = 'bool';
  msg.fields{13}.start_bit     = 51;
  ...
  msg.fields{14}.name          = 'TempSensExt1';
  msg.fields{14}.units         = 'bool';
  msg.fields{14}.start_bit     = 50;
  ...
  msg.fields{15}.name          = 'TempSensExt2';
  msg.fields{15}.units         = 'bool';
  msg.fields{15}.start_bit     = 49;
  ...
  msg.fields{16}.name          = 'TempSensExt3';
  msg.fields{16}.units         = 'bool';
  msg.fields{16}.start_bit     = 48;
  ...
  msg.fields{17}.name          = 'FlashChksmFail';
  msg.fields{17}.units         = 'bool';
  msg.fields{17}.start_bit     = 47;
  ...
  msg.fields{18}.name          = 'NVSRAMChksmFail';
  msg.fields{18}.units         = 'bool';
  msg.fields{18}.start_bit     = 46;
  ...
  msg.fields{19}.name          = 'EEPROMSysChksmFail';
  ...
  msg.fields{20}.name          = 'EEPROMPOWChksmFail';
  msg.fields{20}.units         = 'bool';
  msg.fields{20}.start_bit     = 44;
  ...
  msg.fields{21}.name          = 'WatchdogInternal';
  msg.fields{21}.units         = 'bool';
  msg.fields{21}.start_bit     = 43;
  ...
  msg.fields{22}.name          = 'Initialization';
  msg.fields{22}.units         = 'bool';
  msg.fields{22}.start_bit     = 42;
  ...
  msg.fields{23}.name          = 'CANTimeout';
  msg.fields{23}.units         = 'bool';
  msg.fields{23}.start_bit     = 41;
  ...
  msg.fields{24}.name          = 'CANOff';
  msg.fields{24}.units         = 'bool';
  msg.fields{24}.start_bit     = 40;
  ...
  msg.fields{25}.name          = 'CAN_Xmit';
  msg.fields{25}.units         = 'bool';
  msg.fields{25}.start_bit     = 39;
  ...
  msg.fields{26}.name          = 'CAN_Rcv';
  msg.fields{26}.units         = 'bool';
  msg.fields{26}.start_bit     = 38;
  ...
  msg.fields{27}.name          = 'ShtdwnThrsBattTemp';
  msg.fields{27}.units         = 'bool';
  msg.fields{27}.start_bit     = 37;
  ...
  msg.fields{28}.name          = 'ShtdwnThresBattVlt';
  msg.fields{28}.units         = 'bool';
  msg.fields{28}.start_bit     = 36;
  ...
  msg.fields{29}.name          = 'ShtdwnThresBattAhrs';
  msg.fields{29}.units         = 'bool';
  msg.fields{29}.start_bit     = 35;
  ...
  msg.fields{30}.name          = 'ShtdwnThresChrgTime';
  msg.fields{30}.units         = 'bool';
  msg.fields{30}.start_bit     = 34;
  ...
  msg.fields{31}.name          = 'PwrLimByLowMainsVlt';
  msg.fields{31}.units         = 'bool';
  msg.fields{31}.start_bit     = 31;
  ...
  msg.fields{32}.name          = 'PwrLimByLowBattVlt';
  msg.fields{32}.units         = 'bool';
  msg.fields{32}.start_bit     = 30;
  ...
  msg.fields{33}.name          = 'PwrLimByIntOvrTemp';
  msg.fields{33}.units         = 'bool';
  msg.fields{33}.start_bit     = 29;
  ...
  msg.fields{34}.name          = 'CmdValOutRange';
  msg.fields{34}.units         = 'bool';
  msg.fields{34}.start_bit     = 28;
