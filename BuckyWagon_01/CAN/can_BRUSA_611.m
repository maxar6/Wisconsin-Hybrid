function msg = can_BRUSA_611()
%% Brusa NLG5 Actual Values 1
%%
%%
...
%%
  ...
  msg.name                    = 'NLG5 Actual Values 1';
  msg.description             = 'NLG5 Actual Values 1';
  msg.protocol                = 'Brusa';
  msg.module                  = 'NLG5->VCU';
  msg.channel                 = 1;
  ...
  msg.fields{1}.name          = 'MainsActCrnt';
  ...
  msg.fields{4}.name          = 'OutptActCrnt';
