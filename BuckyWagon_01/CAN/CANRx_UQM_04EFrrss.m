function msg = CANRx_UQM_04EFrrss()
...
%%
  ...
  msg.name                    = 'Accurate_Feedback_Message';
  msg.description             = '';
  msg.protocol                = '';
  msg.module                  = 'Inverter';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Accurate_Torque';
  msg.fields{1}.units         = 'Nm';
  ...
  msg.fields{1}.offset        = -3212.8;

  msg.fields{2}.name          = 'Accurate_Voltage';
  msg.fields{2}.units         = 'Volts';
  ...
  msg.fields{2}.offset        = -3212.8;
  
  msg.fields{3}.name          = 'Accurate_Current';
  msg.fields{3}.units         = 'Amperes';
  ...
  msg.fields{3}.offset        = -3212.8;
  
  msg.fields{4}.name          = 'Accurate_Speed';
