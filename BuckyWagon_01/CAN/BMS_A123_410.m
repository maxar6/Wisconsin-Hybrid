...
%%
  ...
  msg.name                    = 'BCM Status';
  msg.description             = 'Status from BCM';
  msg.protocol                = 'A123';
  msg.module                  = 'A123';
  msg.bus_name                = 'CAN_2';
  ...
  msg.fields{field_ctr}.name          = 'bcm_alarm';
  msg.fields{field_ctr}.units         = 'enum';
  msg.fields{field_ctr}.start_bit     = 54;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_cpwr_cmd';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_cpwr_mon';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_epo';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_gfd';
  msg.fields{field_ctr}.units         = 'kOhm';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_hvil_mon';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_ibat';
  msg.fields{field_ctr}.units         = 'A';
  msg.fields{field_ctr}.start_bit     = 16;
  msg.fields{field_ctr}.bit_length    = 16;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 0.025;
  msg.fields{field_ctr}.offset        = -1000;
  
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_mainc_stat';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 60;
  msg.fields{field_ctr}.bit_length    = 2;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_ready';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_soc';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_vbat';
  msg.fields{field_ctr}.units         = '';
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_chg_done';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 12;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_chgc_stat';
  msg.fields{field_ctr}.units         = 'enum';
  msg.fields{field_ctr}.start_bit     = 62;
  msg.fields{field_ctr}.bit_length    = 2;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
  ...
  field_ctr = field_ctr + 1;
  msg.fields{field_ctr}.name          = 'bcm_cool_req';
  msg.fields{field_ctr}.units         = '';
  msg.fields{field_ctr}.start_bit     = 13;
  msg.fields{field_ctr}.bit_length    = 1;
  msg.fields{field_ctr}.byte_order    = 'BIG_ENDIAN';
  msg.fields{field_ctr}.data_type     = 'UNSIGNED';
  msg.fields{field_ctr}.scale         = 1;
