/*
 * Trigger_FGND_20XRTI_PERIODIC_4086p0002.c
 *
...
void Trigger_FGND_20XRTI_PERIODIC_4086p0002(void)
{
  if (BuckyWagon_01_DWork.s2_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S2>/Gauges' */
    {
       ...
       */
      if ((VDO_Gauge_StartupDelay_DataStore()) >= BuckyWagon_01_B.s395_Sum) {
      ...
      rtb_Temperature = !BuckyWagon_01_B.s254_RelationalOperator;
       ...
       */
      BuckyWagon_01_B.s10_Product = (uint8_T)(BuckyWagon_01_B.s265_Merge ?
      ...
      if (IsFaultActive(11)) {
        ...
        rtb_Temperature = !BuckyWagon_01_B.s265_Merge;
      }
       ...
       *  Gain: '<S10>/Gain'
       */
      u = 100.0 * BuckyWagon_01_B.s396_Merge;
       ...
       *  Gain: '<S10>/Gain2'
       */
      u = 100.0 * BuckyWagon_01_B.s383_Merge;
       ...
       *  Gain: '<S10>/Gain1'
       */
      u = 10.0 * BuckyWagon_01_B.s268_Merge;
