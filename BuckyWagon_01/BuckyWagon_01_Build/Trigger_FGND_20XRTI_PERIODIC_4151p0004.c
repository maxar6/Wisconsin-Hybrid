/*
 * Trigger_FGND_20XRTI_PERIODIC_4151p0004.c
 *
...
void Trigger_FGND_20XRTI_PERIODIC_4151p0004(void)
{
  if (BuckyWagon_01_DWork.s2_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S2>/Gauges' */
    {
      ...
      boolean_T rtb_motohawk_fault_statuses[30];
       ...
       */
      if ((VDO_Gauge_StartupDelay_DataStore()) >= BuckyWagon_01_B.s360_Sum) {
      ...
      rtb_Temperature = !BuckyWagon_01_B.s229_RelationalOperator;
       ...
       */
      BuckyWagon_01_B.s10_Product = (uint8_T)(BuckyWagon_01_B.s240_Merge ?
      ...
      if (IsFaultActive(10)) {
        ...
        rtb_Temperature = !BuckyWagon_01_B.s240_Merge;
      }
      ...
      {
        extern boolean_T IsFaultActive(uint32_T fault);
        rtb_Temperature = IsFaultActive(15);
      }
       ...
       *  Gain: '<S10>/Gain'
       */
      u = 100.0 * BuckyWagon_01_B.s235_Abs;
       ...
       *  Gain: '<S10>/Gain2'
       */
      u = 100.0 * BuckyWagon_01_B.s348_Merge;
       ...
       *  Gain: '<S10>/Gain1'
       */
      u = 10.0 * BuckyWagon_01_B.s243_Merge;
