/*
 * Trigger_CAN_Slot_miniview_button_up_2659p0004.c
 *
...
void Trigger_CAN_Slot_miniview_button_up_2659p0004(void)
{
  /* Output and update for function-call system: '<S221>/Subsystem' */

  /* S-Function (motohawk_sfun_read_canmsg): '<S247>/Read CAN Message' */
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s247_upasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s247_upcount = (uint8_T) tmp1;
    }
  }
}
