/*
 * Trigger_CAN_Slot_miniview_button_up_2724p0004.c
 *
...
void Trigger_CAN_Slot_miniview_button_up_2724p0004(void)
{
  /* Output and update for function-call system: '<S197>/Subsystem' */
  ...
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s223_upasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s223_upcount = (uint8_T) tmp1;
    }
  }
}
