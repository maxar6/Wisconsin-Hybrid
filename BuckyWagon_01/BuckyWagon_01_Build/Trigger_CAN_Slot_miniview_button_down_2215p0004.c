/*
 * Trigger_CAN_Slot_miniview_button_down_2215p0004.c
 *
...
void Trigger_CAN_Slot_miniview_button_down_2215p0004(void)
{
  /* Output and update for function-call system: '<S178>/Subsystem' */
  ...
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s199_downasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s199_downcount = (uint8_T) tmp1;
    }
  }
}
