...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_10899p0006 = { 0 };

static boolean_T MHCAN_handler_RxSlot_10899p0006(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000410) {
...

    {
      ...
      new_message = !MHCAN_directslot_RxSlot_10899p0006.ready;
      MHCAN_directslot_RxSlot_10899p0006.message = *messageObj;
      MHCAN_directslot_RxSlot_10899p0006.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_10901p0005 = { 0 };

static boolean_T MHCAN_handler_RxSlot_10901p0005(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000430) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_10901p0005.ready;
      MHCAN_directslot_RxSlot_10901p0005.message = *messageObj;
      MHCAN_directslot_RxSlot_10901p0005.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_10900p0007 = { 0 };

static boolean_T MHCAN_handler_RxSlot_10900p0007(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000420) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_10900p0007.ready;
      MHCAN_directslot_RxSlot_10900p0007.message = *messageObj;
      MHCAN_directslot_RxSlot_10900p0007.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x000007FF[] = {
  { 0x00000410, MHCAN_handler_RxSlot_10899p0006 },

  { 0x00000430, MHCAN_handler_RxSlot_10901p0005 },

  { 0x00000420, MHCAN_handler_RxSlot_10900p0007 },
};
