...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_2300p0012 = { 0 };

static boolean_T MHCAN_handler_RxSlot_2300p0012(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000410) {
...

    {
      ...
      new_message = !MHCAN_directslot_RxSlot_2300p0012.ready;
      MHCAN_directslot_RxSlot_2300p0012.message = *messageObj;
      MHCAN_directslot_RxSlot_2300p0012.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_2302p0011 = { 0 };

static boolean_T MHCAN_handler_RxSlot_2302p0011(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000430) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_2302p0011.ready;
      MHCAN_directslot_RxSlot_2302p0011.message = *messageObj;
      MHCAN_directslot_RxSlot_2302p0011.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_2301p0011 = { 0 };

static boolean_T MHCAN_handler_RxSlot_2301p0011(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000420) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_2301p0011.ready;
      MHCAN_directslot_RxSlot_2301p0011.message = *messageObj;
      MHCAN_directslot_RxSlot_2301p0011.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x000007FF[] = {
  { 0x00000410, MHCAN_handler_RxSlot_2300p0012 },

  { 0x00000430, MHCAN_handler_RxSlot_2302p0011 },

  { 0x00000420, MHCAN_handler_RxSlot_2301p0011 },
};
