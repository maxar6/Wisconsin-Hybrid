...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_2909p0005 = { 0 };

static boolean_T MHCAN_handler_RxSlot_2909p0005(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000410) {
...

    {
      ...
      new_message = !MHCAN_directslot_RxSlot_2909p0005.ready;
      MHCAN_directslot_RxSlot_2909p0005.message = *messageObj;
      MHCAN_directslot_RxSlot_2909p0005.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_2911p0004 = { 0 };

static boolean_T MHCAN_handler_RxSlot_2911p0004(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000430) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_2911p0004.ready;
      MHCAN_directslot_RxSlot_2911p0004.message = *messageObj;
      MHCAN_directslot_RxSlot_2911p0004.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_2910p0004 = { 0 };

static boolean_T MHCAN_handler_RxSlot_2910p0004(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000420) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_2910p0004.ready;
      MHCAN_directslot_RxSlot_2910p0004.message = *messageObj;
      MHCAN_directslot_RxSlot_2910p0004.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x000007FF[] = {
  { 0x00000410, MHCAN_handler_RxSlot_2909p0005 },

  { 0x00000430, MHCAN_handler_RxSlot_2911p0004 },

  { 0x00000420, MHCAN_handler_RxSlot_2910p0004 },
};
