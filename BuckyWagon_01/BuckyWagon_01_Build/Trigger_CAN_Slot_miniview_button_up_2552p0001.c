/*
 * Trigger_CAN_Slot_miniview_button_up_2552p0001.c
 *
...
void Trigger_CAN_Slot_miniview_button_up_2552p0001(void)
{
  /* Output and update for function-call system: '<S218>/Subsystem' */

  /* S-Function (motohawk_sfun_read_canmsg): '<S244>/Read CAN Message' */
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s244_upasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s244_upcount = (uint8_T) tmp1;
    }
  }
}
