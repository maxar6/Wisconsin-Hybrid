/*
 * Trigger_CAN_Slot_miniview_button_menu_2408p0001.c
 *
...
void Trigger_CAN_Slot_miniview_button_menu_2408p0001(void)
{
  /* Output and update for function-call system: '<S217>/Subsystem' */

  /* S-Function (motohawk_sfun_read_canmsg): '<S232>/Read CAN Message' */
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s232_menuasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s232_menucount = (uint8_T) tmp1;
    }
  }
}
