/*
 * Trigger_CAN_Slot_miniview_button_down_10204p0002.c
 *
...
void Trigger_CAN_Slot_miniview_button_down_10204p0002(void)
{
  /* Output and update for function-call system: '<S166>/Subsystem' */
  ...
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s187_downasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s187_downcount = (uint8_T) tmp1;
    }
  }
}
