/*
 * Trigger_CAN_Slot_miniview_button_up_2115p0011.c
 *
...
void Trigger_CAN_Slot_miniview_button_up_2115p0011(void)
{
  /* Output and update for function-call system: '<S183>/Subsystem' */

  /* S-Function (motohawk_sfun_read_canmsg): '<S209>/Read CAN Message' */
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s209_upasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s209_upcount = (uint8_T) tmp1;
    }
  }
}
