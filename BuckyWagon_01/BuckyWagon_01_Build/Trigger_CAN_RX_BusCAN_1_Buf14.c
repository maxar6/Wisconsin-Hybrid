...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_3446p0001 = { 0 };

static boolean_T MHCAN_handler_RxSlot_3446p0001(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x18FF0320) {
...

    {
      ...
      new_message = !MHCAN_directslot_RxSlot_3446p0001.ready;
      MHCAN_directslot_RxSlot_3446p0001.message = *messageObj;
      MHCAN_directslot_RxSlot_3446p0001.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x1FFFFFFF[] = {
  { 0x18ff0320, MHCAN_handler_RxSlot_3446p0001 },
};
