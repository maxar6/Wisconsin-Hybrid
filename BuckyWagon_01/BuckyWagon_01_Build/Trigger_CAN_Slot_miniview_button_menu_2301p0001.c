/*
 * Trigger_CAN_Slot_miniview_button_menu_2301p0001.c
 *
...
void Trigger_CAN_Slot_miniview_button_menu_2301p0001(void)
{
  /* Output and update for function-call system: '<S214>/Subsystem' */

  /* S-Function (motohawk_sfun_read_canmsg): '<S229>/Read CAN Message' */
  /* MotoHawk Read CAN Message */
  {
    ...
    if (msg_valid) {
      ...
      BuckyWagon_01_B.s229_menuasserted = (boolean_T) tmp0;
      BuckyWagon_01_B.s229_menucount = (uint8_T) tmp1;
    }
  }
}
