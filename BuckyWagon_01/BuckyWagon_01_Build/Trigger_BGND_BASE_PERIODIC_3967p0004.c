/*
 * Trigger_BGND_BASE_PERIODIC_3967p0004.c
 *
...
void Trigger_BGND_BASE_PERIODIC_3967p0004(void)
{
  {
    /* Output and update for function-call system: '<S4>/Background' */
    {
      ...
      /* S-Function Block: DOut3919p0004 */
      {
        DOut3919p0004_DiscreteOutput_Set(rtb_Merge);
      }
