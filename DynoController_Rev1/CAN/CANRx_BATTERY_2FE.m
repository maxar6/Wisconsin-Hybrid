function msg = CANRx_BATTERY_2FE()
...
%%
  ...
  msg.name                    = 'DetailPackInformation';
  msg.description             = 'Battery Detailed Pack Info';
  msg.protocol                = '';
  msg.module                  = 'Battery';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'MaxCellVoltage';
  ...
  msg.fields{1}.scale         = 0.001;
  msg.fields{1}.offset        = 0;

  msg.fields{2}.name          = 'MinCellVoltage';
  ...
  msg.fields{3}.name          = 'MaxCellTemperature';
  ...
  msg.fields{4}.name          = 'MinCellTemperature';
  ...
  msg.fields{5}.name          = 'CoolantTemperature';
  ...
  msg.fields{5}.offset        = -40;

  msg.fields{6}.name          = 'DPI_RollingCounter';
