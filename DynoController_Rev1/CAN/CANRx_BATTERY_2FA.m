function msg = CANRx_BATTERY_2FA()
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'JCS_PackIdentifier';
  msg.fields{1}.units         = '';
  ...
  msg.fields{3}.name          = 'PrechargeState';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 52;
  msg.fields{3}.bit_length    = 3;
  msg.fields{3}.byte_order    = 'BIG_ENDIAN';
  msg.fields{3}.data_type     = 'UNSIGNED';
  msg.fields{3}.scale         = 1;
  msg.fields{3}.offset        = 0;

  msg.fields{4}.name          = 'HVIL_Status';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'IsolationStatus';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 42;
  ...
  msg.fields{6}.name          = 'WakeSignal';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 44;
  ...
  msg.fields{7}.name          = 'SleepInhibited';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 46;
  ...
  msg.fields{8}.name          = 'CellBalanceingActive';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 32;
  ...
  msg.fields{9}.name          = 'MILState';
  msg.fields{9}.units         = '';
  msg.fields{9}.start_bit     = 34;
