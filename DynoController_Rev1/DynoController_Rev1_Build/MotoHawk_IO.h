...
extern NativeError_S DOut736p0002_DiscreteOutput_Set(boolean_T in);
extern NativeError_S DOut736p0002_DiscreteOutputPushPull_Set(int8_T in);
extern NativeError_S DOut736p0002_DiscreteOutput_Create(void);
...
extern NativeError_S DOut336p001_DiscreteOutput_Set(boolean_T in);
extern NativeError_S DOut336p001_DiscreteOutputPushPull_Set(int8_T in);
extern NativeError_S DOut336p001_DiscreteOutput_Create(void);

/* S-Function Block: <S75>/motohawk_dout5 Resource: FUELP */
extern NativeError_S DOut337p001_DiscreteOutput_Set(boolean_T in);
extern NativeError_S DOut337p001_DiscreteOutputPushPull_Set(int8_T in);
extern NativeError_S DOut337p001_DiscreteOutput_Create(void);
...
extern NativeError_S DOut338p001_DiscreteOutput_Set(boolean_T in);
extern NativeError_S DOut338p001_DiscreteOutputPushPull_Set(int8_T in);
extern NativeError_S DOut338p001_DiscreteOutput_Create(void);

/* S-Function Block: <S75>/motohawk_dout7 Resource: LIAC */
extern NativeError_S DOut339p001_DiscreteOutput_Set(boolean_T in);
extern NativeError_S DOut339p001_DiscreteOutputPushPull_Set(int8_T in);
extern NativeError_S DOut339p001_DiscreteOutput_Create(void);
