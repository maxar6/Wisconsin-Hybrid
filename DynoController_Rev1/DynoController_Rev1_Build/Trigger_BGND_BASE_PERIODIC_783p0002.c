/*
 * Trigger_BGND_BASE_PERIODIC_783p0002.c
 *
...
void Trigger_BGND_BASE_PERIODIC_783p0002(void)
{
  {
    /* Output and update for function-call system: '<S2>/Background' */
    {
      ...
      /* S-Function Block: DOut736p0002 */
      {
        DOut736p0002_DiscreteOutput_Set(rtb_Merge);
      }
