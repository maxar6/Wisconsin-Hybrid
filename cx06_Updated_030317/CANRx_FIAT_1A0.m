...
%%
  ...
  msg.name                    = 'FIAT Engine Idle Spd Info';
  msg.description             = 'ID1A0 FIAT Engine Idle Speed Info';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Eng_Idle_Spd_V';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Eng_Idle_Spd';
  ...
  msg.fields{3}.name          = 'Base_Target_Eng_Idle_Spd';
  ...
  msg.fields{3}.scale         = 8;
  msg.fields{3}.offset        = 0;

  msg.fields{4}.name          = 'Eng_Airflow_Backup_Mode';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 30;
  ...
  msg.fields{5}.name          = 'Eng_Throt_Control_Operat';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'Eng_Crankshaft_Backup_Mode';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 24;
  ...
  msg.fields{7}.name          = 'Eng_Allowed_Clutch_Adapt';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 23;
