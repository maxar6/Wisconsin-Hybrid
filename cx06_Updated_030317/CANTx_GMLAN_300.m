...
%%
  ...
  msg.name                    = 'Engine Status 1';
  msg.description             = 'GMLAN 300';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Limp_Home';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 59;
  ...
  msg.fields{3}.name          = 'Eng_Run_Sts';
  msg.fields{3}.units         = 'ENM';
  ...
  msg.fields{4}.name          = 'Oil_Pres_Low';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 45;
  ...
  msg.fields{5}.name          = 'Svc_Eng_Non_Emis';
  msg.fields{5}.units         = 'ENM';
  msg.fields{5}.start_bit     = 22;
  ...
  msg.fields{7}.name          = 'Brake_Pdl_Sw1';
  msg.fields{7}.units         = '';
  ...
  msg.fields{8}.name          = 'Brake_Pdl_Sw2';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 21;
