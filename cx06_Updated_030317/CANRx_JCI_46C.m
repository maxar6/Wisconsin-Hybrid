...
%%
  ...
  msg.name                    = 'BMS Protection';
  msg.description             = 'BMS 46C';
  msg.protocol                = '';
  msg.module                  = 'BMS';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Alm_OverTemp';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Alm_UnderTemp';
  msg.fields{2}.units         = '';
  ...
  msg.fields{5}.name          = 'Alm_Over_I_chg';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'Alm_Over_I_dis';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 50;
  ...
  msg.fields{7}.name          = 'Alm_Defective_Ch';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 52;
  ...
  msg.fields{8}.name          = 'Alm_Timeout_Ref_Msg';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 54;
  ...
  msg.fields{9}.name          = 'Alm_Chg_Mode_Fail';
  msg.fields{9}.units         = '';
  msg.fields{9}.start_bit     = 40;
  ...
  msg.fields{10}.name          = 'Trp_OverTemp';
  msg.fields{10}.units         = '';
  msg.fields{10}.start_bit     = 24;
  ...
  msg.fields{11}.name          = 'Trp_UnderTemp';
  msg.fields{11}.units         = '';
  msg.fields{11}.start_bit     = 26;
  ...
  msg.fields{12}.name          = 'Trp_Over_V';
  msg.fields{12}.units         = '';
  msg.fields{12}.start_bit     = 28;
  ...
  msg.fields{13}.name          = 'Trp_Under_V';
  msg.fields{13}.units         = '';
  msg.fields{13}.start_bit     = 30;
  ...
  msg.fields{14}.name          = 'Trp_Over_I_chg';
  msg.fields{14}.units         = '';
  msg.fields{14}.start_bit     = 16;
  ...
  msg.fields{15}.name          = 'Trp_Over_I_dis';
  msg.fields{15}.units         = '';
  msg.fields{15}.start_bit     = 18;
  ...
  msg.fields{16}.name          = 'Trp_Defective_Ch';
  msg.fields{16}.units         = '';
  msg.fields{16}.start_bit     = 20;
  ...
  msg.fields{17}.name          = 'Trp_Timeout_Ref_Msg';
  msg.fields{17}.units         = '';
  msg.fields{17}.start_bit     = 22;
  ...
  msg.fields{18}.name          = 'Trp_Chg_Mode_Fail';
  msg.fields{18}.units         = '';
  msg.fields{18}.start_bit     = 8;
  ...
  msg.fields{19}.name          = 'Protective_Count_Down';
  msg.fields{19}.units         = '';
  msg.fields{19}.start_bit     = 0;
  msg.fields{19}.bit_length    = 8;
