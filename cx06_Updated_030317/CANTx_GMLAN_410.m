...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Roll_Cnt_Rst';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 61;
