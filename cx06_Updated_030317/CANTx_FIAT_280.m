...
%%
  ...
  msg.name                    = 'FIAT Engine Wheel Speed';
  msg.description             = 'ID280 FIAT Engine Wheel Speed';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Wheel_Ang_Vel_FL_V';
  msg.fields{1}.units         = '';
  ...
  msg.fields{8}.name          = 'Wheel_Ang_Vel_RR';
  msg.fields{8}.units         = 'rpm';
  msg.fields{8}.start_bit     = 0;
  msg.fields{8}.bit_length    = 15;
  msg.fields{8}.byte_order    = 'BIG_ENDIAN';
  msg.fields{8}.data_type     = 'SIGNED';
  msg.fields{8}.scale         = 0.25;
