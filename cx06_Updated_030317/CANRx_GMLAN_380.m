...
%%
  ...
  msg.name                    = 'General Satus';
  msg.description             = 'GMLAN380';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'AC_Clutch_Req';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'System_Power_Mode';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'RunCrank_Status';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 51;
  ...
  msg.fields{4}.name          = 'Acc_Status';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 52;
