...
%%
  ...
  msg.name                    = 'IPT DCDC Cmd';
  msg.description             = 'ID318 DCDC Command';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
