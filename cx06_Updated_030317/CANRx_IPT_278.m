...
%%
  ...
  msg.name                    = 'IPT Status 1';
  msg.description             = 'ID278 IPT Status 1';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Derated Operation';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 57;
  ...
  msg.fields{3}.name          = 'E-Drive System Error';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 58;
  ...
  msg.fields{4}.name          = 'Emergency Shutdown';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 59;
  ...
  msg.fields{5}.name          = 'Over Current IGBT Error';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 60;
  ...
  msg.fields{6}.name          = 'Lube(Anal) Error';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 61;
  ...
  msg.fields{7}.name          = 'Encoder Error';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 62;
  ...
  msg.fields{8}.name          = 'OverVoltage Error';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 63;
  ...
  msg.fields{9}.name          = 'UnderVoltage Error';
  msg.fields{9}.units         = '';
  msg.fields{9}.start_bit     = 48;
  ...
  msg.fields{10}.name          = 'OverCurrent-AC Error';
  msg.fields{10}.units         = '';
  msg.fields{10}.start_bit     = 49;
  ...
  msg.fields{11}.name          = 'Motor OverTemp';
  msg.fields{11}.units         = '';
  msg.fields{11}.start_bit     = 50;
  ...
  msg.fields{12}.name          = 'Inverter OverTemp';
  msg.fields{12}.units         = '';
  ...
  msg.fields{13}.name          = 'OverSpeed Error';
  msg.fields{13}.units         = '';
  msg.fields{13}.start_bit     = 52;
  ...
  msg.fields{14}.name          = 'CAN Error';
  msg.fields{14}.units         = '';
  msg.fields{14}.start_bit     = 53;
  ...
  msg.fields{15}.name          = 'Unreasonable Limits';
  msg.fields{15}.units         = '';
  msg.fields{15}.start_bit     = 54;
  ...
  msg.fields{16}.name          = 'EPO Line Error';
  msg.fields{16}.units         = '';
  msg.fields{16}.start_bit     = 55;
  ...
  msg.fields{17}.name          = 'Sensor Out Of Range';
  msg.fields{17}.units         = '';
  ...
  msg.fields{18}.name          = 'Voltage Limitation active';
  msg.fields{18}.units         = '';
  msg.fields{18}.start_bit     = 44;
  ...
  msg.fields{19}.name          = 'Current Limitiation active';
  msg.fields{19}.units         = '';
  msg.fields{19}.start_bit     = 45;
  ...
  msg.fields{20}.name          = 'Pull Out Torque Protection active';
  msg.fields{20}.units         = '';
  msg.fields{20}.start_bit     = 46;
  ...
  msg.fields{21}.name          = 'Peak Level Overflow';
  msg.fields{21}.units         = '';
  msg.fields{21}.start_bit     = 47;
  ...
  msg.fields{22}.name          = 'Parity bit phase current';
  msg.fields{22}.units         = '';
  msg.fields{22}.start_bit     = 48;
  ...
  msg.fields{23}.name          = 'Phase Current Peak-Value';
  msg.fields{23}.units         = 'Amps';
  msg.fields{23}.start_bit     = 24;
  msg.fields{23}.bit_length    = 10;
  msg.fields{23}.byte_order    = 'BIG_ENDIAN';
  msg.fields{23}.data_type     = 'UNSIGNED';
  msg.fields{23}.scale         = 1;
  msg.fields{23}.offset        = 0;
  
  msg.fields{24}.name          = 'Max Torque available';
  msg.fields{24}.units         = '';
  msg.fields{24}.start_bit     = 16;
  msg.fields{24}.bit_length    = 8;
  msg.fields{24}.byte_order    = 'BIG_ENDIAN';
  msg.fields{24}.data_type     = 'UNSIGNED';
  msg.fields{24}.scale         = 1;
  msg.fields{24}.offset        = 0;
  
  msg.fields{25}.name          = 'MCU Ready to Go';
  msg.fields{25}.units         = '';
  msg.fields{25}.start_bit     = 8;
  ...
  msg.fields{26}.name          = 'MCU Hardware/Software Error';
  msg.fields{26}.units         = '';
  msg.fields{26}.start_bit     = 9;
  ...
  msg.fields{27}.name          = 'MCU Speed Error Track Missing';
  msg.fields{27}.units         = '';
  msg.fields{27}.start_bit     = 10;
  ...
  msg.fields{28}.name          = 'MCU Speed Error Speed Jump';
  msg.fields{28}.units         = '';
  msg.fields{28}.start_bit     = 11;
  ...
  msg.fields{29}.name          = 'Error in Error Store';
  msg.fields{29}.units         = '';
  ...
  msg.fields{30}.name          = 'Supply Line Low Error';
  msg.fields{30}.units         = '';
  msg.fields{30}.start_bit     = 5;
  ...
  msg.fields{31}.name          = 'MCU On';
  msg.fields{31}.units         = '';
  msg.fields{31}.start_bit     = 6;
