...
%%
  ...
  msg.name                    = 'Debug Data 1';
  msg.description             = 'General Control Code Variables';
  msg.protocol                = '';
  msg.module                  = 'DEBUG';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{5}.name          = 'Neutral';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 1;
  ...
  msg.fields{6}.name          = 'Reverse';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 2;
  ...
  msg.fields{8}.name          = 'Rear_Slip?';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 4;
  ...
  msg.fields{9}.name          = 'TC_Active';
  msg.fields{9}.units         = '';
  msg.fields{9}.start_bit     = 5;
