...
%%
  ...
  msg.name                    = 'Wheel Speed';
  msg.description             = 'GMLAN280';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'FL_Wheel_Vel';
  msg.fields{1}.units         = 'rpm';
  msg.fields{1}.start_bit     = 48;
  msg.fields{1}.bit_length    = 15;
  msg.fields{1}.byte_order    = 'BIG_ENDIAN';
  msg.fields{1}.data_type     = 'SIGNED';
  msg.fields{1}.scale         = 0.25;
  msg.fields{1}.offset        = 0;

  msg.fields{2}.name          = 'FL_Wheel_Valid';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 63;
  ...
  msg.fields{3}.name          = 'FR_Wheel_Vel';
  msg.fields{3}.units         = 'rpm';
  msg.fields{3}.start_bit     = 32;
  msg.fields{3}.bit_length    = 15;
  msg.fields{3}.byte_order    = 'BIG_ENDIAN';
  msg.fields{3}.data_type     = 'SIGNED';
  msg.fields{3}.scale         = 0.25;
  msg.fields{3}.offset        = 0;
  
  msg.fields{4}.name          = 'FR_Wheel_Valid';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 47;
  ...
  msg.fields{5}.name          = 'RL_Wheel_Vel';
  msg.fields{5}.units         = 'rpm';
  msg.fields{5}.start_bit     = 16;
  msg.fields{5}.bit_length    = 15;
  msg.fields{5}.byte_order    = 'BIG_ENDIAN';
  msg.fields{5}.data_type     = 'SIGNED';
  msg.fields{5}.scale         = 0.25;
  msg.fields{5}.offset        = 0;

  msg.fields{6}.name          = 'RL_Wheel_Valid';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 31;
  ...
  msg.fields{7}.name          = 'RR_Wheel_Vel';
  msg.fields{7}.units         = 'rpm';
  msg.fields{7}.start_bit     = 0;
  msg.fields{7}.bit_length    = 15;
  msg.fields{7}.byte_order    = 'BIG_ENDIAN';
  msg.fields{7}.data_type     = 'SIGNED';
  msg.fields{7}.scale         = 0.25;
  msg.fields{7}.offset        = 0;

  msg.fields{8}.name          = 'RR_Wheel_Valid';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 15;
