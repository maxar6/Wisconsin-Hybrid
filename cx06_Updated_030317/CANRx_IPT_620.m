...
%%
  ...
  msg.name                    = 'IPT DCDC Status';
  msg.description             = 'ID620 DCDC Status';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'LV_Voltage';
  msg.fields{2}.units         = 'V';
  ...
  msg.fields{3}.name          = 'HV_DCDC_Current';
  msg.fields{3}.units         = 'A';
  ...
  msg.fields{3}.offset        = -15;
  
  msg.fields{4}.name          = 'DCDC_GenError';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'DCDC_HV_Over_I';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 25;
  ...
  msg.fields{6}.name          = 'DCDC_HV_Over_V';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 26;
  ...
  msg.fields{7}.name          = 'DCDC_LV_Over_I_Buck';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 27;
  ...
  msg.fields{8}.name          = 'DCDC_LV_Under_V';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 28;
  ...
  msg.fields{9}.name          = 'DCDC_LV_Over_V';
  msg.fields{9}.units         = '';
  msg.fields{9}.start_bit     = 29;
  ...
  msg.fields{10}.name          = 'DCDC_LV_Over_I_Boost';
  msg.fields{10}.units         = '';
  msg.fields{10}.start_bit     = 30;
  ...
  msg.fields{11}.name          = 'DCDC_Temp_Reduction';
  msg.fields{11}.units         = '';
  msg.fields{11}.start_bit     = 31;
  ...
  msg.fields{12}.name          = 'DCDC_Buck';
  msg.fields{12}.units         = '';
  msg.fields{12}.start_bit     = 17;
  ...
  msg.fields{13}.name          = 'DCDC_Boost';
  msg.fields{13}.units         = '';
  msg.fields{13}.start_bit     = 18;
  ...
  msg.fields{14}.name          = 'DCDC_Reduce_Buck';
  msg.fields{14}.units         = '';
  msg.fields{14}.start_bit     = 19;
  ...
  msg.fields{15}.name          = 'DCDC_Reduce_Boost';
  msg.fields{15}.units         = '';
  msg.fields{15}.start_bit     = 20;
  ...
  msg.fields{16}.name          = 'DCDC_CAN_Err';
  msg.fields{16}.units         = '';
  msg.fields{16}.start_bit     = 21;
  ...
  msg.fields{17}.name          = 'DCDC_Meas_Err';
  msg.fields{17}.units         = '';
  ...
  msg.fields{18}.name          = 'DCDC_OverTemp';
  msg.fields{18}.units         = '';
  msg.fields{18}.start_bit     = 16;
  ...
  msg.fields{19}.name          = 'DCDC_90I2t';
  msg.fields{19}.units         = '';
  msg.fields{19}.start_bit     = 8;
  ...
  msg.fields{20}.name          = 'DCDC_Break';
  msg.fields{20}.units         = '';
  msg.fields{20}.start_bit     = 9;
  ...
  msg.fields{22}.name          = 'DCDC_>0C';
  msg.fields{22}.units         = '';
  msg.fields{22}.start_bit     = 11;
  ...
  msg.fields{23}.name          = 'DCDC_HV_Under_V';
  msg.fields{23}.units         = '';
  ...
  msg.fields{24}.name          = 'DCDC_HW_Err';
  msg.fields{24}.units         = '';
  msg.fields{24}.start_bit     = 13;
  ...
  msg.fields{25}.name          = 'DCDC_Err_in_Store';
  msg.fields{25}.units         = '';
  msg.fields{25}.start_bit     = 14;
