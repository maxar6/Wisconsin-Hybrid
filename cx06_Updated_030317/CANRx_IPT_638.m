...
%%
  ...
  msg.fields{1}.name          = 'Sw_Ver';
  msg.fields{1}.units         = 'Rev';
  msg.fields{1}.start_bit     = 58;
  msg.fields{1}.bit_length    = 6;
  msg.fields{1}.byte_order    = 'BIG_ENDIAN';
  msg.fields{1}.data_type     = 'UNSIGNED';
  msg.fields{1}.scale         = 1;
  msg.fields{1}.offset        = 0;

  msg.fields{2}.name          = 'IPT_Ser_Num';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Gear_Ratio';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 43;
  msg.fields{3}.bit_length    = 5;
  msg.fields{3}.byte_order    = 'BIG_ENDIAN';
  msg.fields{3}.data_type     = 'UNSIGNED';
  msg.fields{3}.scale         = 0.1;
  msg.fields{3}.offset        = 8;
  
  msg.fields{4}.name          = 'Oil_Pressure';
  msg.fields{4}.units         = 'bar';
  msg.fields{4}.start_bit     = 37;
  msg.fields{4}.bit_length    = 6;
  msg.fields{4}.byte_order    = 'BIG_ENDIAN';
  msg.fields{4}.data_type     = 'UNSIGNED';
  msg.fields{4}.scale         = 0.1;
  msg.fields{4}.offset        = 0;
  
  msg.fields{5}.name          = 'Motor_Temp';
  msg.fields{5}.units         = 'C';
