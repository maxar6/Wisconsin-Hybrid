...
%%
  ...
  msg.name                    = 'Trans Status';
  msg.description             = 'GMLAN 320';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
