...
%%
  ...
  msg.name                    = 'Engine Spd & Pedal Pos';
  msg.description             = 'GMLAN 110';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Cruise_Active';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Engine_Speed';
