...
%%
  ...
  msg.name                    = 'Chassis General Data';
  msg.description             = 'GMLAN 2F0';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Tire_Pres_Low';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 61;
  ...
  msg.fields{2}.name          = 'VDC_Sts';
  msg.fields{2}.units         = 'ENM';
  msg.fields{2}.start_bit     = 22;
  msg.fields{2}.bit_length    = 3;
  msg.fields{2}.byte_order    = 'BIG_ENDIAN';
  msg.fields{2}.data_type     = 'UNSIGNED';
  msg.fields{2}.scale         = 1;
  msg.fields{2}.offset        = 0;
  
  msg.fields{3}.name          = 'ABS_Ide';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 25;
  ...
  msg.fields{4}.name          = 'ABS_Act';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 26;
  ...
  msg.fields{5}.name          = 'ABS_Fail';
  msg.fields{5}.units         = '';
  msg.fields{5}.start_bit     = 27;
  ...
  msg.fields{6}.name          = 'TC_Enab';
  msg.fields{6}.units         = '';
  msg.fields{6}.start_bit     = 28;
  ...
  msg.fields{7}.name          = 'TC_Act';
  msg.fields{7}.units         = '';
  msg.fields{7}.start_bit     = 29;
  ...
  msg.fields{8}.name          = 'TC_Sts';
  msg.fields{8}.units         = 'ENM';
  msg.fields{8}.start_bit     = 30;
  ...
  msg.fields{10}.name          = 'TC_Fail';
  msg.fields{10}.units         = '';
  msg.fields{10}.start_bit     = 37;
