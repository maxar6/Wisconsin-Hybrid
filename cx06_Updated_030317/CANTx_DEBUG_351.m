...
%%
  ...
  msg.name                    = 'Debug Data 2';
  msg.description             = 'Current Tracking Alg';
  msg.protocol                = '';
  msg.module                  = 'DEBUG';
  msg.channel                 = 1;
