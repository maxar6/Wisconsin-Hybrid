#ifndef __c7_cx06_MA_h__
#define __c7_cx06_MA_h__
...
typedef struct {
  ...
  uint8_T c7_is_active_c7_cx06_MA;
...
extern void c7_cx06_MA_method_dispatcher(SimStruct *S, int_T method, void *data);
