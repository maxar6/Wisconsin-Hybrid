...
void StepApplicationStartup(void)
{
  ...
  if ((ApplicationInitStatus == APP_INIT_BEFORE_MODEL) && (ApplicationPausePoint
    ...
    /* Initialize Application Model: cx06_MA */
    cx06_MA_initialize(1);
    cx06_MA_step();
...
void CheckApplicationStatus(void)
{
  ...
  if (stopApplication) {
    ...
    {
      if ((init_resource_INJ1D_DataStore()) >= 0) {
    ...
    /* Turn off discrete output */
    {
      if ((init_resource_INJ2D_DataStore()) >= 0) {
    ...
    /* Turn off discrete output */
    {
      if ((init_resource_AC_Clutch_DataStore()) >= 0) {
        SetDiscreteOutState((E_ModuleResource)
                            ((init_resource_AC_Clutch_DataStore())), RES_OFF);
      }
    }

    /* Turn off discrete output */
    {
      if ((init_resource_AC_Fan_DataStore()) >= 0) {
    ...
    /* Turn off discrete output */
    {
      if ((init_resource_Urea_Power_DataStore()) >= 0) {
        SetDiscreteOutState((E_ModuleResource)
                            ((init_resource_Urea_Power_DataStore())), RES_OFF);
      }
    }

    /* Turn off discrete output */
    {
      if ((init_resource_INJ8D_DataStore()) >= 0) {
    ...
    /* Turn off discrete output */
    {
      if ((init_resource_INJ6D_DataStore()) >= 0) {
    ...
    {
      /* Turn off PWM output */
      extern void EST6_PWMOutput_PWMOutput_Stop(void);
      EST6_PWMOutput_PWMOutput_Stop();
    }

    /* Turn off discrete output */
    {
      if ((init_resource_INJ3D_DataStore()) >= 0) {
    ...
    {
      /* Turn off PWM output */
      extern void IPT_EPO_PWMOutput_PWMOutput_Stop(void);
      IPT_EPO_PWMOutput_PWMOutput_Stop();
    }

    /* Turn off discrete output */
    {
      if ((init_resource_INJ10D_DataStore()) >= 0) {
    ...
    {
      /* Turn off PWM output */
      extern void INJ5D_PWMOutput_PWMOutput_Stop(void);
      INJ5D_PWMOutput_PWMOutput_Stop();
    }

    {
      /* Turn off PWM output */
      extern void INJ11D_PWMOutput_PWMOutput_Stop(void);
      INJ11D_PWMOutput_PWMOutput_Stop();
    }
  } else {
