...
void UpdateFault(uint32_T fault)
{
  ...
  VolFaults_DataStore_ByIndex(fault).x = (uint8_T) x;
  VolFaults_DataStore_ByIndex(fault).y = (uint8_T) y;
...
void GlobalFaultClear(void)
{
  ...
  FaultMarquees_DataStore_FaultMarquees().current_suspected_vardec = 25;
  FaultMarquees_DataStore_FaultMarquees().current_active_vardec = 25;
  FaultMarquees_DataStore_FaultMarquees().current_occurred_vardec = 25;
  VolFaultManager_DataStore_VolFaultManager().last_suspected_fault = 25;
  VolFaultManager_DataStore_VolFaultManager().last_unsuspected_fault = 25;
  VolFaultManager_DataStore_VolFaultManager().last_active_fault = 25;
  VolFaultManager_DataStore_VolFaultManager().last_inactive_fault = 25;
  VolFaultManager_DataStore_VolFaultManager().last_occurred_fault = 25;
}
...
static void UpdateActionReasonMarquee(uint32_T fault_action_index)
{
  ...
  static fault_action_marquee_state_t fault_action_marquee_state[9] = { { 0 } };
  ...
  (FaultActionReason_DataStore())[fault_action_index] = 25;
}
