  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_1_0_33;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_1_0_33 = 0;
    else
      can_tx_err_CAN_1_0_33 = (uint8_T) GetErrorCode(sErrorResult);
  }
  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_2_0_34;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_2_0_34 = 0;
    else
      can_tx_err_CAN_2_0_34 = (uint8_T) GetErrorCode(sErrorResult);
  }
