...
%%
  ...
  msg.name                    = 'FIAT Engine AC Status';
  msg.description             = 'ID348 FIAT Engine AC Status';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'AC_Ref_Hi_Side_Pres_V';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'AC_Comp_Clutch_Engaged';
  msg.fields{2}.units         = '';
  msg.fields{2}.start_bit     = 59;
  ...
  msg.fields{3}.name          = 'AC_Comp_Stroke_Req';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'AC_Off_Ind';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 56;
