...
%%
  ...
  msg.description             = 'ID258 IPT Status 2';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Torque Delivered';
  ...
  msg.fields{1}.scale         = 1/10;
  msg.fields{1}.offset        = 0;

  msg.fields{2}.name          = 'DC Current';
