...
%%
  ...
  msg.name                    = 'BMS Control';
  msg.description             = 'BMS 460';
  msg.protocol                = '';
  msg.module                  = 'BMS';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Contactor_Enable';
  msg.fields{1}.units         = '';
  ...
  msg.fields{2}.name          = 'Contactor_On';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'BMS_Standby';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 48;
  ...
  msg.fields{4}.name          = 'Charger_Ready';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 50;
  ...
  msg.fields{5}.name          = 'Emergency_Contactor_Off';
  msg.fields{5}.units         = '';
  ...
  msg.fields{6}.name          = 'Quit_Batt_Locked';
  msg.fields{6}.units         = '';
  ...
  msg.fields{7}.name          = 'Ambient_Temp';
  msg.fields{7}.units         = 'C';
  ...
  msg.fields{7}.offset        = -40;

  msg.fields{8}.name          = 'Air_Pres';
  msg.fields{8}.units         = 'kPa';
  msg.fields{8}.start_bit     = 16;
  msg.fields{8}.bit_length    = 8;
  msg.fields{8}.byte_order    = 'BIG_ENDIAN';
  msg.fields{8}.data_type     = 'UNSIGNED';
  msg.fields{8}.scale         = 0.5;
  msg.fields{8}.offset        = 0;
  
  msg.fields{9}.name          = 'ISO_On';
  msg.fields{9}.units         = '';
  msg.fields{9}.start_bit     = 46;
