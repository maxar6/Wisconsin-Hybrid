...
%%
  ...
  msg.name                    = 'FIAT Vehicle Speed and Odometer';
  msg.description             = 'ID410 FIAT Vehicle Speed and Odometer';
  msg.protocol                = '';
  msg.module                  = 'FIAT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'Dist_Roll_Cnt_Lft_V';
  msg.fields{2}.units         = '';
  ...
  msg.fields{3}.name          = 'Dist_Roll_Cnt_Lft_Reset';
  msg.fields{3}.units         = '';
  ...
  msg.fields{4}.name          = 'Dist_Roll_Cnt_Rht_V';
  msg.fields{4}.units         = '';
  ...
  msg.fields{5}.name          = 'Dist_Roll_Cnt_Rht_Reset';
  msg.fields{5}.units         = '';
