...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.scale         = 0.05;
  msg.fields{1}.offset        = -1600;

  msg.fields{2}.name          = 'I_Chg_Limit';
  ...
  msg.fields{2}.offset        = -1600;

  msg.fields{3}.name          = 'V_Dis_Limit';
  ...
  msg.fields{3}.scale         = 0.05;
  msg.fields{3}.offset        = 0;

  msg.fields{4}.name          = 'V_Chg_Limit';
