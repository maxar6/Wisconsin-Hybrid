...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{8}.name          = 'Batt_Fan_On';
  msg.fields{8}.units         = '';
  msg.fields{8}.start_bit     = 44;
  msg.fields{8}.bit_length    = 2;
  msg.fields{8}.byte_order    = 'BIG_ENDIAN';
  msg.fields{8}.data_type     = 'UNSIGNED';
  msg.fields{8}.scale         = 1;
  msg.fields{8}.offset        = 0;

  msg.fields{9}.name          = 'Need_Equalize';
  msg.fields{9}.units         = '';
  ...
  msg.fields{10}.name          = 'Equalize_Running';
  msg.fields{10}.units         = '';
  msg.fields{10}.start_bit     = 34;
  ...
  msg.fields{11}.name          = 'Equalize_Complete';
  msg.fields{11}.units         = '';
  msg.fields{11}.start_bit     = 36;
  ...
  msg.fields{12}.name          = 'End_of_Charge';
  msg.fields{12}.units         = '';
  msg.fields{12}.start_bit     = 38;
