...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{3}.name          = 'Reset_AO2';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 44;
