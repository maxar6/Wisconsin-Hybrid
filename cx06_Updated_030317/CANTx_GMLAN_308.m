...
%%
  ...
  msg.name                    = 'Engine Status 2';
  msg.description             = 'GMLAN 308';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
