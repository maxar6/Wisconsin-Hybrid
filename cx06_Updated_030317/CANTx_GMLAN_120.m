...
%%
  ...
  msg.name                    = 'Engine Torque';
  msg.description             = 'GMLAN 120';
  msg.protocol                = '';
  msg.module                  = 'GMLAN';
  msg.channel                 = 2;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'Validity';
  msg.fields{1}.units         = '';
  msg.fields{1}.start_bit     = 60;
  ...
  msg.fields{2}.name          = 'Torque_Act';
  msg.fields{2}.units         = 'Nm';
  msg.fields{2}.start_bit     = 48;
  msg.fields{2}.bit_length    = 12;
  msg.fields{2}.byte_order    = 'BIG_ENDIAN';
  msg.fields{2}.data_type     = 'UNSIGNED';
  msg.fields{2}.scale         = 0.25;
  msg.fields{2}.offset        = -200;
  
  msg.fields{3}.name          = 'Trq_Reduce_Fail_Sts';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 45;
  ...
  msg.fields{4}.name          = 'Trq_Reduce_Trac_Fail';
  msg.fields{4}.units         = '';
  msg.fields{4}.start_bit     = 44;
