...
%%
  ...
  msg.name                    = 'IPT Torque-Demand';
  msg.description             = 'ID250 Torque Demand';
  msg.protocol                = '';
  msg.module                  = 'IPT';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{3}.name          = 'Disable_AntiShudder';
  msg.fields{3}.units         = '';
  msg.fields{3}.start_bit     = 26;
